...
//
// Data source (same-origin browser fetch, no build step):
//   ./package-registry.json + ./ig/<package>/package-list.json
// Served by the repo root — no CORS, no upstream dependency.
