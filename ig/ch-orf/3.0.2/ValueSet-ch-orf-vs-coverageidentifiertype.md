...
## ValueSet: Coverage Identifier Type 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-orf/ValueSet/ch-orf-vs-coverageidentifiertype | *Version*:3.0.2 |
...
* [CH ORF Coverage](StructureDefinition-ch-orf-coverage.md)
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-orf/ValueSet/ch-orf-vs-coverageidentifiertype",
  "version" : "3.0.2",
