# Anwendungsfälle - CH ORF (R4) v3.0.2
...
* **Radiologie-Auftrag:** [XML](Bundle-radiology-order.xml.md), [JSON](Bundle-radiology-order.json.md)
...
* **Auftrag für externe Diagnostik:** [XML](Bundle-external-diagnostics-order.xml.md), [JSON](Bundle-external-diagnostics-order.json.md)
