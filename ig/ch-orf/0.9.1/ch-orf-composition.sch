...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Composition">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-orf/StructureDefinition/ch-orf-dataentryperson']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/ch-orf/StructureDefinition/ch-orf-dataentryperson': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-orf/StructureDefinition/ch-orf-urgentnoficationcontactforrequest']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/ch-orf/StructureDefinition/ch-orf-urgentnoficationcontactforrequest': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-orf/StructureDefinition/ch-orf-urgentnoficationcontactforresponse']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/ch-orf/StructureDefinition/ch-orf-urgentnoficationcontactforresponse': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-orf/StructureDefinition/ch-orf-requestreceiver']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/ch-orf/StructureDefinition/ch-orf-requestreceiver': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-orf/StructureDefinition/ch-orf-visitnumber']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/ch-orf/StructureDefinition/ch-orf-visitnumber': maximum cardinality of 'extension' is 1</sch:assert>
