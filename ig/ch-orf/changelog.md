...
* [Modular Form](modular-form.md)
* [Form Population](form-population.md)
* [Form Data Extraction](form-data-extraction.md)
...
* Adaptation of the Questionnaire profiles to the new SDC profiles ([CH ORF Questionnaire](Questionnaire-order-referral-form.json.md): `Questionnaire.meta.profile`) 
...
* [Description](index.md#composition-resource) of the handling of general information about the document in derived questionnaires (title, type and category). 
* [Issue #31](https://github.com/hl7ch/ch-orf/issues/31)
 
* Add patients marital status to the [Questionnaire](Questionnaire-order-referral-form.md) and the examples (e.g. [Bundle Order-Referral-Form](Bundle-bundle-order-referral-form.md)). 
* [Issue #60](https://github.com/hl7ch/ch-orf/issues/60) and [Issue #63](https://github.com/hl7ch/ch-orf/issues/63)
 
* Add patients language of correspondence to the [Questionnaire](Questionnaire-order-referral-form.md) and the examples (e.g. [Bundle Order-Referral-Form](Bundle-bundle-order-referral-form.md)). 
* [Issue #64](https://github.com/hl7ch/ch-orf/issues/64)
 
* Add 'ZSR' as Practitioner.identifier to the [Questionnaire](Questionnaire-order-referral-form.md) and the examples (e.g. [Bundle Order-Referral-Form](Bundle-bundle-order-referral-form.md)). 
* [Issue #65](https://github.com/hl7ch/ch-orf/issues/65)
 
* Add 'GLN' to organization ([Questionnaire](Questionnaire-order-referral-form.md)). 
...
* [Issue #44](https://github.com/hl7ch/ch-orf/issues/44): Description in the [FHIR Representation](index.md#fhir-representation) section adapted, i.e. 'XML' removed, as FHIR can also be serialised for exchange in formats other than XML.
* [Issue #42](https://github.com/hl7ch/ch-orf/issues/42): Instead of the redundantly embedded differential tables of the profiles on the 'Home' page ([Volume 3 - Content Modules](index.md#volume-3-%E2%80%93-content-modules)), links to the profiles are provided at the relevant places.
* [Issue #43](https://github.com/hl7ch/ch-orf/issues/43): Add meaningful descriptions to the [profiles](profiles.md).
* [Issue #51](https://github.com/hl7ch/ch-orf/issues/51): Add a [description](index.md#generic-elements-of-a-questionnaire) of the use of the PractitionerRole resource.
 
* The patient in the order defined as required ([Questionnaire](Questionnaire-order-referral-form.md), [CH ORF Composition Profile](StructureDefinition-ch-orf-composition.md)) 
...
* Expansion of the [questionnaire](Questionnaire-order-referral-form.md) field 'coverage.self'. Differentiation between [patient himself](Coverage-CoverageSelfPatient.md) or [related person](Coverage-CoverageSelfRelatedPerson.md) as self-payer. 
* [Issue #80](https://github.com/hl7ch/ch-orf/issues/80)
 
* Added explanation in [questionnaire](Questionnaire-order-referral-form.md): "Copy receiver is ment to receive a copy from the order and all evolving results". 
* [Issue #84](https://github.com/hl7ch/ch-orf/issues/84)
 
* Change source of the codes for [desired accommodation](ValueSet-ch-orf-vs-desiredaccommodation.md). 
* [Issue #91](https://github.com/hl7ch/ch-orf/issues/91)
 
* Cardinality for Questionnaire and QR in [Composition](StructureDefinition-ch-orf-composition.md) set to 0..1. –> Exchange format can be used without questionnaire. 
