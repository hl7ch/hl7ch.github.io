...
* **Radiology order:** [XML](Bundle-radiology-order.xml.md), [JSON](Bundle-radiology-order.json.md)
...
* **Order external diagnostics:** [XML](Bundle-external-diagnostics-order.xml.md), [JSON](Bundle-external-diagnostics-order.json.md)
