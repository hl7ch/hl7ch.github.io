# Cas d'application - CH ORF (R4) v3.0.2
...
* **Ordre de radiologie:** [XML](Bundle-radiology-order.xml.md), [JSON](Bundle-radiology-order.json.md)
...
* **Ordre de diagnostic externe:** [XML](Bundle-external-diagnostics-order.xml.md), [JSON](Bundle-external-diagnostics-order.json.md)
...
* **Personne responsable:** Dr. F. Amily, médecin de famille **Destinataire du mandat:** Spitex
