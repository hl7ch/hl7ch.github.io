# CH Core MedicationAdministration - CH Core (R4) v7.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-medicationadministration | *Version*:7.0.0-ballot |
| Active as of 2026-06-10 | *Computable Name*:CHCoreMedicationAdministration |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-core|current/StructureDefinition/StructureDefinition-ch-core-medicationadministration.json)
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "MedicationAdministration.extension:indicationCode",
      "path" : "MedicationAdministration.extension",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Ratio",
        "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-emed-ratio-with-emed-units"]
      },
      {
        "code" : "Quantity",
        "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-quantity-with-emed-units"]
