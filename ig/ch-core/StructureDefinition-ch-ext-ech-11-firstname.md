# First Name - CH Core (R4) v7.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-core/StructureDefinition/ch-ext-ech-11-firstname | *Version*:7.0.0-ballot |
| Active as of 2026-06-10 | *Computable Name*:ECH011FirstName |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-core|current/StructureDefinition/StructureDefinition-ch-ext-ech-11-firstname.json)
