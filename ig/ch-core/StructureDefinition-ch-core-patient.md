# CH Core Patient - CH Core (R4) v7.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-patient | *Version*:7.0.0-ballot |
| Active as of 2026-06-10 | *Computable Name*:CHCorePatient |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-core|current/StructureDefinition/StructureDefinition-ch-core-patient.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-patient-ech-11-placeofbirth"]
      }],
      "mapping" : [{
        "identity" : "eCH",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-patient-ech-11-placeoforigin"]
      }],
      "mapping" : [{
        "identity" : "eCH",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/patient-religion|5.3.0"]
      }],
      "mapping" : [{
        "identity" : "eCH",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Identifier",
        "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-epr-spid-identifier"]
      }],
      "patternIdentifier" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Identifier",
        "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-ahvn13-identifier"]
      }],
      "patternIdentifier" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-ext-ech-11-maritaldata-separation"]
      }],
      "mapping" : [{
        "identity" : "eCH",
