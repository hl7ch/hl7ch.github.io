# AHVN13 / NAVS13 Identifier - CH Core (R4) v7.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-ahvn13-identifier | *Version*:7.0.0-ballot |
| Active as of 2026-06-10 | *Computable Name*:AHVN13Identifier |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-core|current/StructureDefinition/StructureDefinition-ch-core-ahvn13-identifier.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      {
        "label" : "of valid AHVN13",
        "valueString" : "7561234567897"
      }],
      "constraint" : [{
        "key" : "ahvn13-length",
        "severity" : "warning",
