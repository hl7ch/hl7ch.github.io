# Extensions - CH Core (R4) v7.0.0-ballot
...
* [BFS Extension Medical Statistic: Encounter Type (Class) for Encounter](StructureDefinition-ch-ext-bfs-ms-encountertype.md) 
...
* [Indication Code](StructureDefinition-ch-ext-epl-regulated-authorization-limitation-indication-code.md) 
