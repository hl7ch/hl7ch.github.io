# Consent for participation in a Patient Portal - CH Core (R4) v7.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Consent for participation in a Patient Portal**

## Example Consent: Consent for participation in a Patient Portal

Profile: [CH Core Consent](StructureDefinition-CHCoreConsent.md)
...
This consent is made under the policy [https://example.org/patient-portal-policy](https://example.org/patient-portal-policy) .
...
* [Rule](https://hl7.org/fhir/R4/formats.html#table): ![](icon-qi-hidden.png)deny
  ...
  * [What](https://hl7.org/fhir/R4/formats.html#table): * Purpose: [v3 Code System ActReason: PATADMIN](http://hl7.org/fhir/R4/v3/ActReason/cs.html#v3-ActReason-PATADMIN) (patient administration)
* Code: Patient Portal
...
```json
{
  ...
  "meta" : {
    "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/CHCoreConsent"]
  },
  "extension" : [{
