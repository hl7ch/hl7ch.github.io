# Laboratory Order - CH Core (R4) v7.0.0-ballot
...
**insurance**: [Coverage: identifier = urn:oid:2.16.756.5.30.1.123.100.1.1.1#InsuranceCardNumber#80756015090002647590; status = active](Coverage-CoverageBroennimann.md)
