# Claim Inpatient Treatment Psychiatry - CH Core (R4) v7.0.0-ballot
...
**patient**: [Peter Muster Male, DoB: 1964-05-14 ( urn:oid:2.16.756.5.32#AHVN13#7562295883070)](Patient-ClaimPatient.md)
...
```json
{
  ...
  "meta" : {
    "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-claim"]
  },
  "extension" : [{
