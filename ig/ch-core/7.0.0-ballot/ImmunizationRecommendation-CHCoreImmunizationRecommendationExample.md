# CH Core ImmunizationRecommendation Example - CH Core (R4) v7.0.0-ballot
...
```json
{
  ...
  "meta" : {
    "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-immunization-recommendation"]
  },
  "patient" : {
