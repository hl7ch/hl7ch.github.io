# Changelog - CH Core (R4) v7.0.0-ballot
...
* [#330](https://github.com/hl7ch/ch-core/issues/330): Add new VS immunoglobulins for vaccinecode to Immunization
...
* [#242](https://github.com/hl7ch/ch-core/issues/242): Update the description for type of [CH Core Composition EPR](StructureDefinition-ch-core-composition-epr.md)
* [#238](https://github.com/hl7ch/ch-core/issues/238): Update context of [Extension EPR Time](StructureDefinition-ch-ext-epr-time.md) with MedicationRequest.requester
* [#246](https://github.com/hl7ch/ch-core/issues/246): Only allow an UUID as Bundle.identifier in the EPR context
* [#181](https://github.com/hl7ch/ch-core/issues/181): Change slicing from Patient.contact:nameOfFahter/nameOfMother to Patient.contact:nameOfParent according to eCH RFC 2019-9: **geschlechtsneutrale Bezeichnung für Namen der Eltern** and remove chapter numbers in mapping of eCH
...
* [#196](https://github.com/hl7ch/ch-core/issues/196): Data type profile [VEKAIdentifier](StructureDefinition-ch-core-veka-identifier.md) for [Coverage.identifier](StructureDefinition-ch-core-coverage.md) and new also for [Patient.identifier](StructureDefinition-ch-core-patient.md)
...
* [#191](https://github.com/hl7ch/ch-core/issues/191): [CH Core Patient](StructureDefinition-ch-core-patient.md) - Relax max cardinality to * for EPR-SPID and AHVN13
* [#195](https://github.com/hl7ch/ch-core/issues/195): [CH Core Address](StructureDefinition-ch-core-address.md) - Add extension iso21090-ADXP-streetName to CH Core Address line
* [#198](https://github.com/hl7ch/ch-core/issues/198): [CH Core Composition EPR](StructureDefinition-ch-core-composition-epr-definitions.md) - Relax information recipient cardinality to zero
* [#194](https://github.com/hl7ch/ch-core/issues/194): [CH Core Composition EPR](StructureDefinition-ch-core-composition-epr.md) - Relax attester:legalAuthenticator.time cardinality to zero
...
* [#181](https://github.com/hl7ch/ch-core/issues/181): Updated used eCH standards (incl. versions) to [introduction (home)](index.md#introduction) (standards themselves currently have no updates)
...
* [#172](https://github.com/hl7ch/ch-core/issues/172): Generic CH Core extension [Author of the content](StructureDefinition-ch-ext-author.md) (fusion of the extensions from CH EMED and CH VACD)
...
* [#150](https://github.com/hl7ch/ch-core/issues/150): Expansion of the context of the extension [EPR Time](StructureDefinition-ch-ext-epr-time.md)
* [#160](https://github.com/hl7ch/ch-core/issues/160): Slicing on repeating element
* [#154](https://github.com/hl7ch/ch-core/issues/154): Improve description of example instances, see [Artifacts](artifacts.md#example-example-instances)
...
* [#175](https://github.com/hl7ch/ch-core/issues/175): Rename the profile [CH Core EPR-Consent](StructureDefinition-ch-core-epr-consent.md)
* [#173](https://github.com/hl7ch/ch-core/issues/173): Define aggregation mode (contained, referenced) for [Coverage.payor](StructureDefinition-ch-core-coverage.md)
...
* [#161](https://github.com/hl7ch/ch-core/issues/161): Use 'patternCodeableConcept' instead of 'fixedCodeableConcept' for [Consent.policyRule](StructureDefinition-ch-core-epr-consent.md)
