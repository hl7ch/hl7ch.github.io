# Artifacts Summary - CH Core (R4) v7.0.0-ballot
...
| | |
| :--- | :--- |
| [ConsentProvisionCodeSearch](SearchParameter-ConsentProvisionCodeSearch.md) | Enables the search for Consent.provision.code.coding |
...
| [CH Core Consent](StructureDefinition-CHCoreConsent.md) | Base definition of the Consent resource for use in Swiss specific use cases. Uses the cross-version profile from hl7.fhir.uv.xver-r5.r4 to expose R5 Consent fields (grantor, manager, controller, decision, …) as extensions on R4 Consent. |
...
| [CH Core General Consent](StructureDefinition-CHCoreGeneralConsent.md) | Specialization of CHCoreConsent for the Unimedsuisse Generalkonsent (GC). |
...
| [BFS Extension Medical Statistic: Encounter Type (Class) for Encounter](StructureDefinition-ch-ext-bfs-ms-encountertype.md) | BFS Extension Encounter Type (Class) for Encounter |
...
| [Indication Code](StructureDefinition-ch-ext-epl-regulated-authorization-limitation-indication-code.md) | Indication Code, as defined by the [FOPH list of healthcare benefits](https://fhir.ch/ig/ch-epl/index.html) to be conveyed when referring to prescription/dispense/billing of medicinal products subject to a price model as defined by the FOPH. |
...
| | |
| :--- | :--- |
| [CH Core General Consent State](ValueSet-CHCoreGeneralConsentStateVS.md) | Allowed status values for CH Core General Consent: only active and inactive. |
| [ConsentCategoriesVS](ValueSet-ConsentCategoriesVS.md) | ValueSet of all used codes for the Consent.category |
| [ConsentProvisionCodesVS](ValueSet-ConsentProvisionCodesVS.md) | ValueSet of all used codes for Consent.provision.code |
...
| | |
| :--- | :--- |
| [ConsentProvisionCodesCS](CodeSystem-ConsentProvisionCodesCS.md) | Code System for Consents that are specificaly used in Switzerland |
...
| [CH Core Immunization Example NUVA](Immunization-CHCoreImmunizationExampleNUVA.md) | Example of Immunization resource with NUVA vaccineCode. |
...
| [Clinical Information System](HealthcareService-healthcareService-DemoCIS.md) | Example of a Clinical Information System used in CH Core Consent profile |
...
| [Consent for participation in a Patient Portal](Consent-PatPortalParticipation-accepted.md) | Example of a Consent for participation in a Patient Portal accepted by the patient |
...
| [General Consent accepted](Consent-GC-accepted.md) | Example of a General Consent accepted by the patient |
| [General Consent denied](Consent-GC-denied.md) | Example of a General Consent denied by a legal representative |
...
| [Medication dispense of Abirateron](MedicationDispense-MedDisAbirateron.md) | Instance of a medication dispense of Abirateron, which is a drug subject to the FOPH price model and exemplifies the usage of the indication code extension. |
| [MedicationRequest with Abirateron](MedicationRequest-MedReqAbirateron.md) | Instance of a medication request with Abirateron, which is a drug subject to the FOPH price model and exemplifies the usage of the indication code extension. |
| [MedicationStatement with Abirateron](MedicationStatement-MedicationStatementAbirateron.md) | Instance of a medication statement with Abirateron, which is a drug subject to the FOPH price model and exemplifies the usage of the indication code extension. |
...
| [Patient Portal](HealthcareService-healthcareService-DemoPatientPortal.md) | Example of a Patient Portal used in CH Core Consent profile |
