# SNOMED CT Swiss Extension - CH Core (R4) v7.0.0-ballot
...
Within the EPR, SNOMED CT is used for the metadata and in the exchange formats, see [here](index.md#metadata-annex-3-and-annex-9). 
