# CH Core Encounter - CH Core (R4) v7.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-encounter | *Version*:7.0.0-ballot |
| Active as of 2026-06-10 | *Computable Name*:CHCoreEncounter |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-core|current/StructureDefinition/StructureDefinition-ch-core-encounter.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-ext-bfs-ms-admitrole"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-ext-accident"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-ext-encounter-susp-readmission"]
      }]
    },
    {
      "id" : "Encounter.hospitalization.extension:BfsMsEncounterType",
      "path" : "Encounter.hospitalization.extension",
      "sliceName" : "BfsMsEncounterType",
      "short" : "BFS Medizinische Statistik - Liegeklasse (Encounter Type)",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-ext-bfs-ms-encountertype"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-ext-bfs-ms-dischargedecision"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-ext-bfs-ms-dischargedestination"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-location",
