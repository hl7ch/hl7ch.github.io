# MedicationRequest with Abirateron - CH Core (R4) v7.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MedicationRequest with Abirateron**

## Example MedicationRequest: MedicationRequest with Abirateron
...
```json
{
  ...
  "id" : "MedReqAbirateron",
  "meta" : {
    "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-medicationrequest"]
  },
  "contained" : [{
  ...
  "identifier" : [{
    ...
    "value" : "urn:uuid:f3ab7b8f-3eb4-4211-aba4-ce83c202f04e"
  }],
  "status" : "active",
  "intent" : "order",
  "medicationReference" : {
