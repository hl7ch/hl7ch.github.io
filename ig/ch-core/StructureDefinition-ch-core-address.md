# CH Core Address - CH Core (R4) v7.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-address | *Version*:7.0.0-ballot |
| Active as of 2026-06-10 | *Computable Name*:CHCoreAddress |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-core|current/StructureDefinition/StructureDefinition-ch-core-address.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-streetName|5.3.0"]
      }],
      "mapping" : [{
        "identity" : "eCH",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-unitID|5.3.0"]
      }],
      "mapping" : [{
        "identity" : "eCH",
    ...
    },
    {
      ...
      "definition" : "BFS defines the valid set of countries. Values are from the 'ISO 3166-1 country codes' code system.",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/iso21090-codedString|5.3.0"]
      }],
      "constraint" : [{
        "key" : "ch-addr-1",
        "severity" : "warning",
