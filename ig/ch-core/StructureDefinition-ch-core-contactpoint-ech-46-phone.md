# CH Core ContactPoint eCH-0046 Phone - CH Core (R4) v7.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-contactpoint-ech-46-phone | *Version*:7.0.0-ballot |
| Active as of 2026-06-10 | *Computable Name*:CHCoreContactPointECH46Phone |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-core|current/StructureDefinition/StructureDefinition-ch-core-contactpoint-ech-46-phone.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-ext-ech-46-phonecategory"]
      }],
      "mapping" : [{
        "identity" : "eCH",
