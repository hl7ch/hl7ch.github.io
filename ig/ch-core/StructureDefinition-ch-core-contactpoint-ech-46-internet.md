# CH Core ContactPoint eCH-0046 Internet - CH Core (R4) v6.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-contactpoint-ech-46-internet | *Version*:6.0.0 |
| Active as of 2025-12-16 | *Computable Name*:CHCoreContactPointECH46Internet |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-core|current/StructureDefinition/ch-core-contactpoint-ech-46-internet)
