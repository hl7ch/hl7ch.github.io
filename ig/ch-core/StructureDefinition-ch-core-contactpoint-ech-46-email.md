# CH Core ContactPoint eCH-0046 Email - CH Core (R4) v7.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-contactpoint-ech-46-email | *Version*:7.0.0-ballot |
| Active as of 2026-06-10 | *Computable Name*:CHCoreContactPointECH46Email |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-core|current/StructureDefinition/StructureDefinition-ch-core-contactpoint-ech-46-email.json)
...
Other representations of profile: [CSV](StructureDefinition-ch-core-contactpoint-ech-46-email.csv), [Excel](StructureDefinition-ch-core-contactpoint-ech-46-email.xlsx), [Schematron](StructureDefinition-ch-core-contactpoint-ech-46-email.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.ch/ig/ch-core/StructureDefinition/ch-ext-ech-46-emailcategory"]
      }],
      "mapping" : [{
        "identity" : "eCH",
