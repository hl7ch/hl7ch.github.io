# EDQM - Route Of Administration - CH IDMP (R5) v1.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-idmp/ValueSet/edqm-route-of-administration | *Version*:1.0.0-ballot |
| Active as of 2026-06-12 | *Computable Name*:EdqmRouteOfAdministrationVS |
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-idmp/ValueSet/edqm-route-of-administration",
  "identifier" : [{
    "use" : "official",
