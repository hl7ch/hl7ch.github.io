...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-idmp/ValueSet/ema-intended-effect | *Version*:1.0.0-ballot |
| Active as of 2026-06-12 | *Computable Name*:EMAIntendedEffectVS |
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-idmp/ValueSet/ema-intended-effect",
