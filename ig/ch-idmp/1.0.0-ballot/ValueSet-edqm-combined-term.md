# EDQM - Combined Term - CH IDMP (R5) v1.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-idmp/ValueSet/edqm-combined-term | *Version*:1.0.0-ballot |
| Active as of 2026-06-12 | *Computable Name*:EdqmCombinedTermVS |
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-idmp/ValueSet/edqm-combined-term",
  "identifier" : [{
    "use" : "official",
