# EDQM - Packaging - CH IDMP (R5) v1.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-idmp/ValueSet/edqm-packaging | *Version*:1.0.0-ballot |
| Active as of 2026-06-12 | *Computable Name*:EdqmPackagingVS |
...
```json
{
  ...
  "id" : "edqm-packaging",
  "url" : "http://fhir.ch/ig/ch-idmp/ValueSet/edqm-packaging",
  "identifier" : [{
    "use" : "official",
