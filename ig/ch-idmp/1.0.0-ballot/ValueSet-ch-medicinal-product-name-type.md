...
## ValueSet: CH - Medicinal Product Name Type 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-idmp/ValueSet/ch-medicinal-product-name-type | *Version*:1.0.0-ballot |
| Active as of 2026-06-12 | *Computable Name*:ChMedicinalProductNameTypeVS |
| **Copyright/Legal**: CC0-1.0 | |

 
Value Set for the Medicinal Product Name Type used in Switzerland 
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-idmp/ValueSet/ch-medicinal-product-name-type",
  "version" : "1.0.0-ballot",
  "name" : "ChMedicinalProductNameTypeVS",
