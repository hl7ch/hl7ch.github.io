...
## ValueSet: CH SMC - Additional Monitoring Indicator 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-idmp/ValueSet/ch-SMC-additional-monitoring-indicator | *Version*:1.0.0-ballot |
| Active as of 2026-06-12 | *Computable Name*:ChSMCAdditionalMonitoringIndicatorVS |
| **Copyright/Legal**: CC0-1.0 | |

 
Value Set for the Additional Monitoring Indicator from SMC 
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-idmp/ValueSet/ch-SMC-additional-monitoring-indicator",
