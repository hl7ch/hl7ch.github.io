...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicinalProductDefinition">
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-idmp/StructureDefinition/authorizedDoseForm']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/ch-idmp/StructureDefinition/authorizedDoseForm': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
