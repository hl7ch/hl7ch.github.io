# CH SMC - Authorised Pharmaceutical Dose Form - CH IDMP (R5) v1.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-idmp/ValueSet/ch-SMC-authorised-pharmaceutical-dose-form | *Version*:1.0.0-ballot |
| Active as of 2026-06-12 | *Computable Name*:ChSMCAuthorisedPharmaceuticalDoseFormVS |
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-idmp/ValueSet/ch-SMC-authorised-pharmaceutical-dose-form",
  ...
  "compose" : {
    ...
    {
      "valueSet" : ["http://fhir.ch/ig/ch-idmp/ValueSet/edqm-combined-term"]
    },
    {
      "valueSet" : ["http://fhir.ch/ig/ch-idmp/ValueSet/edqm-combination-packaging"]
    }]
  }
}
