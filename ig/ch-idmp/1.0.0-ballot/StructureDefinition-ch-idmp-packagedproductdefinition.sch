...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:PackagedProductDefinition/f:packaging/f:shelfLifeStorage/f:specialPrecautionsForStorage</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:PackagedProductDefinition/f:packaging/f:packaging</sch:title>
    <sch:rule context="f:PackagedProductDefinition/f:packaging/f:packaging">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:type) &lt;= 1">type: maximum cardinality of 'type' is 1</sch:assert>
      <sch:assert test="count(f:componentPart) &lt;= 1">componentPart: maximum cardinality of 'componentPart' is 1</sch:assert>
      <sch:assert test="count(f:quantity) &lt;= 1">quantity: maximum cardinality of 'quantity' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:PackagedProductDefinition/f:packaging/f:packaging/f:property</sch:title>
    <sch:rule context="f:PackagedProductDefinition/f:packaging/f:packaging/f:property">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:PackagedProductDefinition/f:packaging/f:packaging/f:containedItem</sch:title>
    <sch:rule context="f:PackagedProductDefinition/f:packaging/f:packaging/f:containedItem">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:PackagedProductDefinition/f:packaging/f:packaging/f:packaging</sch:title>
    <sch:rule context="f:PackagedProductDefinition/f:packaging/f:packaging/f:packaging">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:type) &lt;= 1">type: maximum cardinality of 'type' is 1</sch:assert>
      <sch:assert test="count(f:componentPart) &lt;= 1">componentPart: maximum cardinality of 'componentPart' is 1</sch:assert>
      <sch:assert test="count(f:quantity) &lt;= 1">quantity: maximum cardinality of 'quantity' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:PackagedProductDefinition/f:packaging/f:packaging/f:packaging/f:property</sch:title>
    <sch:rule context="f:PackagedProductDefinition/f:packaging/f:packaging/f:packaging/f:property">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:type) &gt;= 1">type: minimum cardinality of 'type' is 1</sch:assert>
      <sch:assert test="count(f:type) &lt;= 1">type: maximum cardinality of 'type' is 1</sch:assert>
      <sch:assert test="count(f:value[x]) &lt;= 1">value[x]: maximum cardinality of 'value[x]' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:PackagedProductDefinition/f:packaging/f:packaging/f:packaging/f:containedItem</sch:title>
    <sch:rule context="f:PackagedProductDefinition/f:packaging/f:packaging/f:packaging/f:containedItem">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:item) &gt;= 1">item: minimum cardinality of 'item' is 1</sch:assert>
      <sch:assert test="count(f:item) &lt;= 1">item: maximum cardinality of 'item' is 1</sch:assert>
      <sch:assert test="count(f:amount) &lt;= 1">amount: maximum cardinality of 'amount' is 1</sch:assert>
