# CH SMC - Authorisation Category - CH IDMP (R5) v1.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-idmp/CodeSystem/ch-SMC-authorisation-category | *Version*:1.0.0-ballot |
| Active as of 2026-06-12 | *Computable Name*:ChSMCAuthorisationCategoryCS |
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-idmp/CodeSystem/ch-SMC-authorisation-category",
