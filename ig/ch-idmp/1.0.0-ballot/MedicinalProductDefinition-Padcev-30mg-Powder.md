# Padcev 30 mg, Pulver für ein Konzentrat zur Herstellung einer Infusionslösung - CH IDMP (R5) v1.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Padcev 30 mg, Pulver für ein Konzentrat zur Herstellung einer Infusionslösung**

## Example MedicinalProductDefinition: Padcev 30 mg, Pulver für ein Konzentrat zur Herstellung einer Infusionslösung
...
**identifier**: [Medical Product Identifier](NamingSystem-MPID.md)/CH-01100869-0682910040000
...
> **name****productName**: Padcev 30 mg, Pulver für ein Konzentrat zur Herstellung einer Infusionslösung
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "CH-01100869-0682910040000"
  }],
