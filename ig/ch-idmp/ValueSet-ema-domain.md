...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-idmp/ValueSet/ema-domain | *Version*:1.0.0-ballot |
| Active as of 2026-06-12 | *Computable Name*:EMADomainVS |
| **Copyright/Legal**: CC0-1.0 | |

 
Value Set for the Domain from EMA used by SMC 
...
```json
{
  ...
  "id" : "ema-domain",
  "url" : "http://fhir.ch/ig/ch-idmp/ValueSet/ema-domain",
