# EDQM - Unit of Presentation - CH IDMP (R5) v1.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-idmp/ValueSet/edqm-unit-of-presentation | *Version*:1.0.0-ballot |
| Active as of 2026-06-12 | *Computable Name*:EdqmUnitOfPresentationVS |
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-idmp/ValueSet/edqm-unit-of-presentation",
  "identifier" : [{
    "use" : "official",
