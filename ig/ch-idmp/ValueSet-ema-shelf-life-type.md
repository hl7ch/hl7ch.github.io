# EMA - Shelf Life Type - CH IDMP (R5) v1.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-idmp/ValueSet/ema-shelf-life-type | *Version*:1.0.0-ballot |
| Active as of 2026-06-12 | *Computable Name*:EMAShelfLifeTypeVS |
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-idmp/ValueSet/ema-shelf-life-type",
