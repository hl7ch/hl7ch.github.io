...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-idmp/CodeSystem/ch-SMC-attached-document-type | *Version*:1.0.0-ballot |
| Active as of 2026-06-12 | *Computable Name*:ChSMCAttachedDocumentTypeCS |
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-idmp/CodeSystem/ch-SMC-attached-document-type",
