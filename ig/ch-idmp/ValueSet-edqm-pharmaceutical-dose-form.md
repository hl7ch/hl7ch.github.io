# EDQM - Pharmaceutical Dose Form - CH IDMP (R5) v1.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-idmp/ValueSet/edqm-pharmaceutical-dose-form | *Version*:1.0.0-ballot |
| Active as of 2026-06-12 | *Computable Name*:EdqmPharmaceuticalDoseFormVS |
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-idmp/ValueSet/edqm-pharmaceutical-dose-form",
  "identifier" : [{
    "use" : "official",
