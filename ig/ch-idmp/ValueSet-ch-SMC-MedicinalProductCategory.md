...
## ValueSet: CH SMC - MedicinalProductCategory 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-idmp/ValueSet/ch-SMC-MedicinalProductCategory | *Version*:1.0.0-ballot |
| Active as of 2026-06-12 | *Computable Name*:ChSMCMedicinalProductCategoryVS |
| **Copyright/Legal**: CC0-1.0 | |

 
Value Set for the MedicinalProductCategory from SMC 
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-idmp/ValueSet/ch-SMC-MedicinalProductCategory",
  "version" : "1.0.0-ballot",
  "name" : "ChSMCMedicinalProductCategoryVS",
