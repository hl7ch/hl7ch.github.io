# Padcev20 - CH IDMP (R5) v1.0.0-ballot
...
Representation of IDMP data attributes as FHIR XML and JSON: [FHIR Example](Bundle-a058182b-13dc-4797-9364-2cdb9a4c2bd4.md)

#### IDMP Dataexample

Representation of IDMP/FHIR data elements: ![](padcev20-structure.png)
