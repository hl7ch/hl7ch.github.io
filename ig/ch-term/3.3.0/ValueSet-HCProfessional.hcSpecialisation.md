# HCProfessional.hcSpecialisation - CH Term (R4) v3.3.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HCProfessional.hcSpecialisation**

## ValueSet: HCProfessional.hcSpecialisation 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-term/ValueSet/HCProfessional.hcSpecialisation | *Version*:3.3.0 |
| Active as of 2025-12-15 | *Computable Name*:HCProfessionalHcSpecialisation |
| *Other Identifiers:*OID:2.16.756.5.30.1.127.3.10.8.2 (use: official, ) | |
 ...
 **References** 
 ...
 Detailed information about the **current version** of this artifact, including cross-references to resources that use it, can be found [here](http://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-term%7Ccurrent/ValueSet/HCProfessional.hcSpecialisation) via the XIG (Cross-IG) index for FHIR specifications. 
...
```json
{
  ...
  "id" : "HCProfessional.hcSpecialisation",
  "meta" : {
    "source" : "https://art-decor.org/fhir/ValueSet/2.16.756.5.30.1.127.3.10.8.2--20220626160205",
  ...
  "extension" : [
    {
      ...
      "valuePeriod" : {
        "start" : "2022-06-26T16:02:05+02:00"
      }
    }
  ],
  "url" : "http://fhir.ch/ig/ch-term/ValueSet/HCProfessional.hcSpecialisation",
  "identifier" : [
    {
      "use" : "official",
      "system" : "urn:ietf:rfc:3986",
      "value" : "urn:oid:2.16.756.5.30.1.127.3.10.8.2"
    }
  ],
  "version" : "3.3.0",
  "name" : "HCProfessionalHcSpecialisation",
  "title" : "HCProfessional.hcSpecialisation",
  "status" : "active",
  "experimental" : false,
        ...
        "concept" : [
          ...
          },
          {
            ...
            "designation" : [
              ...
              {
                "language" : "rm-CH",
                "value" : "Media generalista/medi generalist"
              },
              {
                "language" : "en-US",
