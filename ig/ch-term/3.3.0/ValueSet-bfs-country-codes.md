# BFS Verzeichnis der Staaten und Gebiete - CH Term (R4) v3.3.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-term/ValueSet/bfs-country-codes | *Version*:3.3.0 |
 ...
 **References** 
 ...
 Detailed information about the **current version** of this artifact, including cross-references to resources that use it, can be found [here](http://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-term%7Ccurrent/ValueSet/bfs-country-codes) via the XIG (Cross-IG) index for FHIR specifications. 
