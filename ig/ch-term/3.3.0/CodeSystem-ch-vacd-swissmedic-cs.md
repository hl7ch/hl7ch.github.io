# CH VACD Swissmedic Authorized Vaccines - CH Term (R4) v3.3.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-vacd/CodeSystem/ch-vacd-swissmedic-cs | *Version*:3.3.0 |
| Active as of 2025-12-15 | *Computable Name*:SwissMedicAuthorizedVaccinesCodesystem |
...
```json
{
  ...
  "concept" : [
    ...
    {
      "code" : "68473",
      "display" : "Nuvaxovid 0.5 ml, Injektionsdispersion",
    ...
    {
      "code" : "69189",
      "display" : "Spikevax Bivalent Original / Omicron BA.4-5, dispersion for injection",
    ...
    {
      "code" : "68752",
      "display" : "Vaxneuvance, Injektionssuspension",
    ...
    {
      "code" : "69465",
      "display" : "Spikevax XBB.1.5 0.10 mg/ml, Dispersion zur Injektion",
    ...
    {
      "code" : "69488",
      "display" : "Comirnaty Omicron XBB.1.5 (30 Mikrogramm)/Dosis, Injektionsdispersion",
    ...
    {
      "code" : "69310",
      "display" : "AREXVY, Pulver und Suspension zur Herstellung einer Injektionssuspension\tGlaxoSmithKline AG",
      "definition" : "AREXVY",
      "designation" : [
        {
          "language" : "de-CH",
    ...
    {
      "code" : "69173",
      "display" : "Jynneos, Injektionssuspension\tBavarian Nordic Switzerland AG",
      "definition" : "Jynneos",
      "designation" : [
        {
          "language" : "de-CH",
    ...
    {
      "code" : "69222",
      "display" : "Prevenar 20, Injektionssuspension in einer Fertigspritze\tPfizer AG",
    ...
    {
      "code" : "69815",
      "display" : "Comirnaty Omicron XBB.1.5, 0.042 mg, Injektionsdispersion in einer Fertigspritze\tPfizer AG",
    ...
    {
      "code" : "69403",
      "display" : "Qdenga 0.5 ml, Pulver und Lösungsmittel für eine Injektionslösung in einer vorgefüllten Spritze\tTakeda Pharma AG",
