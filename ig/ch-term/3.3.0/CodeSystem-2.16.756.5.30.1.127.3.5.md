# ch-ehealth-codesystem-medreg - CH Term (R4) v3.3.0
...
| | |
| :--- | :--- |
| *Official URL*:urn:oid:2.16.756.5.30.1.127.3.5 | *Version*:3.3.0 |
| Active as of 2025-12-15 | *Computable Name*:ChEhealthCodesystemMedreg |
...
* [HCProfessionalHcSpecialisation](ValueSet-HCProfessional.hcSpecialisation.md)
...
```json
{
  ...
  "url" : "urn:oid:2.16.756.5.30.1.127.3.5",
  "version" : "3.3.0",
  "name" : "ChEhealthCodesystemMedreg",
  "title" : "ch-ehealth-codesystem-medreg",
  "status" : "active",
  "experimental" : false,
