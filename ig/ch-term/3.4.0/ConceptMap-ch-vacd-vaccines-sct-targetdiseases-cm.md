# Snomed CT VaccineCode To TargetDisease Mapping - CH Term (R4) v3.4.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-vacd/ConceptMap/ch-vacd-vaccines-sct-targetdiseases-cm | *Version*:3.4.0 |
| Active as of 2026-06-10 | *Computable Name*:SnomedCTVaccineCodeToTargetDiseaseMapping |
...
```json
{
  ...
  "group" : [{
    ...
    {
      "code" : "1344967001",
      "display" : "Live attenuated Chikungunya virus antigen",
      "target" : [{
        "code" : "111864006",
        "display" : "Chikungunya fever (disorder)",
        "equivalence" : "relatedto"
