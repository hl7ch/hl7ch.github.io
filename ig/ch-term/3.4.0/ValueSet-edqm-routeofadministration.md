# EDQM - RouteOfAdministration - CH Term (R4) v3.4.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-term/ValueSet/edqm-routeofadministration | *Version*:3.4.0 |
| Active as of 2026-02-09 | *Computable Name*:RouteOfAdministrationEDQM |
...
```json
{
  ...
  "meta" : {
    "lastUpdated" : "2026-02-09T14:38:25Z",
  ...
  "extension" : [{
    ...
    "valuePeriod" : {
      "start" : "2026-02-03T07:48:02+01:00"
    }
  }],
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-02-09T14:38:25+01:00",
  ...
  "compose" : {
    "include" : [{
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/StructureDefinition/valueset-concept-comments",
          "valueString" : "Administration, usually by injection, of a medicinal product into the tissue surrounding a lesion."
        }],
        "code" : "20088000",
        "display" : "Perilesional use",
        "designation" : [{
          "language" : "de-CH",
          "value" : "periläsionale Anwendung"
        },
        {
          "language" : "fr-CH",
          "value" : "Voie périlésionnelle"
        },
        {
          "language" : "it-CH",
          "value" : "Uso perilesionale"
        },
        {
          "language" : "rm-CH",
          "value" : "periläsionale Anwendung"
