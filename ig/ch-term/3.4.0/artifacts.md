# Artifacts Summary - CH Term (R4) v3.4.0
...
| [ConceptMap for mapping Nuva vaccine codes to Old Swiss vaccine codes](ConceptMap-ch-vacd-nuva-to-swisslegacy-cm.md) | This ConceptMap maps vaccine codes from the Nuva terminology to the corresponding codes in the old swiss vaccines CodeSystem. It is generated based on the provided CSV mapping file and the Swissmedic CodeSystem. |
| [ConceptMap for mapping Nuva vaccine codes to SNOMED-CT vaccine codes](ConceptMap-ch-vacd-nuva-to-snomedct-cm.md) | This ConceptMap maps vaccine codes from the Nuva terminology to the corresponding codes in the SNOMED-CT CodeSystem. It is generated based on the provided CSV mapping file and the SNOMED-CT CodeSystem. |
| [ConceptMap for mapping Nuva vaccine codes to Swissmedic codes](ConceptMap-ch-vacd-nuva-to-swissmedic-cm.md) | This ConceptMap maps vaccine codes from the Nuva terminology to the corresponding codes in the Swissmedic CodeSystem. It is generated based on the provided CSV mapping file and the Swissmedic CodeSystem. |
| [ConceptMap for mapping Old Swiss vaccine codes to Nuva vaccine codes](ConceptMap-ch-vacd-swisslegacy-to-nuva-cm.md) | This ConceptMap maps vaccine codes from the old swiss vaccines CodeSystem to the corresponding codes in the Nuva terminology. It is generated based on the provided CSV mapping file and the Swissmedic CodeSystem. |
| [ConceptMap for mapping SNOMED-CT vaccine codes to Nuva vaccine codes](ConceptMap-ch-vacd-snomedct-to-nuva-cm.md) | This ConceptMap maps vaccine codes from the SNOMED-CT CodeSystem to the corresponding codes in the Nuva terminology. It is generated based on the provided CSV mapping file and the SNOMED-CT CodeSystem. |
| [ConceptMap for mapping Swissmedic vaccine codes to Nuva codes](ConceptMap-ch-vacd-swissmedic-to-nuva-cm.md) | This ConceptMap maps vaccine codes from the Swissmedic CodeSystem to the corresponding codes in the Nuva terminology. It is generated based on the provided CSV mapping file and the Swissmedic CodeSystem. |
...
| [Old Swiss vaccine codes To TargetDisease Mapping](ConceptMap-ch-vacd-vaccines-sl-targetdiseases-cm.md) | ConceptMap for mapping Old Swiss vaccine codes to TargetDisease according to the correcsponding valuesets |
...
| [Swissmedic vaccine codes To TargetDisease Mapping](ConceptMap-ch-vacd-vaccines-sm-targetdiseases-cm.md) | ConceptMap for mapping Swissmedic vaccine codes to TargetDisease according to the correcsponding valuesets |
...
| | |
| :--- | :--- |
| [ExpansionParameters](Parameters-ExpansionParameters.md) | expansion parameter |
