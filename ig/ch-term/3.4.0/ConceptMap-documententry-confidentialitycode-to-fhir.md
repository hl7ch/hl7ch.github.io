# DocumentEntry.confidentialityCode to FHIR mapping - CH Term (R4) v3.4.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-core/ConceptMap/documententry-confidentialitycode-to-fhir | *Version*:3.4.0 |
