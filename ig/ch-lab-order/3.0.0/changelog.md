# Changelog - CH LAB-Order (R4) v3.0.0
...
* [#71](https://github.com/hl7ch/ch-lab-order/issues/71): Missing insurance Information: resolved, see [http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-organization-epr](http://fhir.ch/ig/ch-core/StructureDefinition/ch-core-organization-epr)
