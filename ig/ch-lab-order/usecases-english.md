# Use Cases - CH LAB-Order (R4) v3.0.0
...
* [**Control of Anticoagulant Effect**](case-studies-english.md#control-of-anticoagulant-effect): [CH LAB-Order Document with Service Request](Bundle-0-best-practice-document-with-sr.md)
* [**Suspicion of Deep Vein Thrombosis**](case-studies-english.md#suspicion-of-deep-vein-thrombosis): [CH LAB-Order Document with Service Request](Bundle-1-tvt-document-with-sr.md)
* [**Annual Gynecological Checkup**](case-studies-english.md#annual-gynecological-checkup): [CH LAB-Order Document with Service Request](Bundle-3-gyn-document.md)
* [**Histopathological Examination**](case-studies-english.md#histopathological-examination): [CH LAB-Order Document with Service Request](Bundle-6-histopath-document-with-sr.md)
...
* [**Suspicion of Deep Vein Thrombosis**](case-studies-english.md#suspicion-of-deep-vein-thrombosis): [CH LAB-Order Document with Service Request and Form](Bundle-1-tvt-document-with-sr-and-form.md)
* [**Annual Gynecological Checkup**](case-studies-english.md#annual-gynecological-checkup): [CH LAB-Order Document with Service Request and Form](Bundle-3-gyn-document-with-sr-and-form.md)
* [**Histopathological Examination**](case-studies-english.md#histopathological-examination): [CH LAB-Order Document with Service Request and Form](Bundle-6-histopath-document-with-sr-and-form.md)
...
In the [**suspicion of pertussis**](case-studies-english.md#suspicion-of-pertussis) case study, the in-house laboratory tests (automated blood count, CRP) are supplemented by a search for the Bordetella pertussis and parapertussis DNA in the throat swab, carried out by an external contract laboratory, in order to rule out whooping cough.
...
* [CH LAB-Order Document with Service Request](Bundle-2-pertussis-document-with-sr.md)
* [CH LAB-Order Document with Service Request and Form](Bundle-2-pertussis-document-with-sr-and-form.md)

### Collective Request for Toxicological Testing

This use case corresponds to the [**SUVA biological monitoring**](case-studies-english.md#suva-biological-monitoring) case study. In order to assess the exposure of workers to chemical substances, measurements at the workplace are supplemented by occupational health checkups. The toxic substances themselves or their metabolites in serum or urine can be determined. The order is initiated by the occupational physician of the company or the insurance company. The problem of employee fluctuations must be kept in mind.
...
* [CH LAB-Order Document with Service Request](Bundle-5-biol-monit-document-with-sr.md)
* [CH LAB-Order Document with Service Request and Form](Bundle-5-biol-monit-document-with-sr-and-form.md)
