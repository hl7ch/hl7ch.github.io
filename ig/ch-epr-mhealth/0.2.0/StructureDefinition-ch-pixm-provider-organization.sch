...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Organization">
      ...
      <sch:assert test="count(f:telecom | f:address | f:contact.name) &gt; 0">The organization SHALL have at least one of telecom, address, or contact person to be present.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
