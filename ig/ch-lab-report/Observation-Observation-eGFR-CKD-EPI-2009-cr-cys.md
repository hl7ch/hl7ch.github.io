# Observation-eGFR-CKD-EPI-2009-cr-cys - CH LAB-Report (R4) v2.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation-eGFR-CKD-EPI-2009-cr-cys**

## Example Observation: Observation-eGFR-CKD-EPI-2009-cr-cys
...
**identifier**: `https://example.org/labvalues`/1304-03720-eGFR_CKD_EPI-cr-cys

**status**: Final

**category**: Laboratory

**code**: Glomerular filtration rate [Volume Rate/Area] in Serum, Plasma or Blood by Creatinine and Cystatin C-based formula (CKD-EPI)/1.73 sq M
...
```json
{
  ...
  "id" : "Observation-eGFR-CKD-EPI-2009-cr-cys",
  "meta" : {
    "profile" : [
  ...
  "identifier" : [
    {
      ...
      "value" : "1304-03720-eGFR_CKD_EPI-cr-cys"
    }
  ],
  "status" : "final",
  "category" : [
