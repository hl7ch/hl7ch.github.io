# Blood Group Rh combined - CH LAB-Report (R4) v2.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Blood Group Rh combined**

## Example Observation: Blood Group Rh combined

Profile: [CH LAB-Report Observation Results: Blood Group](StructureDefinition-ch-lab-observation-blood-group.md)

**identifier**: `http://example.org/Labor-Pipette/labvalues`/1304-03720-blood-group-simple
...
**method**: Genotyping (qualifier value)
  ...
  "identifier" : [
    {
      ...
      "value" : "1304-03720-blood-group-simple"
    }
  ],
  "status" : "final",
  "category" : [
