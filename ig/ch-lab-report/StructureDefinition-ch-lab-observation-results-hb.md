# CH LAB-Report Observation Results: Hemoglobin - CH LAB-Report (R4) v2.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH LAB-Report Observation Results: Hemoglobin**

## Resource Profile: CH LAB-Report Observation Results: Hemoglobin 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-lab-report/StructureDefinition/ch-lab-observation-results-hb | *Version*:2.0.0 |
| Active as of 2025-12-16 | *Computable Name*:ChLabHemoglobin |
...
* Examples for this Profile: [Observation/ExampleObservationHb](Observation-ExampleObservationHb.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-lab-report|current/StructureDefinition/ch-lab-observation-results-hb)
...
Other representations of profile: [CSV](StructureDefinition-ch-lab-observation-results-hb.csv), [Excel](StructureDefinition-ch-lab-observation-results-hb.xlsx), [Schematron](StructureDefinition-ch-lab-observation-results-hb.sch) 
