# Blood Group free Text Result with Components ABO, RhD, Date, Period and Antibody Results - CH LAB-Report (R4) v2.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Blood Group free Text Result with Components ABO, RhD, Date, Period and Antibody Results**

## Example Observation: Blood Group free Text Result with Components ABO, RhD, Date, Period and Antibody Results
...
> **component****code**:Blutgruppe**value**: O

> **component****code**:Rhesusfaktor**value**: -

> **component****code**:1. Bestimmungsdatum**value**: 2022-07-01 11:24:26+0100

> **component****code**:2. Bestimmungsdatum**value**: 2022-07-01 11:34:26+0100

> **component****code**:T + S**value**: 2022-07-01 11:34:26+0100 --> 2022-07-05 11:28:26+0100

> **component****code**:Antikörper**value**: nein
...
```json
{
  ...
  "id" : "BloodGroup-freeTextResult-1",
  "meta" : {
    "profile" : [
