# Platelet Count - CH LAB-Report (R4) v2.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Platelet Count**

## Example Observation: Platelet Count

Profile: [CH LAB-Report Observation Results: Platelet Count](StructureDefinition-ch-lab-observation-results-platelets.md)
...
**value**: 113 10*9U/L(Details: UCUM code10*9/L = '10*9/L')
...
```json
{
  ...
  "id" : "ExampleObservationPlateletCount",
  "meta" : {
    "profile" : [
