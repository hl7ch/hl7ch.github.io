# Use Cases in German - CH LAB-Report (R4) v2.0.0
...
[Laborergebnis Dokument](Bundle-LabResultReport-1-tvt.md)
...
[Laborergebnis Dokument](Bundle-LabResultReport-2-electrophoresis.md)
...
[Laborergebnis Dokument](Bundle-LabResultReport-3-breath-test.md)
...
[Laborergebnis Dokument](Bundle-LabResultReport-4-sepsis.md)
...
1. [ValueSet: Results Blood Group - SNOMED CT IPS Free Set](http://hl7.org/fhir/uv/ips/ValueSet/results-blood-group-snomed-ct-ips-free-set)mit 13 Konzepten

Dieser Leitfaden enthält 3 weitere mögliche ValueSets:

1. [ValueSet: CH LAB-Report BloodGroup Immunohematology Tests (SNOMED CT coded procedures)](ValueSet-ch-lab-bloodgroup-immuno-hematology-vs.md)mit den SNOMED CT Codes der Blutgruppen-Antikörper screening tests
1. [ValueSet: CH LAB-Report BloodGroup Antibody Screen Tests Result (LOINC codes)](ValueSet-ch-lab-bloodgroup-antibody-screen-vs.md)mit den LOINC Codes der Resultate der Blutgruppen Antikörper screening Tests
1. [ValueSet: CH LAB-Report BloodGroup Antibody Result](ValueSet-ch-lab-bloodgroup-antibody-vs.md)mit den SNOMED CT Codes der Blutgruppen Antikörper
...
* [Blood Group Panel ABO Rh mit 'Component'](Observation-BloodGroupCompAB0CompRhD.md)
