# Blood Group free Text Result with Components ABO, RhD, Antibody Screen Test and DAT - CH LAB-Report (R4) v2.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Blood Group free Text Result with Components ABO, RhD, Antibody Screen Test and DAT**

## Example Observation: Blood Group free Text Result with Components ABO, RhD, Antibody Screen Test and DAT
...
```json
{
  ...
  "id" : "BloodGroup-freeTextResult-2",
  "meta" : {
    "profile" : [
