# Use Cases in Italian - CH LAB-Report (R4) v2.0.0
...
[Documento sui risultati di laboratorio](Bundle-LabResultReport-1-tvt.md)
...
[Documento sui risultati di laboratorio](Bundle-LabResultReport-2-electrophoresis.md)
...
[Documento sui risultati di laboratorio](Bundle-LabResultReport-3-breath-test.md)
...
[Documento sui risultati di laboratorio](Bundle-LabResultReport-4-sepsis.md)
...
Profilo: [CH LAB-Report Observation Results: Count of Blood Cells (automated CBC)](StructureDefinition-ch-lab-observation-cbc-panel.md)

Esempio: [Risultati dell'osservazione: conteggio delle cellule del sangue (emocromo automatico)](Observation-ExampleObservationCBCPanel.md)
...
Profilo: [CH LAB-Report Observation Results: Renal Insufficiency Panel](StructureDefinition-ch-lab-observation-renal-insufficiency-panel.md)

Esempio: [Risultati dell'osservazione: pannello di insufficienza renale](Observation-ObservationRenalInsufficiencyPanel.md)
...
1. [ValueSet: Results Blood Group - SNOMED CT IPS Free Set](http://hl7.org/fhir/uv/ips/ValueSet/results-blood-group-snomed-ct-ips-free-set)con 13 concetti.

Questa guida contiene altri 3 possibili ValueSet:

1. [ValueSet: CH LAB-Report BloodGroup Immunohematology Tests (SNOMED CT coded procedures)](ValueSet-ch-lab-bloodgroup-immuno-hematology-vs.md)con i codici SNOMED CT dei test di screening degli anticorpi del gruppo sanguigno.
1. [ValueSet: CH LAB-Report BloodGroup Antibody Screen Tests Result (LOINC codes)](ValueSet-ch-lab-bloodgroup-antibody-screen-vs.md)con i codici LOINC dei resultati dei test di screening degli anticorpi del gruppo sanguigno.
1. [ValueSet: CH LAB-Report BloodGroup Antibody Result](ValueSet-ch-lab-bloodgroup-antibody-vs.md)con i codici SNOMED CT degli anticorpi del gruppo sanguigno.
...
* [Pannello gruppi sanguigni ABO Rh semplice](Observation-BloodGroupAB0RhD.md)
* [Pannello gruppi sanguigni ABO Rh](Observation-BloodGroupPanel.md)
* [Pannello gruppi sanguigni ABO Rh usando 'Component'](Observation-BloodGroupCompAB0CompRhD.md)
