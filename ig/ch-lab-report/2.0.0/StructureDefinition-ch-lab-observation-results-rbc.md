# CH LAB-Report Observation Results: ErythrocyteCount - CH LAB-Report (R4) v2.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH LAB-Report Observation Results: ErythrocyteCount**

## Resource Profile: CH LAB-Report Observation Results: ErythrocyteCount 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-lab-report/StructureDefinition/ch-lab-observation-results-rbc | *Version*:2.0.0 |
| Active as of 2025-12-16 | *Computable Name*:ChLabErythrocyteCount |
...
* Examples for this Profile: [Observation/ExampleObservationRBC](Observation-ExampleObservationRBC.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-lab-report|current/StructureDefinition/ch-lab-observation-results-rbc)
...
Other representations of profile: [CSV](StructureDefinition-ch-lab-observation-results-rbc.csv), [Excel](StructureDefinition-ch-lab-observation-results-rbc.xlsx), [Schematron](StructureDefinition-ch-lab-observation-results-rbc.sch) 
