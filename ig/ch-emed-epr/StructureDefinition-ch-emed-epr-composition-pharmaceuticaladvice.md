# PADV Composition - CH EMED EPR v3.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **PADV Composition**

## Resource Profile: PADV Composition 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-composition-pharmaceuticaladvice | *Version*:3.0.0 |
| Draft as of 2026-02-11 | *Computable Name*:CHEMEDEPRCompositionPharmaceuticalAdvice |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-emed-epr|current/StructureDefinition/ch-emed-epr-composition-pharmaceuticaladvice)
...
Other representations of profile: [CSV](StructureDefinition-ch-emed-epr-composition-pharmaceuticaladvice.csv), [Excel](StructureDefinition-ch-emed-epr-composition-pharmaceuticaladvice.xlsx), [Schematron](StructureDefinition-ch-emed-epr-composition-pharmaceuticaladvice.sch) 
...
```json
{
  ...
  "abstract" : false,
  "type" : "Composition",
  "baseDefinition" : "http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-composition-pharmaceuticaladvice",
  ...
  "differential" : {
    "element" : [
        ...
        "constraint" : [
          {
            ...
            "source" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-composition-pharmaceuticaladvice"
          }
        ]
      },
      {
      ...
      {
        "id" : "Composition.section:pharmaceuticalAdvice.modifierExtension",
        "path" : "Composition.section.modifierExtension",
        "max" : "0"
      },
      {
        "id" : "Composition.section:pharmaceuticalAdvice.author",
        "extension" : [
          {
            "url" : "http://hl7.org/fhir/StructureDefinition/structuredefinition-standards-status",
            "valueCode" : "draft"
