# PADV Observation - CH EMED EPR v3.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-observation | *Version*:3.0.0 |
| Draft as of 2026-02-11 | *Computable Name*:CHEMEDEPRObservation |
...
* Use this Profile: [PADV Document](StructureDefinition-ch-emed-epr-document-pharmaceuticaladvice.md)
* Refer to this Profile: [PADV Composition](StructureDefinition-ch-emed-epr-composition-pharmaceuticaladvice.md) and [PADV Changed MedicationRequest](StructureDefinition-ch-emed-epr-medicationrequest-changed.md)
* Examples for this Profile: [Observation/ObservationParacetamolAxapharmPrePadvCancel](Observation-ObservationParacetamolAxapharmPrePadvCancel.md), [Observation/ObservationParacetamolAxapharmPrePadvChange](Observation-ObservationParacetamolAxapharmPrePadvChange.md), [Observation/ObservationRamiprilPadv](Observation-ObservationRamiprilPadv.md) and [Observation/ObservationTriatecPadv](Observation-ObservationTriatecPadv.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-emed-epr|current/StructureDefinition/ch-emed-epr-observation)
...
Other representations of profile: [CSV](StructureDefinition-ch-emed-epr-observation.csv), [Excel](StructureDefinition-ch-emed-epr-observation.xlsx), [Schematron](StructureDefinition-ch-emed-epr-observation.sch) 
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-observation",
  "version" : "3.0.0",
  "name" : "CHEMEDEPRObservation",
    ...
    "element" : [
      {
        ...
        "constraint" : [
          {
            "key" : "only-one-obs-ref",
            "severity" : "error",
            "human" : "A single reference (to either a medication treatment plan, prescription or dispense) SHALL be present",
            ...
            "source" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-observation"
          },
          {
            "key" : "mtp-entry-only-with-ref",
            "severity" : "error",
            "human" : "A changed MedicationStatement SHALL only be present with a medication treatment plan reference, in a PADV CHANGE",
          ...
          {
            "key" : "pre-entry-only-with-ref",
            "severity" : "error",
            "human" : "A changed MedicationRequest SHALL only be present with a medication request reference, in a PADV CHANGE",
          ...
          {
            "key" : "treatment-plan-id-reference-matches-statement-changed-reference",
            "severity" : "error",
            "human" : "If the observation includes a medication statement changed reference, it SHALL match the treatment plan id reference",
          ...
          {
            "key" : "prescription-id-reference-matches-request-changed-reference",
            "severity" : "error",
            "human" : "If the observation includes a medication request changed reference, it SHALL match the prescription id reference",
      ...
      {
        "id" : "Observation.extension:medicationStatementChanged.value[x]",
      ...
      {
        "id" : "Observation.extension:medicationRequestChanged.value[x]",
        "path" : "Observation.extension.value[x]",
        "type" : [
          {
            "code" : "Reference",
