# PML Document - CH EMED EPR v3.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-document-medicationlist | *Version*:3.0.0 |
| Draft as of 2026-02-11 | *Computable Name*:CHEMEDEPRDocumentMedicationList |
...
* Examples for this Profile: [Bundle/BundlePml1](Bundle-BundlePml1.md), [Bundle/BundleUtc1Pml](Bundle-BundleUtc1Pml.md) and [Bundle/BundleUtc6bPml](Bundle-BundleUtc6bPml.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-emed-epr|current/StructureDefinition/ch-emed-epr-document-medicationlist)
...
Other representations of profile: [CSV](StructureDefinition-ch-emed-epr-document-medicationlist.csv), [Excel](StructureDefinition-ch-emed-epr-document-medicationlist.xlsx), [Schematron](StructureDefinition-ch-emed-epr-document-medicationlist.sch) 
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-document-medicationlist",
  "version" : "3.0.0",
  "name" : "CHEMEDEPRDocumentMedicationList",
  "title" : "PML Document",
  "status" : "draft",
  ...
  "abstract" : false,
  "type" : "Bundle",
  "baseDefinition" : "http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-document-medicationlist",
        ...
        "constraint" : [
          {
            ...
            "source" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-document-medicationlist"
          }
        ]
      },
      {
