# PML MedicationStatement - CH EMED EPR v3.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **PML MedicationStatement**

## Resource Profile: PML MedicationStatement 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medicationstatement-list | *Version*:3.0.0 |
| Draft as of 2026-02-11 | *Computable Name*:CHEMEDEPRMedicationStatementList |
...
* Examples for this Profile: [MedicationStatement/MedicationStatementParacetamolAxapharmPml](MedicationStatement-MedicationStatementParacetamolAxapharmPml.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-emed-epr|current/StructureDefinition/ch-emed-epr-medicationstatement-list)
...
Other representations of profile: [CSV](StructureDefinition-ch-emed-epr-medicationstatement-list.csv), [Excel](StructureDefinition-ch-emed-epr-medicationstatement-list.xlsx), [Schematron](StructureDefinition-ch-emed-epr-medicationstatement-list.sch) 
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medicationstatement-list",
  "version" : "3.0.0",
  "name" : "CHEMEDEPRMedicationStatementList",
  ...
  "baseDefinition" : "http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-medicationstatement-list",
        ...
        "constraint" : [
          {
            ...
            "source" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medicationstatement-list"
          }
        ]
      },
      {
