# MedicationStatement: Paracetamol Axapharm (PMLC) - CH EMED EPR v3.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MedicationStatement: Paracetamol Axapharm (PMLC)**

## Example MedicationStatement: MedicationStatement: Paracetamol Axapharm (PMLC)
...
```json
{
  ...
  "id" : "MedicationStatementParacetamolAxapharmPmlc",
  "meta" : {
    "profile" : [
  ...
  "identifier" : [
    {
      "system" : "urn:ietf:rfc:3986",
      "value" : "urn:uuid:64ac7c70-3edb-4b39-84e6-4045e196884f"
    }
  ],
  "status" : "active",
  "medicationReference" : {
