# MTP Document - CH EMED EPR v3.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MTP Document**

## Resource Profile: MTP Document 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-document-medicationtreatmentplan | *Version*:3.0.0 |
| Draft as of 2026-02-11 | *Computable Name*:CHEMEDEPRDocumentMedicationTreatmentPlan |
...
* Examples for this Profile: [Bundle/DocumentMtp1](Bundle-DocumentMtp1.md), [Bundle/DocumentMtpCARAPMP004MarcoumarFreeTextDosage](Bundle-DocumentMtpCARAPMP004MarcoumarFreeTextDosage.md), [Bundle/DocumentMtpParacetamolCARAPMP004](Bundle-DocumentMtpParacetamolCARAPMP004.md), [Bundle/DocumentMtpParacetamolDafalganCARAPMP004](Bundle-DocumentMtpParacetamolDafalganCARAPMP004.md)... Show 2 more, [Bundle/DocumentUCSF2CARAPMP004MTPParacetamol](Bundle-DocumentUCSF2CARAPMP004MTPParacetamol.md) and [Bundle/DocumentUCSF6CARAPMP004MTPIbuprofen](Bundle-DocumentUCSF6CARAPMP004MTPIbuprofen.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-emed-epr|current/StructureDefinition/ch-emed-epr-document-medicationtreatmentplan)
...
Other representations of profile: [CSV](StructureDefinition-ch-emed-epr-document-medicationtreatmentplan.csv), [Excel](StructureDefinition-ch-emed-epr-document-medicationtreatmentplan.xlsx), [Schematron](StructureDefinition-ch-emed-epr-document-medicationtreatmentplan.sch) 
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-document-medicationtreatmentplan",
  "version" : "3.0.0",
  "name" : "CHEMEDEPRDocumentMedicationTreatmentPlan",
  "title" : "MTP Document",
  "status" : "draft",
  ...
  "abstract" : false,
  "type" : "Bundle",
  "baseDefinition" : "http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-document-medicationtreatmentplan",
        ...
        "constraint" : [
          {
            ...
            "source" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-document-medicationtreatmentplan"
          }
        ]
      },
      {
