# PADV Changed MedicationRequest - CH EMED EPR v3.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **PADV Changed MedicationRequest**

## Resource Profile: PADV Changed MedicationRequest 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medicationrequest-changed | *Version*:3.0.0 |
| Draft as of 2026-02-11 | *Computable Name*:CHEMEDEPRChangedMedicationRequest |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-emed-epr|current/StructureDefinition/ch-emed-epr-medicationrequest-changed)
...
Other representations of profile: [CSV](StructureDefinition-ch-emed-epr-medicationrequest-changed.csv), [Excel](StructureDefinition-ch-emed-epr-medicationrequest-changed.xlsx), [Schematron](StructureDefinition-ch-emed-epr-medicationrequest-changed.sch) 
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medicationrequest-changed",
  "version" : "3.0.0",
  "name" : "CHEMEDEPRChangedMedicationRequest",
  ...
  "baseDefinition" : "http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-medicationrequest-changed",
        ...
        "constraint" : [
          {
            ...
            "source" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medicationrequest-changed"
          }
        ]
      },
      {
