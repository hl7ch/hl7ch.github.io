# Composition: use case PML #6b - CH EMED EPR v3.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Composition: use case PML #6b**

## Example Composition: Composition: use case PML #6b

Language: fr-CH

Profile: [PML Composition](StructureDefinition-ch-emed-epr-composition-medicationlist.md)

**identifier**: [Uniform Resource Identifier (URI)](http://terminology.hl7.org/6.5.0/NamingSystem-uri.html)/urn:uuid:90561ab0-6b84-4c46-8d97-f205e028b1a5
