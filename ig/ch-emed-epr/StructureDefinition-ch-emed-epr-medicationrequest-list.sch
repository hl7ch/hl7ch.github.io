...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile CHEMEDMedicationRequestList
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationRequest">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-ext-prescription']) &gt;= 1">extension with URL = 'http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-ext-prescription': minimum cardinality of 'extension' is 1</sch:assert>
