# PRE Composition - CH EMED EPR v3.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **PRE Composition**

## Resource Profile: PRE Composition 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-composition-medicationprescription | *Version*:3.0.0 |
| Draft as of 2026-02-11 | *Computable Name*:CHEMEDEPRCompositionMedicationPrescription |
...
* Use this Profile: [PRE Document](StructureDefinition-ch-emed-epr-document-medicationprescription.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-emed-epr|current/StructureDefinition/ch-emed-epr-composition-medicationprescription)
...
Other representations of profile: [CSV](StructureDefinition-ch-emed-epr-composition-medicationprescription.csv), [Excel](StructureDefinition-ch-emed-epr-composition-medicationprescription.xlsx), [Schematron](StructureDefinition-ch-emed-epr-composition-medicationprescription.sch) 
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-composition-medicationprescription",
  "version" : "3.0.0",
  "name" : "CHEMEDEPRCompositionMedicationPrescription",
  ...
  "abstract" : false,
  "type" : "Composition",
  "baseDefinition" : "http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-composition-medicationprescription",
    ...
    "element" : [
      {
        ...
        "constraint" : [
          {
            "key" : "pre-composition-title",
            "severity" : "warning",
            "human" : "The PRE composition title must be: 'Rezept' in German or 'Ordonnance' in French or 'Ricetta' in Italian or 'Prescription' in English or titles in other languages are also allowed.",
            ...
            "source" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-composition-medicationprescription"
          }
        ]
      },
      {
      ...
      {
        "id" : "Composition.section:prescription.modifierExtension",
        "path" : "Composition.section.modifierExtension",
        "max" : "0"
      },
      {
        "id" : "Composition.section:prescription.author",
        "extension" : [
          {
            "url" : "http://hl7.org/fhir/StructureDefinition/structuredefinition-standards-status",
            "valueCode" : "draft"
