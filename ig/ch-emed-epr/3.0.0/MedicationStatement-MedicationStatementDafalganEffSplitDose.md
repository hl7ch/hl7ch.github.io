# MedicationStatement: Paracetamol Dafalgan Effervescent (MTP) with split dose - CH EMED EPR v3.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MedicationStatement: Paracetamol Dafalgan Effervescent (MTP) with split dose**

## Example MedicationStatement: MedicationStatement: Paracetamol Dafalgan Effervescent (MTP) with split dose
...
```json
{
  ...
  "id" : "MedicationStatementDafalganEffSplitDose",
  "meta" : {
    "profile" : [
  ...
  "identifier" : [
    {
      ...
      "value" : "urn:uuid:0564998f-b3b2-4e70-8daf-52d7c5d50eb3"
    }
  ],
  "status" : "active",
  "medicationReference" : {
  ...
  "dosage" : [
    {
      "sequence" : 1,
      "text" : "2 comprimés à avaler le matin et 1 comprimé à avaler le soir.",
      "timing" : {
        "repeat" : {
          "boundsPeriod" : {
            "start" : "2023-11-05",
