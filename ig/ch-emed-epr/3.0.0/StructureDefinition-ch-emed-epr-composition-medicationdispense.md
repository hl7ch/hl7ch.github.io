# DIS Composition - CH EMED EPR v3.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **DIS Composition**

## Resource Profile: DIS Composition 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-composition-medicationdispense | *Version*:3.0.0 |
| Draft as of 2026-02-11 | *Computable Name*:CHEMEDEPRCompositionMedicationDispense |
...
* Use this Profile: [DIS Document](StructureDefinition-ch-emed-epr-document-medicationdispense.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-emed-epr|current/StructureDefinition/ch-emed-epr-composition-medicationdispense)
...
Other representations of profile: [CSV](StructureDefinition-ch-emed-epr-composition-medicationdispense.csv), [Excel](StructureDefinition-ch-emed-epr-composition-medicationdispense.xlsx), [Schematron](StructureDefinition-ch-emed-epr-composition-medicationdispense.sch) 
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-composition-medicationdispense",
  "version" : "3.0.0",
  "name" : "CHEMEDEPRCompositionMedicationDispense",
  ...
  "abstract" : false,
  "type" : "Composition",
  "baseDefinition" : "http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-composition-medicationdispense",
    ...
    "element" : [
      {
        ...
        "constraint" : [
          {
            "key" : "dis-composition-title",
            "severity" : "warning",
            "human" : "The DIS composition title must be: 'Abgabe' in German or 'Remise' in French or 'Dispensazione' in Italian or 'Dispense' in English or titles in other languages are also allowed.",
            ...
            "source" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-composition-medicationdispense"
          }
        ]
      },
      {
      ...
      {
        "id" : "Composition.section:dispense.modifierExtension",
        "path" : "Composition.section.modifierExtension",
        "max" : "0"
      },
      {
        "id" : "Composition.section:dispense.author",
        "extension" : [
          {
            "url" : "http://hl7.org/fhir/StructureDefinition/structuredefinition-standards-status",
            "valueCode" : "draft"
