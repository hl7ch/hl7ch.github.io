# Ratio (Amount / Amount) - CH EMED EPR v3.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-ratio-amount-per-amount | *Version*:3.0.0 |
| Draft as of 2026-02-11 | *Computable Name*:CHEMEDEPRRatioAmountPerAmount |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-emed-epr|current/StructureDefinition/ch-emed-epr-ratio-amount-per-amount)
...
Other representations of profile: [CSV](StructureDefinition-ch-emed-epr-ratio-amount-per-amount.csv), [Excel](StructureDefinition-ch-emed-epr-ratio-amount-per-amount.xlsx), [Schematron](StructureDefinition-ch-emed-epr-ratio-amount-per-amount.sch) 
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-ratio-amount-per-amount",
  "version" : "3.0.0",
  "name" : "CHEMEDEPRRatioAmountPerAmount",
