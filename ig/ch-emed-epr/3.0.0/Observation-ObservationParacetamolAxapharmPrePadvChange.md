...
**CH EMED Extension MedicationRequest Changed**: [MedicationRequest: extension = ; identifier = UUID:ac8ad5cd-aa46-49d6-a5ec-fbc48a9287b4; status = active; intent = order; medication[x] = ->Medication DAFALGAN cpr eff 500mg; authoredOn = 2023-11-04 12:00:00+0200; note = Difficulté à prendre le comprimé pelliculé, substitution par un comprimé effervescent.](Bundle-DocumentPadvChangeParacetamolCARAPMP004.md#urn-uuid-ac8ad5cd-aa46-49d6-a5ec-fbc48a9287b4)

**identifier**: [Uniform Resource Identifier (URI)](http://terminology.hl7.org/6.5.0/NamingSystem-uri.html)/urn:uuid:7e64e4bf-65d9-40d4-a2b5-e7ddc254f08d
