# PML MedicationRequest - CH EMED EPR v3.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **PML MedicationRequest**

## Resource Profile: PML MedicationRequest 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medicationrequest-list | *Version*:3.0.0 |
| Draft as of 2026-02-11 | *Computable Name*:CHEMEDEPRMedicationRequestList |
...
* Examples for this Profile: [MedicationRequest/MedicationRequestParacetamolAxapharmPml](MedicationRequest-MedicationRequestParacetamolAxapharmPml.md) and [MedicationRequest/MedicationRequestTriatecPml](MedicationRequest-MedicationRequestTriatecPml.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-emed-epr|current/StructureDefinition/ch-emed-epr-medicationrequest-list)
...
Other representations of profile: [CSV](StructureDefinition-ch-emed-epr-medicationrequest-list.csv), [Excel](StructureDefinition-ch-emed-epr-medicationrequest-list.xlsx), [Schematron](StructureDefinition-ch-emed-epr-medicationrequest-list.sch) 
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medicationrequest-list",
  "version" : "3.0.0",
  "name" : "CHEMEDEPRMedicationRequestList",
  ...
  "baseDefinition" : "http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-medicationrequest-list",
  ...
  "differential" : {
    "element" : [
        ...
        "constraint" : [
          {
            ...
            "source" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medicationrequest-list"
          }
        ]
      },
      {
      ...
      {
        "id" : "MedicationRequest.extension:authorDocument.value[x]",
