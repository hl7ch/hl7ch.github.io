...
* Added a use case to guidance with a scenario of self-medication treatment **modified** at a later stage by a professional.
* Added more examples.
...
* Added an alternative scenario to the [Use Case](use_case.md) to showcase a PADV CHANGE and a PML including changed resources.
