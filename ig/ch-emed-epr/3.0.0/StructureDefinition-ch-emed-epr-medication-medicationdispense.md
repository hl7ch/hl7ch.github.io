# CH EMED EPR Medication (DIS) - CH EMED EPR v3.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH EMED EPR Medication (DIS)**

## Resource Profile: CH EMED EPR Medication (DIS) 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medication-medicationdispense | *Version*:3.0.0 |
| Draft as of 2026-02-11 | *Computable Name*:CHEMEDEPRMedicationMedicationDispense |
...
* Refer to this Profile: [PML MedicationDispense](StructureDefinition-ch-emed-epr-medicationdispense-list.md) and [DIS MedicationDispense](StructureDefinition-ch-emed-epr-medicationdispense.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-emed-epr|current/StructureDefinition/ch-emed-epr-medication-medicationdispense)
...
Other representations of profile: [CSV](StructureDefinition-ch-emed-epr-medication-medicationdispense.csv), [Excel](StructureDefinition-ch-emed-epr-medication-medicationdispense.xlsx), [Schematron](StructureDefinition-ch-emed-epr-medication-medicationdispense.sch) 
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medication-medicationdispense",
  "version" : "3.0.0",
  "name" : "CHEMEDEPRMedicationMedicationDispense",
  ...
  "abstract" : false,
  "type" : "Medication",
  "baseDefinition" : "http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-medication-medicationdispense",
