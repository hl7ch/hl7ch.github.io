# Bundle: use case PML #6b - CH EMED EPR v3.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Bundle: use case PML #6b**

## Example Bundle: Bundle: use case PML #6b
