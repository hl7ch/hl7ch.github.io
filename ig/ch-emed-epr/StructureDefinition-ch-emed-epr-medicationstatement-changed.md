# PADV Changed MedicationStatement - CH EMED EPR v3.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **PADV Changed MedicationStatement**

## Resource Profile: PADV Changed MedicationStatement 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medicationstatement-changed | *Version*:3.0.0 |
| Draft as of 2026-02-11 | *Computable Name*:CHEMEDEPRChangedMedicationStatement |
...
* Refer to this Profile: [PADV Observation](StructureDefinition-ch-emed-epr-observation.md)
* Examples for this Profile: [MedicationStatement/MedicationStatementTriatecPadv](MedicationStatement-MedicationStatementTriatecPadv.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-emed-epr|current/StructureDefinition/ch-emed-epr-medicationstatement-changed)
...
Other representations of profile: [CSV](StructureDefinition-ch-emed-epr-medicationstatement-changed.csv), [Excel](StructureDefinition-ch-emed-epr-medicationstatement-changed.xlsx), [Schematron](StructureDefinition-ch-emed-epr-medicationstatement-changed.sch) 
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medicationstatement-changed",
  "version" : "3.0.0",
  "name" : "CHEMEDEPRChangedMedicationStatement",
  ...
  "baseDefinition" : "http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-medicationstatement-changed",
        ...
        "constraint" : [
          {
            ...
            "source" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medicationstatement-changed"
          }
        ]
      },
      {
