# PML Changed Medication Request - CH EMED EPR v3.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **PML Changed Medication Request**

## Resource Profile: PML Changed Medication Request 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medication-request-changed-list | *Version*:3.0.0 |
| Draft as of 2026-02-11 | *Computable Name*:CHEMEDEPRMedicationRequestChangedList |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-emed-epr|current/StructureDefinition/ch-emed-epr-medication-request-changed-list)
...
Other representations of profile: [CSV](StructureDefinition-ch-emed-epr-medication-request-changed-list.csv), [Excel](StructureDefinition-ch-emed-epr-medication-request-changed-list.xlsx), [Schematron](StructureDefinition-ch-emed-epr-medication-request-changed-list.sch) 
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medication-request-changed-list",
  "version" : "3.0.0",
  "name" : "CHEMEDEPRMedicationRequestChangedList",
  ...
  "baseDefinition" : "http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-medicationrequest-changed-list",
        ...
        "constraint" : [
          {
            ...
            "source" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medication-request-changed-list"
          }
        ]
      },
      {
