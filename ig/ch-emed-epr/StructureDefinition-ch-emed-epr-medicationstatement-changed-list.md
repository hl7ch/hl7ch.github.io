# PML Changed MedicationStatement - CH EMED EPR v3.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **PML Changed MedicationStatement**

## Resource Profile: PML Changed MedicationStatement 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medicationstatement-changed-list | *Version*:3.0.0 |
| Draft as of 2026-02-11 | *Computable Name*:CHEMEDEPRMedicationStatementChangedList |
| **Copyright/Legal**: CC0-1.0 | |

 
Definition of the changed medication statement for the medication list document 

**Usages:**

* Refer to this Profile: [PML Composition](StructureDefinition-ch-emed-epr-composition-medicationlist.md) and [PML Observation](StructureDefinition-ch-emed-epr-observation-list.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-emed-epr|current/StructureDefinition/ch-emed-epr-medicationstatement-changed-list)
...
Other representations of profile: [CSV](StructureDefinition-ch-emed-epr-medicationstatement-changed-list.csv), [Excel](StructureDefinition-ch-emed-epr-medicationstatement-changed-list.xlsx), [Schematron](StructureDefinition-ch-emed-epr-medicationstatement-changed-list.sch) 
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medicationstatement-changed-list",
  "version" : "3.0.0",
  "name" : "CHEMEDEPRMedicationStatementChangedList",
  ...
  "baseDefinition" : "http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-medicationstatement-changed-list",
        ...
        "constraint" : [
          {
            ...
            "source" : "http://fhir.ch/ig/ch-emed-epr/StructureDefinition/ch-emed-epr-medicationstatement-changed-list"
          }
        ]
      },
      {
