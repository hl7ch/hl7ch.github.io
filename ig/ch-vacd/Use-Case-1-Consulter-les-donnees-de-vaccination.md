# Use Case 1 Consulter Les Donnees De Vaccination - Implementation Guide CH VACD v6.0.0

* [**Table of Contents**](toc.md)
* **Use Case 1 Consulter Les Donnees De Vaccination**

## Use Case 1 Consulter Les Donnees De Vaccination

### Consulter les données de vaccination (professionnel de la santé)

Un professionnel de la santé consulte les données de vaccination (**dossier de vaccination et documentation de vaccination**) dans le DEP d’un patient via son système primaire ou le portail de la communauté. Il choisit à cet effet les interfaces utilisateur correspondantes dans le système primaire ou sur le portail et recherche le patient. Il consulte ensuite le **dossier de vaccination** dans le DEP qui contient les informations suivantes: vaccinations administrées, contre-indications, maladies infectieuses contractées, effets indésirables des vaccins, résultats de laboratoire et sérologiques, facteurs de risque médicaux et statut des vaccinations de base. Le professionnel de la santé consulte les données de vaccination dans le système primaire ou sur le portail de la communauté et prend en compte ces informations pour établir un diagnostic ou proposer une thérapie.
