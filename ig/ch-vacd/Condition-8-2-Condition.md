# 8.2 Condition (Medical Problems) - Implementation Guide CH VACD v7.0.0-ballot
...
**identifier**: [Uniform Resource Identifier (URI)](http://terminology.hl7.org/6.3.0/NamingSystem-uri.html)/urn:uuid:6a756da6-f849-4e73-a30a-bcaa8dc13ebd
