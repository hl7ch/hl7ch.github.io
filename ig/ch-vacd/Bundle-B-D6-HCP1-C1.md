# Test Case B 05: Document HCP1 with Medical Problem and Pregnancy Entries - Implementation Guide CH VACD v6.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Test Case B 05: Document HCP1 with Medical Problem and Pregnancy Entries**

## Example Bundle: Test Case B 05: Document HCP1 with Medical Problem and Pregnancy Entries
...
```json
{
  ...
  "identifier" : {
    ...
    "value" : "urn:uuid:47ac85eb-787d-452b-b6a4-abc83e600720"
  },
  "type" : "document",
  "timestamp" : "2021-03-10T14:00:00.390+02:00",
  "entry" : [
    {
      "fullUrl" : "http://test.fhir.ch/r4/Composition/B-D6-HCP1-C1-Composition",
      "resource" : {
