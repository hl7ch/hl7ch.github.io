...
```json
{
  ...
  "entry" : [
    {
      "fullUrl" : "http://test.fhir.ch/r4/Composition/RDB03-Composition",
      "resource" : {
        "resourceType" : "Composition",
        "id" : "RDB03-Composition",
        "meta" : {
          "profile" : [
