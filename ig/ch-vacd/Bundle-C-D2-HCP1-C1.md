# Test Case C 02: GFP Dokument (C_D2_HCP1_C1) - Implementation Guide CH VACD v6.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Test Case C 02: GFP Dokument (C_D2_HCP1_C1)**

## Example Bundle: Test Case C 02: GFP Dokument (C_D2_HCP1_C1)
...
```json
{
  ...
  "entry" : [
    {
      "fullUrl" : "http://test.fhir.ch/r4/Composition/C-D2-HCP1-C1-Composition",
      "resource" : {
    ...
    {
      "fullUrl" : "http://test.fhir.ch/r4/Immunization/TCC02-IMMUN3-HCP1-ORG1-ROLE",
      "resource" : {
