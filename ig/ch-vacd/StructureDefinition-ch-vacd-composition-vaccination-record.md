# CH VACD VaccinationRecord Composition - Implementation Guide CH VACD v7.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-vacd/StructureDefinition/ch-vacd-composition-vaccination-record | *Version*:7.0.0-ballot |
| Active as of 2026-06-11 | *Computable Name*:CHVACDCompositionVaccinationRecord |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-vacd|current/StructureDefinition/StructureDefinition-ch-vacd-composition-vaccination-record.json)
