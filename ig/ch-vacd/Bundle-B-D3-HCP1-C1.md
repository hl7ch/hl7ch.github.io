# Test Case B 02: Document HCP1 with Past Illness Entries - Implementation Guide CH VACD v6.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Test Case B 02: Document HCP1 with Past Illness Entries**

## Example Bundle: Test Case B 02: Document HCP1 with Past Illness Entries
...
```json
{
  ...
  "entry" : [
    {
      "fullUrl" : "http://test.fhir.ch/r4/Composition/B-D3-HCP1-C1-Composition",
      "resource" : {
        "resourceType" : "Composition",
        "id" : "B-D3-HCP1-C1-Composition",
        "meta" : {
          "profile" : [
