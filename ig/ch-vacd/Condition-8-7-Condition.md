# 8.7 Condition (Medical Problems for Recommendation Request/Response) - Implementation Guide CH VACD v7.0.0-ballot
...
**identifier**: [Uniform Resource Identifier (URI)](http://terminology.hl7.org/6.3.0/NamingSystem-uri.html)/urn:uuid:36d1ebae-564e-4c2a-8af6-c1224c3d9e77
