# 10.2 ImmunizationRecommendation - Implementation Guide CH VACD v7.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **10.2 ImmunizationRecommendation**

## Example ImmunizationRecommendation: 10.2 ImmunizationRecommendation
...
```json
{
  ...
  "id" : "10-2-ImmunizationRecommendation",
  "meta" : {
