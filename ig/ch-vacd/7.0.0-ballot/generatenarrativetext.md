# Generatenarrativetext - Implementation Guide CH VACD v7.0.0-ballot
...
Examples with the generated narrative can be seen here: [Immunization Administration Document](Bundle-1-1-ImmunizationAdministration.md) and [Vaccination Record](Bundle-1-3-VaccinationRecord.md)
