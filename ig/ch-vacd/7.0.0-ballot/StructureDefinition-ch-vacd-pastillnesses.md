# CH VACD Past Illness - Implementation Guide CH VACD v7.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-vacd/StructureDefinition/ch-vacd-pastillnesses | *Version*:7.0.0-ballot |
| Draft as of 2026-06-11 | *Computable Name*:CHVACDPastIllness |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-vacd|current/StructureDefinition/StructureDefinition-ch-vacd-pastillnesses.json)
