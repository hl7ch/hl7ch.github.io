# TC1 Immunization by HCP1 - Implementation Guide CH VACD v7.0.0-ballot
...
* entry: [Immunization: extension = ->PractitionerRole,->Medication BOOSTRIX Inj Susp,Confirmed (SNOMED CT#59156000),; identifier = urn:oid:2.999.1.2.3.4#urn:uuid:58457607-9160-4d0a-9a79-55495755a677; status = completed; vaccineCode = Boostrix; occurrence[x] = 2020-12-09; recorded = 2020-12-09 11:00:00+0200; lotNumber = AHAVB946A; route = Intramuscular use](Immunization-TCD01-IMMUN3-2.md)
* conflict: duplicate
