# 7.9 Immunization (Recommendation Request/Response) - Implementation Guide CH VACD v7.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **7.9 Immunization (Recommendation Request/Response)**

## Example Immunization: 7.9 Immunization (Recommendation Request/Response)

Profile: [CH VACD Immunization](StructureDefinition-ch-vacd-immunization.md)

**Author of the content**: [PractitionerRole](PractitionerRole-6-5-PractitionerRole.md)

**CH VACD Extension verificationStatus**: [SNOMED CT: 59156000](http://snomed.info/id/59156000) (Confirmed)

**identifier**: `urn:oid:2.999.1.2.3.4`/34567
...
**occurrence**: 2015-11-01 00:00:00+0100

**recorded**: 2015-11-01 00:00:00+0100
...
| :--- | :--- |
| - | **Actor** |
| * | [PractitionerRole](PractitionerRole-6-5-PractitionerRole.md) |
