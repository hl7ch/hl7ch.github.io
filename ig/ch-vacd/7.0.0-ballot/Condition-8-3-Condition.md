# 8.3 Condition (Medical Problems) - Implementation Guide CH VACD v7.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **8.3 Condition (Medical Problems)**

## Example Condition: 8.3 Condition (Medical Problems)

Profile: [CH VACD Medical Problems](StructureDefinition-ch-vacd-medical-problems.md)

**identifier**: [Uniform Resource Identifier (URI)](http://terminology.hl7.org/7.1.0/NamingSystem-uri.html)/urn:uuid:917147db-fce9-49e9-af20-aa25dd25e283
