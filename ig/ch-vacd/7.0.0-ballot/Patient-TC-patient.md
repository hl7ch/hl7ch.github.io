# TC patient 1 - Implementation Guide CH VACD v7.0.0-ballot
...
Profile: [CH Core Patient EPR](http://fhir.ch/ig/ch-core/7.0.0-ballot/StructureDefinition-ch-core-patient-epr.html)
