# TC HCP1 ORG1 Role Author in C1 - Implementation Guide CH VACD v7.0.0-ballot
...
Profile: [CH Core PractitionerRole EPR](http://fhir.ch/ig/ch-core/7.0.0-ballot/StructureDefinition-ch-core-practitionerrole-epr.html)
