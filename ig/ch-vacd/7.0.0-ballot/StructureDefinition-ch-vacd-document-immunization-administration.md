# CH VACD Immunization Administration Document - Implementation Guide CH VACD v7.0.0-ballot
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-vacd/StructureDefinition/ch-vacd-document-immunization-administration | *Version*:7.0.0-ballot | |
| Active as of 2026-06-11 | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 5 | *Computable Name*:CHVACDDocumentImmunizationAdministration |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-vacd|current/StructureDefinition/StructureDefinition-ch-vacd-document-immunization-administration.json)
