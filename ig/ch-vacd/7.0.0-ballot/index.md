# Home - Implementation Guide CH VACD v7.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-vacd/ImplementationGuide/ch.fhir.ig.ch-vacd | *Version*:7.0.0-ballot |
| Active as of 2026-06-10 | *Computable Name*:CH_VACD |
...
* [CDS Event](CodeSystem-ch-vacd-clinical-decision-support-event-cs.md): [Bundle/1-4-ImmunizationRecommendationRequest](Bundle-1-4-ImmunizationRecommendationRequest.md), [Bundle/1-5-ImmunizationRecommendationResponse](Bundle-1-5-ImmunizationRecommendationResponse.md)... Show 6 more, [CHVACDPatientExportOperationVS](ValueSet-ch-vacd-patient-export-operation-vs.md), [CHVACDRecommendationRequestMessageHeader](StructureDefinition-ch-vacd-recommendation-request-messageheader.md), [CHVACDRecommendationResponseMessageHeader](StructureDefinition-ch-vacd-recommendation-response-messageheader.md), [GeneratePatientExportDocument](OperationDefinition-ch-vacd-patient-export-operation.md), [MessageHeader/2-4-ImmunizationRecommendationRequestMessageHeader](MessageHeader-2-4-ImmunizationRecommendationRequestMessageHeader.md) and [MessageHeader/2-5-ImmunizationRecommendationResponseMessageHeader](MessageHeader-2-5-ImmunizationRecommendationResponseMessageHeader.md)
...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Condition/8-10-Condition"
      },
      "name" : "8.10 Condition (TravelInformation)",
      "description" : "Example Condition for travel information",
      "exampleCanonical" : "http://fhir.ch/ig/ch-vacd/StructureDefinition/ch-vacd-travel-information"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "name" : "8.10 Travel Location (TravelInformation)",
      "description" : "Example for travel location",
      "exampleCanonical" : "http://fhir.ch/ig/ch-vacd/StructureDefinition/ch-vacd-travel-location"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CapabilityStatement/ch-vacd-api-capstmt-srv"
      },
      "name" : "CH VACD FHIR API CapabilityStatement for server",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/ch-vacd-travel-information"
      },
      "name" : "CH VACD Travel Information",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/ch-vacd-travel-code-vs"
      },
      "name" : "CH VACD Travel Information Code",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/ch-vacd-travel-location"
      },
      "name" : "CH VACD Travel Location",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/ch-vacd-travel-location-address"
      },
      "name" : "CH VACD Travel Location Address",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/ch-vacd-patient-export-operation-vs"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "OperationDefinition/ch-vacd-patient-export-operation"
      },
      "name" : "Generate export document",
    ...
    "page" : {
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "REST-API.html"
        }],
        "nameUrl" : "REST-API.html",
        "title" : "REST API",
        "generation" : "markdown"
      },
      {
