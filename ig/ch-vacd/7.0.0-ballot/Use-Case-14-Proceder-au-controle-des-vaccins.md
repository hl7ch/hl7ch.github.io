# Use Case 14 Proceder Au Controle Des Vaccins - Implementation Guide CH VACD v7.0.0-ballot
...
Le professionnel de la santé lance le contrôle vaccinal automatique, consulte les recommandations vaccinales et en discute avec le patient.

S’il existe une recommandation vaccinale et que le patient souhaite se faire vacciner, le professionnel de la santé effectue la vaccination et la documente.
...
La patiente ou le patient lance le contrôle vaccinal automatique et consulte les recommandations vaccinales.

Si le contrôle vaccinal émet une recommandation et que la patiente ou le patient souhaite se faire vacciner, elle ou il prend rendez-vous avec son professionnel de la santé.

Le professionnel de la santé effectue la vaccination et la documente dans son système.
