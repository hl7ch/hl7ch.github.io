# CH VACD Extension Immunization Medication Reference - Implementation Guide CH VACD v7.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-vacd/StructureDefinition/ch-vacd-ext-immunization-medication-reference | *Version*:7.0.0-ballot |
...
This extension is used to reference a [CH VACD Medication For Immunization](StructureDefinition-ch-vacd-medication-for-immunization.md) resource on a [CH VACD Immunization](StructureDefinition-ch-vacd-immunization.md) resource.

The [CH VACD Immunization](StructureDefinition-ch-vacd-immunization.md) resource itself only records the type of vaccine given to the patient using Immunization.vaccineCode.

The [CH VACD Medication For Immunization resource](StructureDefinition-ch-vacd-medication-for-immunization.md) documents the exact product used - such as a specific vaccine identified by its GTIN code.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-vacd|current/StructureDefinition/StructureDefinition-ch-vacd-ext-immunization-medication-reference.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://fhir.ch/ig/ch-vacd/StructureDefinition/ch-vacd-medication-for-immunization"]
      }],
      "mustSupport" : true
    }]
  }
