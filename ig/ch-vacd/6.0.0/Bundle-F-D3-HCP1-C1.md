...
```json
{
  ...
  "entry" : [
    {
      "fullUrl" : "http://test.fhir.ch/r4/Composition/F-D3-HCP1-C1-Composition",
      "resource" : {
    ...
    {
      "fullUrl" : "http://test.fhir.ch/r4/AllergyIntolerance/TCF02-ALLINTO1",
      "resource" : {
