# 1.5 Immunization Recommendation Response - Implementation Guide CH VACD v6.0.0
...
```json
{
  ...
  "meta" : {
    ...
    "profile" : [
      "http://fhir.ch/ig/ch-vacd/StructureDefinition/ch-vacd-recommendation-response-message"
    ]
  },
  "identifier" : {
