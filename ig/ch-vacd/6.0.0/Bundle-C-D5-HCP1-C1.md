...
```json
{
  ...
  "entry" : [
    {
      "fullUrl" : "http://test.fhir.ch/r4/Composition/C-D5-HCP1-C1-Composition",
      "resource" : {
    ...
    {
      "fullUrl" : "http://test.fhir.ch/r4/Condition/TCC04-EXPRISK2",
      "resource" : {
