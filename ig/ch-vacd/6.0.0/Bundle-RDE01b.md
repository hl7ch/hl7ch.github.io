# Test Case E 01: Aggregated Dokument (RDE01) - Implementation Guide CH VACD v6.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Test Case E 01: Aggregated Dokument (RDE01)**

## Example Bundle: Test Case E 01: Aggregated Dokument (RDE01)
...
```json
{
  ...
  "entry" : [
    {
      "fullUrl" : "http://test.fhir.ch/r4/Composition/RDE01-Composition-b",
      "resource" : {
