...
```json
{
  ...
  "entry" : [
    {
      "fullUrl" : "http://test.fhir.ch/r4/Composition/RDC03-Composition",
      "resource" : {
        "resourceType" : "Composition",
        "id" : "RDC03-Composition",
        "meta" : {
          "profile" : [
