# Test Case B 01: Document HCP1 with AllergyIntolerance Entry - Implementation Guide CH VACD v6.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Test Case B 01: Document HCP1 with AllergyIntolerance Entry**

## Example Bundle: Test Case B 01: Document HCP1 with AllergyIntolerance Entry
...
```json
{
  ...
  "entry" : [
    {
      "fullUrl" : "http://test.fhir.ch/r4/Composition/B-D2-HCP1-C1-Composition",
      "resource" : {
