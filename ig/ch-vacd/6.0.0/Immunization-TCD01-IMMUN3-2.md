...
* entry: [Immunization: extension = ->PractitionerRole,->Medication BOOSTRIX Inj Susp,Confirmed (SNOMED CT#59156000),; identifier = urn:oid:2.999.1.2.3.4#urn:uuid:ebcf6de2-ed9c-463c-8b08-cb487af8ce4e; status = completed; vaccineCode = Boostrix; occurrence[x] = 2020-12-09; recorded = 2020-12-09 11:00:00+0200; lotNumber = AHAVB946A; route = Intramuscular use](Immunization-TCD01-IMMUN2-2.md)
* conflict: duplicate
