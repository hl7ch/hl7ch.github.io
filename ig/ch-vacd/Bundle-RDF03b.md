# Test Case F 03: Add comment (note) to an existing Condition(PastIllness) - Implementation Guide CH VACD v6.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Test Case F 03: Add comment (note) to an existing Condition(PastIllness)**

## Example Bundle: Test Case F 03: Add comment (note) to an existing Condition(PastIllness)
...
```json
{
  ...
  "identifier" : {
    ...
    "value" : "urn:uuid:fbee3bad-383c-47ce-b6b5-d6c76af58862"
  },
  "type" : "document",
  ...
  "entry" : [
        ...
        "section" : [
          {
            ...
            "text" : {
              "status" : "generated",
              "div" : "<div xml:lang=\"en-US\" xmlns=\"http://www.w3.org/1999/xhtml\" lang=\"en-US\"><p><b>Code: </b><span>Hx of Past illness (http://loinc.org#11348-0)</span></p><p><b>Entries:</b></p><table><tr><td><a href=\"Condition-TCF03-UNDILL3.html\">Condition/TCF03-UNDILL3</a></td></tr></table></div>"
            },
            "entry" : [
              {
    ...
    },
    {
      ...
      "resource" : {
        ...
        "text" : {
          "status" : "generated",
          "div" : "<div xmlns=\"http://www.w3.org/1999/xhtml\"><a name=\"Condition_TCF03-UNDILL3\"> </a><p class=\"res-header-id\"><b>Generated Narrative: Condition TCF03-UNDILL3</b></p><a name=\"TCF03-UNDILL3\"> </a><a name=\"hcTCF03-UNDILL3\"> </a><div style=\"display: inline-block; background-color: #d9e0e7; padding: 6px; margin: 4px; border: 1px solid #8da1b4; border-radius: 5px; line-height: 60%\"><p style=\"margin-bottom: 0px\"/><p style=\"margin-bottom: 0px\">Profile: <a href=\"StructureDefinition-ch-vacd-pastillnesses.html\">CH VACD Past Illness</a></p></div><p><b>identifier</b>: <code>urn:oid:2.999.1.2.3.4</code>/61358f4e-7121-4dd3-903a-caa5bf26d87c</p><p><b>clinicalStatus</b>: <span title=\"Codes:{http://terminology.hl7.org/CodeSystem/condition-clinical resolved}\">Resolved</span></p><p><b>verificationStatus</b>: <span title=\"Codes:{http://terminology.hl7.org/CodeSystem/condition-ver-status confirmed}\">Confirmed</span></p><p><b>code</b>: <span title=\"Codes:{http://snomed.info/sct 38907003}\">Varicella (disorder)</span></p><p><b>subject</b>: <a href=\"Patient-TC-patient.html\">Monika Wegmueller  Female, DoB: 1967-02-10 ( Medical record number)</a></p><p><b>onset</b>: 2015-05-30</p><p><b>recordedDate</b>: 2015-05-30</p><p><b>recorder</b>: <a href=\"PractitionerRole-TC-HCP1-ORG1-ROLE-author.html\">PractitionerRole</a></p><p><b>note</b>: By Practitioner/TC-HCP1-C1 @2017-01-20</p><blockquote><div><p>Der Patient hatte einen milden Verlauf der Windpockenerkrankung</p>\n</div></blockquote></div>"
        },
        "identifier" : [
          {
            "system" : "urn:oid:2.999.1.2.3.4",
