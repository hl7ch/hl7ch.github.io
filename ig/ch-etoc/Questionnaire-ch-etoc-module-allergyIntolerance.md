# Module Questionnaire AllergyIntolerlance - CH eTOC (R4) v3.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Module Questionnaire AllergyIntolerlance**

## Questionnaire: Module Questionnaire AllergyIntolerlance 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-etoc/Questionnaire/ch-etoc-module-allergyIntolerance | *Version*:3.0.1 |
...
```json
{
  ...
  "id" : "ch-etoc-module-allergyIntolerance",
  "extension" : [
    {
