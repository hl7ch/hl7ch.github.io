# Workflow States - CH UMZH Connect IG (R4) v1.0.0-ballot
...
* Only the Fulfiller may change `Task.status` — it is not patchable by the Placer (see [Workflow oriented API design](core-concept-workflow-api.md))
