# Example of audit event for a [PPQ-5] transaction at Repository - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example of audit event for a [PPQ-5] transaction at Repository**

## Example AuditEvent: Example of audit event for a [PPQ-5] transaction at Repository

Profile: [CH Audit Event for [PPQ-5] Policy Repository](StructureDefinition-ChAuditEventPpq5Repository.md)
...
```json
{
  ...
  "id" : "ChAuditEventPpq5RepositoryExample",
  "meta" : {
    "profile" : [
