# CH Audit Event for [CH:MHD-1] Document Source - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH Audit Event for [CH:MHD-1] Document Source**

## Resource Profile: CH Audit Event for [CH:MHD-1] Document Source 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ch-mhd-updatedocumentmetadata-audit-source | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:ChAuditEventChMhd1Source |
...
* Examples for this Profile: [AuditEvent/ChAuditEventChMhd1SourceExample](AuditEvent-ChAuditEventChMhd1SourceExample.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epr-fhir|current/StructureDefinition/ch-mhd-updatedocumentmetadata-audit-source)
...
Other representations of profile: [CSV](StructureDefinition-ch-mhd-updatedocumentmetadata-audit-source.csv), [Excel](StructureDefinition-ch-mhd-updatedocumentmetadata-audit-source.xlsx), [Schematron](StructureDefinition-ch-mhd-updatedocumentmetadata-audit-source.sch) 
        ...
        "constraint" : [
          {
            ...
            "source" : "http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ch-mhd-updatedocumentmetadata-audit-source"
          }
        ]
      },
      {
