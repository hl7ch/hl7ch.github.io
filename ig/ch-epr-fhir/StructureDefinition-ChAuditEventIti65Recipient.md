# CH Audit Event for [ITI-65] Document Recipient - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH Audit Event for [ITI-65] Document Recipient**

## Resource Profile: CH Audit Event for [ITI-65] Document Recipient 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventIti65Recipient | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:ChAuditEventIti65Recipient |
...
* Examples for this Profile: [AuditEvent/ChAuditEventIti65RecipientExample](AuditEvent-ChAuditEventIti65RecipientExample.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epr-fhir|current/StructureDefinition/ChAuditEventIti65Recipient)
...
Other representations of profile: [CSV](StructureDefinition-ChAuditEventIti65Recipient.csv), [Excel](StructureDefinition-ChAuditEventIti65Recipient.xlsx), [Schematron](StructureDefinition-ChAuditEventIti65Recipient.sch) 
...
```json
{
  ...
  "id" : "ChAuditEventIti65Recipient",
  "url" : "http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventIti65Recipient",
  "version" : "5.0.0",
  "name" : "ChAuditEventIti65Recipient",
  ...
  "abstract" : false,
  "type" : "AuditEvent",
  "baseDefinition" : "https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.ProvideBundle.Audit.Recipient",
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "AuditEvent.entity:submissionSet.what.identifier",
        "path" : "AuditEvent.entity.what.identifier",
        "min" : 1
      },
      {
        "id" : "AuditEvent.entity:submissionSet.what.identifier.system",
        "path" : "AuditEvent.entity.what.identifier.system",
        "min" : 1,
        "patternUri" : "urn:ietf:rfc:3986"
      },
      {
        "id" : "AuditEvent.entity:submissionSet.what.identifier.value",
        "path" : "AuditEvent.entity.what.identifier.value",
        "min" : 1
      },
      {
