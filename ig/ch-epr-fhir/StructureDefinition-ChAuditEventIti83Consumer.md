# CH Audit Event for [ITI-83] Patient Identifier Cross-reference Consumer - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH Audit Event for [ITI-83] Patient Identifier Cross-reference Consumer**

## Resource Profile: CH Audit Event for [ITI-83] Patient Identifier Cross-reference Consumer 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventIti83Consumer | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:ChAuditEventIti83Consumer |
...
* Examples for this Profile: [AuditEvent/ChAuditEventIti83ConsumerExample](AuditEvent-ChAuditEventIti83ConsumerExample.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epr-fhir|current/StructureDefinition/ChAuditEventIti83Consumer)
...
Other representations of profile: [CSV](StructureDefinition-ChAuditEventIti83Consumer.csv), [Excel](StructureDefinition-ChAuditEventIti83Consumer.xlsx), [Schematron](StructureDefinition-ChAuditEventIti83Consumer.sch) 
...
```json
{
  ...
  "abstract" : false,
  "type" : "AuditEvent",
  "baseDefinition" : "https://profiles.ihe.net/ITI/PIXm/StructureDefinition/IHE.PIXm.Query.Audit.Consumer",
