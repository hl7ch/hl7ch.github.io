...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Bundle/f:entry/f:search">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/match-grade']) &gt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/match-grade': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/match-grade']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/match-grade': maximum cardinality of 'extension' is 1</sch:assert>
