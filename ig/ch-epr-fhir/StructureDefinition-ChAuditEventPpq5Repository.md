# CH Audit Event for [PPQ-5] Policy Repository - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH Audit Event for [PPQ-5] Policy Repository**

## Resource Profile: CH Audit Event for [PPQ-5] Policy Repository 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventPpq5Repository | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:ChAuditEventPpq5Repository |
...
* Examples for this Profile: [AuditEvent/ChAuditEventPpq5RepositoryExample](AuditEvent-ChAuditEventPpq5RepositoryExample.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epr-fhir|current/StructureDefinition/ChAuditEventPpq5Repository)
...
Other representations of profile: [CSV](StructureDefinition-ChAuditEventPpq5Repository.csv), [Excel](StructureDefinition-ChAuditEventPpq5Repository.xlsx), [Schematron](StructureDefinition-ChAuditEventPpq5Repository.sch) 
