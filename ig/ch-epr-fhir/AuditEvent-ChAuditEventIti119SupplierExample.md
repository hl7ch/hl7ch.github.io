# Example of audit event for an [ITI-119] transaction at Supplier - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example of audit event for an [ITI-119] transaction at Supplier**

## Example AuditEvent: Example of audit event for an [ITI-119] transaction at Supplier

Profile: [CH Audit Event for [ITI-119] Patient Demographics Supplier](StructureDefinition-ChAuditEventIti119Supplier.md)
...
**subtype**: [FHIR Restful Interactions: search](http://hl7.org/fhir/R4/codesystem-restful-interaction.html#restful-interaction-search) (search), unknown: ITI-119 (Patient Demographics Match)
...
> **entity****type**:[Audit event entity type: 2](http://terminology.hl7.org/7.0.1/CodeSystem-audit-entity-type.html#audit-entity-type-2)(System Object)**role**:[AuditEventEntityRole: 24](http://terminology.hl7.org/7.0.1/CodeSystem-object-role.html#object-role-24)(Query)**query**:``
...
```json
{
  ...
  "id" : "ChAuditEventIti119SupplierExample",
  "meta" : {
    "profile" : [
