# mCSD-No-peer-PractitionerRole-HansMeierSpitalX - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mCSD-No-peer-PractitionerRole-HansMeierSpitalX**

## Example PractitionerRole: mCSD-No-peer-PractitionerRole-HansMeierSpitalX

Profile: [CH mCSD PractitionerRole](StructureDefinition-CH.mCSD.PractitionerRole.md)

**identifier**: [LDAP](NamingSystem-Ldap.md)/CN=CommunityA:00000001005,OU=Relationship,DC=HPD,O=BAG,C=ch
...
```json
{
  ...
  "id" : "mCSD-No-peer-PractitionerRole-HansMeierSpitalX",
  "meta" : {
    "profile" : [
  ...
  "identifier" : [
    {
      ...
      "value" : "CN=CommunityA:00000001005,OU=Relationship,DC=HPD,O=BAG,C=ch"
    }
  ],
  "active" : true,
  "practitioner" : {
