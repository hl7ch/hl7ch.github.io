# CH Audit Event for [PPQ-3] Delete privacy policy - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH Audit Event for [PPQ-3] Delete privacy policy**

## Resource Profile: CH Audit Event for [PPQ-3] Delete privacy policy 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventPpq3Delete | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:ChAuditEventPpq3Delete |
...
* Examples for this Profile: [AuditEvent/ChAuditEventPpq3DeleteExample](AuditEvent-ChAuditEventPpq3DeleteExample.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epr-fhir|current/StructureDefinition/ChAuditEventPpq3Delete)
...
Other representations of profile: [CSV](StructureDefinition-ChAuditEventPpq3Delete.csv), [Excel](StructureDefinition-ChAuditEventPpq3Delete.xlsx), [Schematron](StructureDefinition-ChAuditEventPpq3Delete.sch) 
...
```json
{
  ...
  "id" : "ChAuditEventPpq3Delete",
  "url" : "http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventPpq3Delete",
  "version" : "5.0.0",
  "name" : "ChAuditEventPpq3Delete",
  ...
  "abstract" : false,
  "type" : "AuditEvent",
  "baseDefinition" : "https://profiles.ihe.net/ITI/BALP/StructureDefinition/IHE.BasicAudit.PatientDelete|1.1.4",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "path" : "AuditEvent.agent",
        "sliceName" : "client",
        "short" : "The 'Policy Source' actor (EPR application)"
      },
      {
        "id" : "AuditEvent.agent:server",
        "path" : "AuditEvent.agent",
        "sliceName" : "server",
        "short" : "The 'Policy Repository' actor (EPR API)"
      },
      {
      ...
      {
        "id" : "AuditEvent.entity:data.what.identifier",
        "path" : "AuditEvent.entity.what.identifier",
        "min" : 1
      },
      {
        "id" : "AuditEvent.entity:data.what.identifier.system",
        "path" : "AuditEvent.entity.what.identifier.system",
        "min" : 1,
        "patternUri" : "urn:ietf:rfc:3986"
      },
      {
        "id" : "AuditEvent.entity:data.what.identifier.value",
