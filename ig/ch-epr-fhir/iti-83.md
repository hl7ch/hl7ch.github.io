# Mobile Patient Identifier Cross-reference Query [ITI-83] - CH EPR FHIR (R4) v5.0.0
...
1. [Patient Identifier Cross-referencing for mobile (PIXm), 3.1.0](https://profiles.ihe.net/ITI/PIXm/3.1.0)
...
The message semantics is the same as defined in [2:3.83.4.1.2](https://profiles.ihe.net/ITI/PIXm/ITI-83.html#2383412-message-semantics) with a restriction on the targetSystem query Parameter:
...
See the [PIXm Find patient matches](OperationDefinition-CH.PIXm.md) OperationDefinition and the [CH PIXm IN Parameters](StructureDefinition-ch-pixm-in-parameters.md) Profile (with its [example: PIXm Parameters Query Input](Parameters-ParametersPIXmInput.md)).
...
See [Output Parameters example](Parameters-ParametersPIXmOutput.md) (and the corresponding [profile](StructureDefinition-ch-pixm-out-parameters.md)) as response to the Mobile Patient Identifier Cross-reference Query.
...
See [Input Parameters example](Parameters-ParametersPIXmInput.md) (and the corresponding [profile](StructureDefinition-ch-pixm-in-parameters.md)) for the Mobile Patient Identifier Cross-reference Query.

#### CapabilityStatement Resource

The CapabilityStatement resource for the **Patient Identifier Cross-reference Consumer** is [PIXm Patient Identifier Cross-Reference Consumer](CapabilityStatement-CH.PIXm.Consumer.md).
...
The **Patient Identifier Cross-reference Consumer** SHALL record an audit event according to [CH Audit Event for [ITI-83] Patient Identifier Cross-reference Consumer](StructureDefinition-ChAuditEventIti83Consumer.md) ([example](AuditEvent-ChAuditEventIti83ConsumerExample.md)).

##### Patient Identifier Cross-reference Manager Audit

The **Patient Identifier Cross-reference Manager** SHALL record an audit event according to [CH Audit Event for [ITI-83] Patient Identifier Cross-reference Manager](StructureDefinition-ChAuditEventIti83Manager.md) ([example](AuditEvent-ChAuditEventIti83ManagerExample.md)).
