# CH Audit Event for [ITI-68] Document Consumer - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH Audit Event for [ITI-68] Document Consumer**

## Resource Profile: CH Audit Event for [ITI-68] Document Consumer 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventIti68Consumer | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:ChAuditEventIti68Consumer |
...
* Examples for this Profile: [AuditEvent/ChAuditEventIti68ConsumerExample](AuditEvent-ChAuditEventIti68ConsumerExample.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epr-fhir|current/StructureDefinition/ChAuditEventIti68Consumer)
...
Other representations of profile: [CSV](StructureDefinition-ChAuditEventIti68Consumer.csv), [Excel](StructureDefinition-ChAuditEventIti68Consumer.xlsx), [Schematron](StructureDefinition-ChAuditEventIti68Consumer.sch) 
...
```json
{
  ...
  "abstract" : false,
  "type" : "AuditEvent",
  "baseDefinition" : "https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.RetrieveDocument.Audit.Consumer",
