# CH Audit Event for [PPQ-3] Update privacy policy - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH Audit Event for [PPQ-3] Update privacy policy**

## Resource Profile: CH Audit Event for [PPQ-3] Update privacy policy 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventPpq3Update | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:ChAuditEventPpq3Update |
...
* Examples for this Profile: [AuditEvent/ChAuditEventPpq3UpdateExample](AuditEvent-ChAuditEventPpq3UpdateExample.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epr-fhir|current/StructureDefinition/ChAuditEventPpq3Update)
...
Other representations of profile: [CSV](StructureDefinition-ChAuditEventPpq3Update.csv), [Excel](StructureDefinition-ChAuditEventPpq3Update.xlsx), [Schematron](StructureDefinition-ChAuditEventPpq3Update.sch) 
...
```json
{
  ...
  "abstract" : false,
  "type" : "AuditEvent",
  "baseDefinition" : "https://profiles.ihe.net/ITI/BALP/StructureDefinition/IHE.BasicAudit.PatientUpdate|1.1.4",
