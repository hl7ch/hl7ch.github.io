# CH Audit Event for [ITI-67] Document Responder - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH Audit Event for [ITI-67] Document Responder**

## Resource Profile: CH Audit Event for [ITI-67] Document Responder 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventIti67Responder | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:ChAuditEventIti67Responder |
...
* Examples for this Profile: [AuditEvent/ChAuditEventIti67ResponderExample](AuditEvent-ChAuditEventIti67ResponderExample.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epr-fhir|current/StructureDefinition/ChAuditEventIti67Responder)
...
Other representations of profile: [CSV](StructureDefinition-ChAuditEventIti67Responder.csv), [Excel](StructureDefinition-ChAuditEventIti67Responder.xlsx), [Schematron](StructureDefinition-ChAuditEventIti67Responder.sch) 
...
```json
{
  ...
  "abstract" : false,
  "type" : "AuditEvent",
  "baseDefinition" : "https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.FindDocumentReferences.Audit.Responder",
