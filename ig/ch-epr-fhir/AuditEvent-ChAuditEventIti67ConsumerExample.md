# Example of audit event for an [ITI-67] transaction at Consumer - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example of audit event for an [ITI-67] transaction at Consumer**

## Example AuditEvent: Example of audit event for an [ITI-67] transaction at Consumer

Profile: [CH Audit Event for [ITI-67] Document Consumer](StructureDefinition-ChAuditEventIti67Consumer.md)
...
```json
{
  ...
  "id" : "ChAuditEventIti67ConsumerExample",
  "meta" : {
    "profile" : [
