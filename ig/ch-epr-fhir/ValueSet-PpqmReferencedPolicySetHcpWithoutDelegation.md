# CH PPQm Referenced Policy Set for Healthcare Professionals without Delegation (301) template - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH PPQm Referenced Policy Set for Healthcare Professionals without Delegation (301) template**

## ValueSet: CH PPQm Referenced Policy Set for Healthcare Professionals without Delegation (301) template 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epr-fhir/ValueSet/PpqmReferencedPolicySetHcpWithoutDelegation | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:PpqmReferencedPolicySetHcpWithoutDelegation |
