# CH Audit Event for [ITI-67] Document Consumer - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH Audit Event for [ITI-67] Document Consumer**

## Resource Profile: CH Audit Event for [ITI-67] Document Consumer 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventIti67Consumer | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:ChAuditEventIti67Consumer |
...
* Examples for this Profile: [AuditEvent/ChAuditEventIti67ConsumerExample](AuditEvent-ChAuditEventIti67ConsumerExample.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epr-fhir|current/StructureDefinition/ChAuditEventIti67Consumer)
...
Other representations of profile: [CSV](StructureDefinition-ChAuditEventIti67Consumer.csv), [Excel](StructureDefinition-ChAuditEventIti67Consumer.xlsx), [Schematron](StructureDefinition-ChAuditEventIti67Consumer.sch) 
...
```json
{
  ...
  "id" : "ChAuditEventIti67Consumer",
  "url" : "http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventIti67Consumer",
  "version" : "5.0.0",
  "name" : "ChAuditEventIti67Consumer",
  ...
  "abstract" : false,
  "type" : "AuditEvent",
  "baseDefinition" : "https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.FindDocumentReferences.Audit.Consumer",
