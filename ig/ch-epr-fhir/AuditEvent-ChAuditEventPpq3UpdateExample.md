# Example of audit event for a [PPQ-3] update transaction - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example of audit event for a [PPQ-3] update transaction**

## Example AuditEvent: Example of audit event for a [PPQ-3] update transaction

Profile: [CH Audit Event for [PPQ-3] Update privacy policy](StructureDefinition-ChAuditEventPpq3Update.md)
...
**subtype**: unknown: PPQ-3 (Mobile Privacy Policy Feed), [FHIR Restful Interactions: update](http://hl7.org/fhir/R4/codesystem-restful-interaction.html#restful-interaction-update) (update)
