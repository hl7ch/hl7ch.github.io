# Example of audit event for an [ITI-119] transaction at Consumer - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example of audit event for an [ITI-119] transaction at Consumer**

## Example AuditEvent: Example of audit event for an [ITI-119] transaction at Consumer

Profile: [CH Audit Event for [ITI-119] Patient Demographics Consumer](StructureDefinition-ChAuditEventIti119Consumer.md)
...
```json
{
  ...
  "id" : "ChAuditEventIti119ConsumerExample",
  "meta" : {
    "profile" : [
