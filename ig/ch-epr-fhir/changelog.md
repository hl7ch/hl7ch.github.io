# Open Issues / Change Log - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* **Open Issues / Change Log**
...
* Uniformize the **traceparent** requirement wording on transaction pages [#236](https://github.com/ehealthsuisse/ch-epr-fhir/issues/236)
...
* 4.0.1 technical corrector because plantuml files were not generated major updates on the IG have been made:
