# CH Audit Event for [PPQ-3] Create privacy policy - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH Audit Event for [PPQ-3] Create privacy policy**

## Resource Profile: CH Audit Event for [PPQ-3] Create privacy policy 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventPpq3Create | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:ChAuditEventPpq3Create |
...
* Examples for this Profile: [AuditEvent/ChAuditEventPpq3CreateExample](AuditEvent-ChAuditEventPpq3CreateExample.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epr-fhir|current/StructureDefinition/ChAuditEventPpq3Create)
...
Other representations of profile: [CSV](StructureDefinition-ChAuditEventPpq3Create.csv), [Excel](StructureDefinition-ChAuditEventPpq3Create.xlsx), [Schematron](StructureDefinition-ChAuditEventPpq3Create.sch) 
...
```json
{
  ...
  "abstract" : false,
  "type" : "AuditEvent",
  "baseDefinition" : "https://profiles.ihe.net/ITI/BALP/StructureDefinition/IHE.BasicAudit.PatientCreate|1.1.4",
