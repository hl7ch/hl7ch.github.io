# CH Audit Event for [ITI-119] Patient Demographics Consumer - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH Audit Event for [ITI-119] Patient Demographics Consumer**

## Resource Profile: CH Audit Event for [ITI-119] Patient Demographics Consumer 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventIti119Consumer | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:ChAuditEventIti119Consumer |
...
* Examples for this Profile: [AuditEvent/ChAuditEventIti119ConsumerExample](AuditEvent-ChAuditEventIti119ConsumerExample.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epr-fhir|current/StructureDefinition/ChAuditEventIti119Consumer)
...
Other representations of profile: [CSV](StructureDefinition-ChAuditEventIti119Consumer.csv), [Excel](StructureDefinition-ChAuditEventIti119Consumer.xlsx), [Schematron](StructureDefinition-ChAuditEventIti119Consumer.sch) 
...
```json
{
  ...
  "id" : "ChAuditEventIti119Consumer",
  "url" : "http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventIti119Consumer",
  "version" : "5.0.0",
  "name" : "ChAuditEventIti119Consumer",
  ...
  "abstract" : false,
  "type" : "AuditEvent",
  "baseDefinition" : "https://profiles.ihe.net/ITI/PDQm/StructureDefinition/IHE.PDQm.Match.Audit.Consumer",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "sliceName" : "client",
        "short" : "The 'Patient Demographics Consumer' actor (EPR application)"
      },
      {
        "id" : "AuditEvent.agent:server",
        "path" : "AuditEvent.agent",
        "sliceName" : "server",
        "short" : "The 'Patient Demographics Supplier' actor (EPR API)"
      },
      {
