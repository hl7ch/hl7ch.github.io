# Example of audit event for an [ITI-68] transaction at Consumer - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example of audit event for an [ITI-68] transaction at Consumer**

## Example AuditEvent: Example of audit event for an [ITI-68] transaction at Consumer

Profile: [CH Audit Event for [ITI-68] Document Consumer](StructureDefinition-ChAuditEventIti68Consumer.md)
...
```json
{
  ...
  "id" : "ChAuditEventIti68ConsumerExample",
  "meta" : {
    "profile" : [
