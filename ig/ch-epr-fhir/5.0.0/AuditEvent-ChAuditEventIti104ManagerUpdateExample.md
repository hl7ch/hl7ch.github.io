# Example of audit event for an [ITI-104] update transaction at Manager - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example of audit event for an [ITI-104] update transaction at Manager**

## Example AuditEvent: Example of audit event for an [ITI-104] update transaction at Manager

Profile: [CH Audit Event for [ITI-104] Patient Identifier Cross-reference Manager / Update patient](StructureDefinition-ChAuditEventIti104ManagerUpdate.md)
...
**subtype**: unknown: ITI-104 (Patient Identity Feed FHIR), [FHIR Restful Interactions: update](http://hl7.org/fhir/R4/codesystem-restful-interaction.html#restful-interaction-update) (update)
