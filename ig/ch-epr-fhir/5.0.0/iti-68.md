# Retrieve Document [ITI-68] - CH EPR FHIR (R4) v5.0.0
...
This section describes the additional requirements for the Swiss EPR of the [Retrieve Document [ITI-68]](https://profiles.ihe.net/ITI/MHD/ITI-68.html) transaction defined in the MHD Profile published in the IHE ITI Trial Implementation “Mobile Access to Health Documents”.
...
The **Document Consumer** SHALL record an audit event according to [CH Audit Event for [ITI-68] Document Consumer](StructureDefinition-ChAuditEventIti68Consumer.md) ([example](AuditEvent-ChAuditEventIti68ConsumerExample.md)).

##### Document Responder Audit

The **Document Responder** SHALL record an audit event according to [CH Audit Event for [ITI-68] Document Responder](StructureDefinition-ChAuditEventIti68Responder.md) ([example](AuditEvent-ChAuditEventIti68ResponderExample.md)).
