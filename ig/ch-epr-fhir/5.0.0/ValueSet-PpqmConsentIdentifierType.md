...
## ValueSet: CH PPQm Consent Identifier Type 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epr-fhir/ValueSet/PpqmConsentIdentifierType | *Version*:5.0.0 |
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-epr-fhir/ValueSet/PpqmConsentIdentifierType",
  "version" : "5.0.0",
