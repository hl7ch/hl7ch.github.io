# CH Audit Event for [ITI-119] Patient Demographics Supplier - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH Audit Event for [ITI-119] Patient Demographics Supplier**

## Resource Profile: CH Audit Event for [ITI-119] Patient Demographics Supplier 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventIti119Supplier | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:ChAuditEventIti119Supplier |
...
* Examples for this Profile: [AuditEvent/ChAuditEventIti119SupplierExample](AuditEvent-ChAuditEventIti119SupplierExample.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epr-fhir|current/StructureDefinition/ChAuditEventIti119Supplier)
...
Other representations of profile: [CSV](StructureDefinition-ChAuditEventIti119Supplier.csv), [Excel](StructureDefinition-ChAuditEventIti119Supplier.xlsx), [Schematron](StructureDefinition-ChAuditEventIti119Supplier.sch) 
...
```json
{
  ...
  "id" : "ChAuditEventIti119Supplier",
  "url" : "http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventIti119Supplier",
  "version" : "5.0.0",
  "name" : "ChAuditEventIti119Supplier",
  ...
  "abstract" : false,
  "type" : "AuditEvent",
  "baseDefinition" : "https://profiles.ihe.net/ITI/PDQm/StructureDefinition/IHE.PDQm.Match.Audit.Supplier",
