# Example of audit event for an [ITI-83] transaction at Consumer - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example of audit event for an [ITI-83] transaction at Consumer**

## Example AuditEvent: Example of audit event for an [ITI-83] transaction at Consumer

Profile: [CH Audit Event for [ITI-83] Patient Identifier Cross-reference Consumer](StructureDefinition-ChAuditEventIti83Consumer.md)
...
```json
{
  ...
  "id" : "ChAuditEventIti83ConsumerExample",
  "meta" : {
    "profile" : [
