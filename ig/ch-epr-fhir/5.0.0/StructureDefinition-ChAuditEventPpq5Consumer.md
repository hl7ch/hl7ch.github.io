# CH Audit Event for [PPQ-5] Policy Consumer - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH Audit Event for [PPQ-5] Policy Consumer**

## Resource Profile: CH Audit Event for [PPQ-5] Policy Consumer 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventPpq5Consumer | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:ChAuditEventPpq5Consumer |
...
* Examples for this Profile: [AuditEvent/ChAuditEventPpq5ConsumerExample](AuditEvent-ChAuditEventPpq5ConsumerExample.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epr-fhir|current/StructureDefinition/ChAuditEventPpq5Consumer)
...
Other representations of profile: [CSV](StructureDefinition-ChAuditEventPpq5Consumer.csv), [Excel](StructureDefinition-ChAuditEventPpq5Consumer.xlsx), [Schematron](StructureDefinition-ChAuditEventPpq5Consumer.sch) 
...
```json
{
  ...
  "id" : "ChAuditEventPpq5Consumer",
  "url" : "http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventPpq5Consumer",
  "version" : "5.0.0",
  "name" : "ChAuditEventPpq5Consumer",
  ...
  "abstract" : false,
  "type" : "AuditEvent",
  "baseDefinition" : "https://profiles.ihe.net/ITI/BALP/StructureDefinition/IHE.BasicAudit.PatientQuery|1.1.4",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "path" : "AuditEvent.agent",
        "sliceName" : "client",
        "short" : "The 'Policy Consumer' actor (EPR application)"
      },
      {
