# CH Audit Event for [ITI-65] Document Source - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH Audit Event for [ITI-65] Document Source**

## Resource Profile: CH Audit Event for [ITI-65] Document Source 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventIti65Source | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:ChAuditEventIti65Source |
...
* Examples for this Profile: [AuditEvent/ChAuditEventIti65SourceExample](AuditEvent-ChAuditEventIti65SourceExample.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epr-fhir|current/StructureDefinition/ChAuditEventIti65Source)
...
Other representations of profile: [CSV](StructureDefinition-ChAuditEventIti65Source.csv), [Excel](StructureDefinition-ChAuditEventIti65Source.xlsx), [Schematron](StructureDefinition-ChAuditEventIti65Source.sch) 
...
```json
{
  ...
  "abstract" : false,
  "type" : "AuditEvent",
  "baseDefinition" : "https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.ProvideBundle.Audit.Source",
