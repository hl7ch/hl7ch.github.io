# CH Audit Event for [ITI-104] Patient Identifier Cross-reference Manager / Create patient - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH Audit Event for [ITI-104] Patient Identifier Cross-reference Manager / Create patient**

## Resource Profile: CH Audit Event for [ITI-104] Patient Identifier Cross-reference Manager / Create patient 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventIti104ManagerCreate | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:ChAuditEventIti104ManagerCreate |
...
* Examples for this Profile: [AuditEvent/ChAuditEventIti104ManagerCreateExample](AuditEvent-ChAuditEventIti104ManagerCreateExample.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epr-fhir|current/StructureDefinition/ChAuditEventIti104ManagerCreate)
...
Other representations of profile: [CSV](StructureDefinition-ChAuditEventIti104ManagerCreate.csv), [Excel](StructureDefinition-ChAuditEventIti104ManagerCreate.xlsx), [Schematron](StructureDefinition-ChAuditEventIti104ManagerCreate.sch) 
...
```json
{
  ...
  "id" : "ChAuditEventIti104ManagerCreate",
  "url" : "http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventIti104ManagerCreate",
  "version" : "5.0.0",
  "name" : "ChAuditEventIti104ManagerCreate",
  ...
  "abstract" : false,
  "type" : "AuditEvent",
  "baseDefinition" : "https://profiles.ihe.net/ITI/PIXm/StructureDefinition/IHE.PIXm.Feed.Create.Audit.Manager",
