# Example of audit event for an [ITI-104] transaction at Source - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example of audit event for an [ITI-104] transaction at Source**

## Example AuditEvent: Example of audit event for an [ITI-104] transaction at Source

Profile: [CH Audit Event for [ITI-104] Patient Identity Source](StructureDefinition-ChAuditEventIti104Source.md)
...
```json
{
  ...
  "id" : "ChAuditEventIti104SourceExample",
  "meta" : {
    "profile" : [
