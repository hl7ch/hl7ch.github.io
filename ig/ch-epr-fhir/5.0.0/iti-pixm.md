# Patient Identifier Cross-reference for Mobile (PIXm) - CH EPR FHIR (R4) v5.0.0
...
| | | | |
| :--- | :--- | :--- | :--- |
| Patient Identifier Cross-reference Manager | [IUA Resource Server](iti-iua.md#actors-and-transactions) | R | - |
| Patient Identity Source | [IUA Authorization Client](iti-iua.md#actors-and-transactions) | R | - |
| Patient Identifier Cross-reference Consumer | [IUA Authorization Client](iti-iua.md#actors-and-transactions) | R | - |
