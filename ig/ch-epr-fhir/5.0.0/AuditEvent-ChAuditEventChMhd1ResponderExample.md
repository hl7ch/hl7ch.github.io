# Example of audit event for a [CH:MHD-1] transaction at Responder - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example of audit event for a [CH:MHD-1] transaction at Responder**

## Example AuditEvent: Example of audit event for a [CH:MHD-1] transaction at Responder

Profile: [CH Audit Event for [CH:MHD-1] Document Responder](StructureDefinition-ch-mhd-updatedocumentmetadata-audit-responder.md)
...
```json
{
  ...
  "id" : "ChAuditEventChMhd1ResponderExample",
  "meta" : {
    "profile" : [
