# mCSD-Peer-to-peer-PractitionerRole-GisiGmorkFurchur-Klinik - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mCSD-Peer-to-peer-PractitionerRole-GisiGmorkFurchur-Klinik**

## Example PractitionerRole: mCSD-Peer-to-peer-PractitionerRole-GisiGmorkFurchur-Klinik
...
```json
{
  ...
  "id" : "mCSD-Peer-to-peer-PractitionerRole-GisiGmorkFurchur-Klinik",
  "meta" : {
    "profile" : [
