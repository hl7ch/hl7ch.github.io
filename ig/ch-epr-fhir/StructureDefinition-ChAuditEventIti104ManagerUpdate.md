# CH Audit Event for [ITI-104] Patient Identifier Cross-reference Manager / Update patient - CH EPR FHIR (R4) v5.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH Audit Event for [ITI-104] Patient Identifier Cross-reference Manager / Update patient**

## Resource Profile: CH Audit Event for [ITI-104] Patient Identifier Cross-reference Manager / Update patient 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventIti104ManagerUpdate | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:ChAuditEventIti104ManagerUpdate |
...
* Examples for this Profile: [AuditEvent/ChAuditEventIti104ManagerUpdateExample](AuditEvent-ChAuditEventIti104ManagerUpdateExample.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epr-fhir|current/StructureDefinition/ChAuditEventIti104ManagerUpdate)
...
Other representations of profile: [CSV](StructureDefinition-ChAuditEventIti104ManagerUpdate.csv), [Excel](StructureDefinition-ChAuditEventIti104ManagerUpdate.xlsx), [Schematron](StructureDefinition-ChAuditEventIti104ManagerUpdate.sch) 
...
```json
{
  ...
  "id" : "ChAuditEventIti104ManagerUpdate",
  "url" : "http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventIti104ManagerUpdate",
  "version" : "5.0.0",
  "name" : "ChAuditEventIti104ManagerUpdate",
  ...
  "abstract" : false,
  "type" : "AuditEvent",
  "baseDefinition" : "https://profiles.ihe.net/ITI/PIXm/StructureDefinition/IHE.PIXm.Feed.Update.Audit.Manager",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "sliceName" : "client",
        "short" : "The 'Patient Identifier Source' actor (EPR application)"
      },
      {
        "id" : "AuditEvent.agent:server",
        "path" : "AuditEvent.agent",
        "sliceName" : "server",
        "short" : "The 'Patient Identifier Cross-reference Manager' actor (EPR API)"
      },
      {
