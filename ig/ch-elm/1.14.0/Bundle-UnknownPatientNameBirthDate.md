# Example Document with unknown patient name and birthdate - CH ELM (R4) v1.14.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example Document with unknown patient name and birthdate**

## Example Bundle: Example Document with unknown patient name and birthdate
...
{
  "resourceType" : "Bundle",
  "id" : "UnknownPatientNameBirthDate",
  "identifier" : {
