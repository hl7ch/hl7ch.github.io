# Test94 - If warning is ignored for Binding for path (.+) has no source - CH ELM (R4) v1.14.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/TestScript/Test94-Ignore-Source-Warning | *Version*:1.14.0 |
| Active as of 2026-05-26 | *Computable Name*:Test94IgnoreSourceWarning |
