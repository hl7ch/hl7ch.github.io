# CH ELM Observation Results for Microbiology studies (set) - CH ELM (R4) v1.14.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-observation-results-laboratory-microbiology | *Version*:1.14.0 |
| Active as of 2026-05-26 | *Computable Name*:ChElmObservationResultsLaboratoryMicrobiology |
