# Test93 Error if full name is provided by Influenca (should be initials) - CH ELM (R4) v1.14.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/TestScript/Test93-Error-FullName-Influenca | *Version*:1.14.0 |
| Active as of 2026-05-26 | *Computable Name*:Test93ErrorFullNameInfluenca |
