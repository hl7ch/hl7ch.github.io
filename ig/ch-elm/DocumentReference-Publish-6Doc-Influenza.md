# Publish 6Doc-Influenza - CH ELM (R4) v1.12.0
...
**identifier**: [Uniform Resource Identifier (URI)](http://terminology.hl7.org/5.5.0/NamingSystem-uri.html)/urn:uuid:1901332d-6012-443f-9690-9291adb23a5c
...
| :--- | :--- | :--- |
| - | **Language** | **Url** |
| * | German (Region=Switzerland) | [Bundle: identifier = UUID:1901332d-6012-443f-9690-9291adb23a5c; type = document; timestamp = 2023-09-10 12:00:00+0200](#hcPublish-6Doc-Influenza/6Doc-Influenza) |
...
-------
Entry 2 - fullUrl = http://test.fhir.ch/r4/DiagnosticReport/6DR-InfluenzaResource DiagnosticReport:
> 
...
-------
Entry 4 - fullUrl = http://test.fhir.ch/r4/Observation/6Obs-InfluenzaResource Observation:
...
-------
Entry 5 - fullUrl = http://test.fhir.ch/r4/Specimen/6Spec-SpecimenResource Specimen:
...
-------
Entry 8 - fullUrl = http://test.fhir.ch/r4/PractitionerRole/PR-PeterHauserResource PractitionerRole:
...
-------
Entry 9 - fullUrl = http://test.fhir.ch/r4/Practitioner/Pract-PeterHauserResource Practitioner:
...
-------
Entry 10 - fullUrl = http://test.fhir.ch/r4/Organization/Org-PeterHauserResource Organization:
