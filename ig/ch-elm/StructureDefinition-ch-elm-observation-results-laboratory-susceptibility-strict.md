# CH ELM Observation Results for Microbial susceptibility tests (strict) - CH ELM (R4) v1.12.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-observation-results-laboratory-susceptibility-strict | *Version*:1.12.0 |
| Active as of 2025-10-21 | *Computable Name*:ChElmObservationResultsLaboratorySusceptibilityStrict |
