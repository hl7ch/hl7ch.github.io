# Test93 Error if full name is provided by Influenca (should be initials) - CH ELM (R4) v1.12.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/TestScript/Test93-Error-FullName-Influenca | *Version*:1.12.0 |
| Active as of 2025-10-21 | *Computable Name*:Test93ErrorFullNameInfluenca |
