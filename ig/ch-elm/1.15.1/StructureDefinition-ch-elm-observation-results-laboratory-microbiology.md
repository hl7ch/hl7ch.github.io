# CH ELM Observation Results for Microbiology studies (set) - CH ELM (R4) v1.15.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-observation-results-laboratory-microbiology | *Version*:1.15.1 |
| Active as of 2026-08-14 | *Computable Name*:ChElmObservationResultsLaboratoryMicrobiology |
