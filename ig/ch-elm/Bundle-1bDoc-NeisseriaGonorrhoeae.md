# 1bDoc - Neisseria Gonorrhoeae - CH ELM (R4) v1.12.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **1bDoc - Neisseria Gonorrhoeae**

## Example Bundle: 1bDoc - Neisseria Gonorrhoeae
...
Entry 2 - fullUrl = http://test.fhir.ch/r4/DiagnosticReport/1bDR-NeisseriaGonorrhoeae
...
| Identifier | [Uniform Resource Identifier (URI)](http://terminology.hl7.org/5.5.0/NamingSystem-uri.html)/urn:uuid:1901332d-6012-443f-9690-9291df32e177 |
...
Entry 8 - fullUrl = http://test.fhir.ch/r4/Practitioner/1Pract-KsAbc
...
Entry 9 - fullUrl = http://test.fhir.ch/r4/Organization/1bOrg-Broker
...
Entry 10 - fullUrl = http://test.fhir.ch/r4/Organization/1bOrg-Labor

Resource Organization:

> **identifier**:[GLN](https://www.gs1.org/standards/id-keys/gln)/7601000000415**name**: MikroLab

-------

Entry 11 - fullUrl = http://test.fhir.ch/r4/Organization/1Org-KsAbc
