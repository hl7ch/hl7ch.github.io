...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:name">
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-ext-vct-code']) &gt;= 1">extension with URL = 'http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-ext-vct-code': minimum cardinality of 'extension' is 1</sch:assert>
