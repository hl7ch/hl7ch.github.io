# SearchParameter-ch-elm-status - CH ELM (R4) v1.15.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/SearchParameter/SearchParameter-ch-elm-status | *Version*:1.15.1 |
| Active as of 2026-08-14 | *Computable Name*:elmstatus |
