# CH ELM Results Bot Spec - CH ELM (R4) v1.13.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-bot-spec | *Version*:1.13.0 |
| Active as of 2025-11-25 | *Computable Name*:ChElmResultsBotSpec |
...
```json
{
  ...
  "id" : "ch-elm-results-bot-spec",
  "url" : "http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-bot-spec",
  "version" : "1.13.0",
  "name" : "ChElmResultsBotSpec",
  "title" : "CH ELM Results Bot Spec",
  "status" : "active",
  "experimental" : false,
