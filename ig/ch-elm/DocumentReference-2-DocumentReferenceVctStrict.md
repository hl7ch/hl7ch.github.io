# Publish 2Doc-ChlamydiaTrachomatis with Patient VCT Code (Strict) - CH ELM (R4) v1.12.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Publish 2Doc-ChlamydiaTrachomatis with Patient VCT Code (Strict)**

## Example DocumentReference: Publish 2Doc-ChlamydiaTrachomatis with Patient VCT Code (Strict)
...
| :--- | :--- | :--- |
| - | **Language** | **Url** |
| * | German (Region=Switzerland) | [Bundle: identifier = UUID:1301332d-6012-443f-9690-929132b2e155; type = document; timestamp = 2023-08-05 11:30:00+0200](#hc2-DocumentReferenceVctStrict/2Doc-ChlamydiaTrachomatis-Vct) |
...
```json
{
  ...
  "id" : "2-DocumentReferenceVctStrict",
  "contained" : [
    {
      "resourceType" : "Bundle",
