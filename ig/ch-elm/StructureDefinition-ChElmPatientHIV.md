# CH ELM Patient HIV - CH ELM (R4) v1.15.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/StructureDefinition/ChElmPatientHIV | *Version*:1.15.0 |
| Active as of 2026-08-12 | *Computable Name*:ChElmPatientHIV |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-elm|current/StructureDefinition/StructureDefinition-ChElmPatientHIV.json)
