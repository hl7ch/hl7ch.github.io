# Publish 1cDoc-NeisseriaGonorrhoeae (Strict) - CH ELM (R4) v1.12.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Publish 1cDoc-NeisseriaGonorrhoeae (Strict)**

## Example DocumentReference: Publish 1cDoc-NeisseriaGonorrhoeae (Strict)
...
| :--- | :--- | :--- |
| - | **Language** | **Url** |
| * | German (Region=Switzerland) | [Bundle: identifier = UUID:1901332d-6012-443f-9690-9291adb2e19d; type = document; timestamp = 2023-07-14 16:00:00+0200](#hc1c-DocumentReferenceStrict/1cDoc-NeisseriaGonorrhoeae) |
...
-------
Entry 2 - fullUrl = http://test.fhir.ch/r4/DiagnosticReport/1cDR-NeisseriaGonorrhoeaeResource DiagnosticReport:
> 
...
-------
Entry 6 - fullUrl = http://test.fhir.ch/r4/ServiceRequest/1cSR-OrderResource ServiceRequest:
...
-------
Entry 7 - fullUrl = http://test.fhir.ch/r4/PractitionerRole/1cPR-KsAbcResource PractitionerRole:
> **practitioner**:[Practitioner null Giacometti](Practitioner-1cPract-KsAbc.md)

-------
Entry 8 - fullUrl = http://test.fhir.ch/r4/Practitioner/1cPract-KsAbcResource Practitioner:
