# DocumentReference for Publish Response - CH ELM (R4) v1.14.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/StructureDefinition/PublishDocumentReferenceResponse | *Version*:1.14.1 |
| Active as of 2026-07-01 | *Computable Name*:PublishDocumentReferenceResponse |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-elm|current/StructureDefinition/StructureDefinition-PublishDocumentReferenceResponse.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.ch/ig/ch-elm/StructureDefinition/ch-ext-elm-status"]
      }]
    },
    {
