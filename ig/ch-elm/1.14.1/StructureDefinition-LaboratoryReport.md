# CH ELM Laboratory Report - CH ELM (R4) v1.14.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/StructureDefinition/LaboratoryReport | *Version*:1.14.1 |
| Active as of 2026-07-01 | *Computable Name*:ChElmLaboratoryReport |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-elm|current/StructureDefinition/StructureDefinition-LaboratoryReport.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "mapping" : [{
        "identity" : "ChElmLaboratoryReportToFhir",
        "map" : "Bundle.entry[0].resource.subject.resolve().address.where(use='home').country.extension.where(url='http://hl7.org/fhir/StructureDefinition/iso21090-codedString').value.code"
      }]
    },
    {
