...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:name">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-ext-hiv-code']) &lt;= 0">extension with URL = 'http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-ext-hiv-code': maximum cardinality of 'extension' is 0</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:name/f:family">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/data-absent-reason|5.3.0']) &gt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/data-absent-reason|5.3.0': minimum cardinality of 'extension' is 1</sch:assert>
