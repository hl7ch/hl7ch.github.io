# CH ELM Results Mpox Org - CH ELM (R4) v1.14.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-mpox-org | *Version*:1.14.1 |
| Active as of 2026-07-01 | *Computable Name*:ChElmResultsMpoxOrg |
...
```json
{
  ...
  "id" : "ch-elm-results-mpox-org",
  "url" : "http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-mpox-org",
  "version" : "1.14.1",
  "name" : "ChElmResultsMpoxOrg",
  "title" : "CH ELM Results Mpox Org",
  "status" : "active",
  "experimental" : false,
  ...
  "compose" : {
    "include" : [{
      ...
      {
        "code" : "258372009",
        "display" : "Group 2B (qualifier value)"
      },
      {
        "code" : "258367000",
        "display" : "Group 1A (qualifier value)"
      },
      {
        "code" : "258371002",
        "display" : "Group 2A (qualifier value)"
      },
      {
        "code" : "1156316003",
