# CH ELM Results Mal Org - CH ELM (R4) v1.14.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-mal-org | *Version*:1.14.1 |
| Active as of 2026-07-01 | *Computable Name*:ChElmResultsMalOrg |
...
```json
{
  ...
  "id" : "ch-elm-results-mal-org",
  "url" : "http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-mal-org",
  "version" : "1.14.1",
  "name" : "ChElmResultsMalOrg",
  "title" : "CH ELM Results Mal Org",
  "status" : "active",
  "experimental" : false,
  ...
  "compose" : {
    "include" : [{
      ...
      {
        "code" : "786826006",
        "display" : "Plasmodium ovale or Plasmodium vivax (finding)"
      },
      {
        "code" : "18508006",
