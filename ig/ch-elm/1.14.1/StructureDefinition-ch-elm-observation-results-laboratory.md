# CH ELM Observation Results: Laboratory - CH ELM (R4) v1.14.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-observation-results-laboratory | *Version*:1.14.1 |
| Active as of 2026-07-01 | *Computable Name*:ChElmObservationResultsLaboratory |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-elm|current/StructureDefinition/StructureDefinition-ch-elm-observation-results-laboratory.json)
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "profile" : ["http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-codeableconcept"]
      }],
      "binding" : {
        "strength" : "extensible",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-organization-lab"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Ratio",
        "profile" : ["http://hl7.eu/fhir/laboratory/StructureDefinition/Ratio-eu-lab"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Quantity",
        "profile" : ["http://hl7.eu/fhir/laboratory/StructureDefinition/Quantity-eu-lab"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-specimen"]
      }]
    }]
  }
}
