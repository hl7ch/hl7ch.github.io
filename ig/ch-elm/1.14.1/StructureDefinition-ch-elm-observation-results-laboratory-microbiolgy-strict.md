# CH ELM Observation Results for Microbiology studies (set) strict - CH ELM (R4) v1.14.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-observation-results-laboratory-microbiolgy-strict | *Version*:1.14.1 |
| Active as of 2026-07-01 | *Computable Name*:ChElmObservationResultsLaboratoryMicrobiologyStrict |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-elm|current/StructureDefinition/StructureDefinition-ch-elm-observation-results-laboratory-microbiolgy-strict.json)
