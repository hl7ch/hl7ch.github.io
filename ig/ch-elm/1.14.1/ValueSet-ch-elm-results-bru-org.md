# CH ELM Results Bru Org - CH ELM (R4) v1.14.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-bru-org | *Version*:1.14.1 |
| Active as of 2026-07-01 | *Computable Name*:ChElmResultsBruOrg |
...
```json
{
  ...
  "id" : "ch-elm-results-bru-org",
  "url" : "http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-bru-org",
  "version" : "1.14.1",
  "name" : "ChElmResultsBruOrg",
  "title" : "CH ELM Results Bru Org",
  "status" : "active",
  "experimental" : false,
  ...
  "compose" : {
    "include" : [{
      ...
      {
        "code" : "38025008",
        "display" : "Brucella canis (organism)"
      },
      {
        "code" : "24224000",
