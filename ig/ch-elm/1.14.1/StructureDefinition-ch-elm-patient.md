# CH ELM Patient - CH ELM (R4) v1.14.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-patient | *Version*:1.14.1 |
| Active as of 2026-07-01 | *Computable Name*:ChElmPatient |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-elm|current/StructureDefinition/StructureDefinition-ch-elm-patient.json)
...
```json
{
  ...
  "differential" : {
    "element" : [{
      ...
      "constraint" : [{
        "key" : "ch-elm-patient-address-require-countrycode",
        "severity" : "error",
        "human" : "patient requires country code in address",
      ...
      {
        "key" : "ch-elm-patient-nameorlocalpid",
        "severity" : "error",
        "human" : "patient requires either name or local pid, but not both",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Identifier",
        "profile" : ["http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-idn-identifier"]
      }],
      "patternIdentifier" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "HumanName",
        "profile" : ["http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-humanname"]
      }]
    },
    {
      "id" : "Patient.name.family",
      "path" : "Patient.name.family",
      "short" : "masked when using HIV/VCT-extensions or unknown (see IG guidance).",
      "min" : 1,
      "maxLength" : 100
    },
    {
    ...
    {
      "id" : "Patient.address:home.country.extension:country-deprecated",
      "path" : "Patient.address.country.extension",
      "sliceName" : "country-deprecated",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/iso21090-SC-coding|5.3.0"]
      }]
    },
    {
      "id" : "Patient.address:home.country.extension:country-deprecated.value[x]",
      "path" : "Patient.address.country.extension.value[x]",
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://fhir.ch/ig/ch-term/ValueSet/bfs-country-codes"
