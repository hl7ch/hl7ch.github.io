# Test93 Error if full name is provided by Influenca (should be initials) - CH ELM (R4) v1.14.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/TestScript/Test93-Error-FullName-Influenca | *Version*:1.14.1 |
| Active as of 2026-07-01 | *Computable Name*:Test93ErrorFullNameInfluenca |
