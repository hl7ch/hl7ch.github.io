# CH ELM Observation Results for HIV Recency Testing (strict) - CH ELM (R4) v1.14.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-observation-results-hiv-recency-strict | *Version*:1.14.1 |
| Active as of 2026-07-01 | *Computable Name*:ChElmObservationResultsLaboratoryHivRecencyStrict |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-elm|current/StructureDefinition/StructureDefinition-ch-elm-observation-results-hiv-recency-strict.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://fhir.ch/ig/ch-elm/StructureDefinition/ChElmPatientHIV"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Quantity",
        "profile" : ["http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-quantity-arbu"]
      }]
    },
    {
