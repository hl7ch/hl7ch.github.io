# CH ELM Organization: Author - CH ELM (R4) v1.14.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-organization-author | *Version*:1.14.1 |
| Active as of 2026-07-01 | *Computable Name*:ChElmOrganizationAuthor |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-elm|current/StructureDefinition/StructureDefinition-ch-elm-organization-author.json)
