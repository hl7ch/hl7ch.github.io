# CH ELM Results Influenza Hxny Org - CH ELM (R4) v1.14.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-influenza-hxny-org | *Version*:1.14.1 |
| Active as of 2026-07-01 | *Computable Name*:ChElmResultsInfluenzaHxnyOrg |
...
```json
{
  ...
  "compose" : {
    "include" : [{
      ...
      {
        "code" : "1354812007",
        "display" : "Influenza A virus subtype H1N1v (organism)"
      },
      {
        "code" : "446649001",
        "display" : "Influenza A virus subtype H9 (organism)"
      },
      {
        "code" : "772827006",
        "display" : "Influenza A virus subtype H5N1 (organism)"
      },
      {
        "code" : "446647004",
        "display" : "Influenza A virus subtype H5 (organism)"
      },
      {
        "code" : "700349009",
        "display" : "Influenza A virus subtype H10 (organism)"
      },
      {
        "code" : "446648009",
        "display" : "Influenza A virus subtype H7 (organism)"
      }]
    }]
  }
}
