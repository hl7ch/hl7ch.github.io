# Test95-Ignore-Observation-Interpretation-Codes-Warning - CH ELM (R4) v1.14.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/TestScript/Test95-Ignore-Observation-Interpretation-Codes-Warning | *Version*:1.14.1 |
| Active as of 2026-07-01 | *Computable Name*:Test95IgnoreObservationInterpretationCodesWarning |
| **Copyright/Legal**: CC0-1.0 | |

 
Test script to verify that warning None of the codings provided are in the value set 'Observation Interpretation Codes' is ignored 
