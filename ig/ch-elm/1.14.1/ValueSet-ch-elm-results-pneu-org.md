# CH ELM Results Pneu Org - CH ELM (R4) v1.14.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-pneu-org | *Version*:1.14.1 |
| Active as of 2026-07-01 | *Computable Name*:ChElmResultsPneuOrg |
...
```json
{
  ...
  "id" : "ch-elm-results-pneu-org",
  "url" : "http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-pneu-org",
  "version" : "1.14.1",
  "name" : "ChElmResultsPneuOrg",
  "title" : "CH ELM Results Pneu Org",
  "status" : "active",
  "experimental" : false,
