# Test94 - If warning is ignored for Binding for path (.+) has no source - CH ELM (R4) v1.14.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/TestScript/Test94-Ignore-Source-Warning | *Version*:1.14.1 |
| Active as of 2026-07-01 | *Computable Name*:Test94IgnoreSourceWarning |
| **Copyright/Legal**: CC0-1.0 | |

 
Test script to verify that warning Binding for path (.+) has no source, so can't be checked 
