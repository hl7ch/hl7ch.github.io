# CH ELM Observation Results for Genotyping (strict) - CH ELM (R4) v1.14.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-observation-results-laboratory-genotyping-strict | *Version*:1.14.1 |
| Active as of 2026-07-01 | *Computable Name*:ChElmObservationResultsLaboratoryGenotypingStrict |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-elm|current/StructureDefinition/StructureDefinition-ch-elm-observation-results-laboratory-genotyping-strict.json)
