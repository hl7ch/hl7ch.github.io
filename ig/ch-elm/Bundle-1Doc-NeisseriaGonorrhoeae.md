# 1Doc - Neisseria Gonorrhoeae - CH ELM (R4) v1.12.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **1Doc - Neisseria Gonorrhoeae**

## Example Bundle: 1Doc - Neisseria Gonorrhoeae
...
Entry 2 - fullUrl = http://test.fhir.ch/r4/DiagnosticReport/1DR-NeisseriaGonorrhoeae
...
Entry 6 - fullUrl = http://test.fhir.ch/r4/ServiceRequest/1SR-Order
