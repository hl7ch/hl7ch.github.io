# Test99 Bundle - Coxiella without zero denominator should raise an error - CH ELM (R4) v1.13.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Test99 Bundle - Coxiella without zero denominator should raise an error**

## Example Binary: Test99 Bundle - Coxiella without zero denominator should raise an error
