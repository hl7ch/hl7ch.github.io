# CH ELM Results Tub Spec - CH ELM (R4) v1.13.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-tub-spec | *Version*:1.13.0 |
| Active as of 2025-11-25 | *Computable Name*:ChElmResultsTubSpec |
...
```json
{
  ...
  "id" : "ch-elm-results-tub-spec",
  "url" : "http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-tub-spec",
  "version" : "1.13.0",
  "name" : "ChElmResultsTubSpec",
  "title" : "CH ELM Results Tub Spec",
  "status" : "active",
  "experimental" : false,
