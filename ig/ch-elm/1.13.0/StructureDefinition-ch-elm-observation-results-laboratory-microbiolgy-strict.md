# CH ELM Observation Results for Microbiology studies (set) strict - CH ELM (R4) v1.13.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-observation-results-laboratory-microbiolgy-strict | *Version*:1.13.0 |
| Active as of 2025-11-25 | *Computable Name*:ChElmObservationResultsLaboratoryMicrobiologyStrict |
