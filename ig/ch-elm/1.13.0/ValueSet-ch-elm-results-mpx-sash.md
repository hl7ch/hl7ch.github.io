# CH ELM Results Mpx Sash - CH ELM (R4) v1.13.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-mpx-sash | *Version*:1.13.0 |
| Active as of 2025-11-25 | *Computable Name*:ChElmResultsMpxSash |
...
```json
{
  ...
  "id" : "ch-elm-results-mpx-sash",
  "url" : "http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-mpx-sash",
  "version" : "1.13.0",
  "name" : "ChElmResultsMpxSash",
  "title" : "CH ELM Results Mpx Sash",
  "status" : "active",
  "experimental" : false,
