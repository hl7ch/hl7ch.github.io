# CH ELM Results Tub Org - CH ELM (R4) v1.13.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-tub-org | *Version*:1.13.0 |
| Active as of 2025-11-25 | *Computable Name*:ChElmResultsTubOrg |
    ...
    "include" : [
      {
        ...
        "concept" : [
          ...
          {
            "code" : "33610009",
            "display" : "BCG variant of Mycobacterium bovis (organism)"
          },
          {
            "code" : "430579009",
          ...
          {
            "code" : "110379001",
            "display" : "Mycobacterium, non-tuberculosis (organism)"
          }
        ]
      }
    ]
