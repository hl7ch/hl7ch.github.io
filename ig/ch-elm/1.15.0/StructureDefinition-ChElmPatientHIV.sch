...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile ChElmPatient
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:name">
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-ext-vct-code']) &lt;= 0">extension with URL = 'http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-ext-vct-code': maximum cardinality of 'extension' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-ext-hiv-code']) &gt;= 1">extension with URL = 'http://fhir.ch/ig/ch-elm/StructureDefinition/ch-elm-ext-hiv-code': minimum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Patient/f:name/f:family/f:extension</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Patient/f:name/f:given/f:extension</sch:title>
    <sch:rule context="f:Patient/f:name/f:given/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:url) &lt;= 1">url: maximum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:value[x]) &gt;= 1">value[x]: minimum cardinality of 'value[x]' is 1</sch:assert>
