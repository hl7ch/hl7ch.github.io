# FHIR Document (Bundle) - CH ELM (R4) v1.15.0
...
| RSV | Respiratory syncytial virus RNA [Presence] in Bronchial specimen by NAA with probe detection | 105211-7 | [JSON](Bundle-71Doc-RSV.json.md),[XML](Bundle-71Doc-RSV.json.md) |
...
| RSV | Respiratory syncytial virus RNA [Presence] in Specimen by NAA with probe detection | 40988-8 | [JSON](Bundle-72Doc-RSV.json.md),[XML](Bundle-72Doc-RSV.json.md) |
...
| CPE - 1 gene component | Carbapenemase-producing Escherichia coli (organism) | 737528008 | [JSON](Bundle-68Doc-CPE-Genotyping-Default.json.md),[XML](Bundle-68Doc-CPE-Genotyping-Default.xml.md) |
| CPE - 2 gene components | Carbapenemase-producing Escherichia coli (organism) | 737528008 | [JSON](Bundle-69Doc-CPE-Genotyping-TwoComponents.json.md),[XML](Bundle-69Doc-CPE-Genotyping-TwoComponents.xml.md) |
| CPE - 1 gene component, 1 generic component with freetext | Carbapenemase-producing Escherichia coli (organism) | 737528008 | [JSON](Bundle-70Doc-CPE-Genotyping-TwoComponentsFreetext.json.md),[XML](Bundle-70Doc-CPE-Genotyping-TwoComponentsFreetext.xml.md) |
...
| | | | |
| :--- | :--- | :--- | :--- |
| Chlamydiosis - patient missing given name | Chlamydia trachomatis [Presence] in Specimen by Organism specific culture | 6349-5 | [JSON](Bundle-ChlamydiaPatientMissingNameGiven.json.md),[XML](Bundle-ChlamydiaPatientMissingNameGiven.xml.md) |
| Chlamydiosis - patient missing birthdate | Chlamydia trachomatis [Presence] in Specimen by Organism specific culture | 6349-5 | [JSON](Bundle-ChlamydiaPatientMissingBirthdate.json.md),[XML](Bundle-ChlamydiaPatientMissingBirthdate.xml.md) |
| Chlamydiosis - patient with partial birthdate | Chlamydia trachomatis [Presence] in Specimen by Organism specific culture | 6349-5 | [JSON](Bundle-ChlamydiaPatientPartialBirthdate.json.md),[XML](Bundle-ChlamydiaPatientPartialBirthdate.xml.md) |
| Chlamydiosis - VCT patient (name-code instead of real name) | Chlamydia trachomatis [Presence] in Specimen by Organism specific culture | 6349-5 | [JSON](Bundle-2Doc-ChlamydiaTrachomatis-Vct.json.md),[XML](Bundle-2Doc-ChlamydiaTrachomatis-Vct.xml.md) |
