# Artifacts Summary - CH ELM (R4) v1.15.0
...
| [CH ELM Observation Component Results: Text](StructureDefinition-ch-elm-observation-component-cpe-txt.md) | Text as observation.component result, if component.code is LP113695-3 |
...
| [CH ELM Patient VCT](StructureDefinition-ChElmPatientVCT.md) | Patient representation via a VCT Code extension or local pid |
...
| [CH ELM Extension: HIV code](StructureDefinition-ch-elm-ext-hiv-code.md) | This CH ELM extension enables to provide the HIV Code. |
| [CH ELM Extension: VCT code](StructureDefinition-ch-elm-ext-vct-code.md) | This CH ELM extension enables to provide the VCT Code. Retired. Ues identifier instead (see Guidance) |
...
| [CH ELM Results Gene Cpe](ValueSet-ch-elm-results-component-gene-cpe.md) | The "CH ELM Results Gene Cpe" group provides a curated set of codes representing specific genotypes. Each code within this group is selected to ensure consistency and accuracy for medical coding related to the primary LOINC codes. Clients using the "CH ELM Results Gene Cpe" group should refer to the provided codes to ensure they capture and report antibiotic information correctly and consistently |
...
| [CH ELM Results Lis Spec](ValueSet-ch-elm-results-lis-spec.md) | The "CH ELM Results Lis Spec" material group provides a curated set of codes representing specific materials. Each code within this group is selected to ensure consistency and accuracy for medical coding related to the primary LOINC codes. Clients using the "CH ELM Results Lis Spec" group should refer to the provided codes to ensure they capture and report material information correctly and consistently. |
...
| [CH ELM Results Genotyping To Component Obersvation Profile](ConceptMap-ch-elm-results-geno-to-component-observation-profile.md) | This CH ELM concept map specifies the ValuesSet for component.code for each leading code. |
...
| [2Doc - Chlamydia Trachomatis (VCT Deprecated)](Bundle-2Doc-ChlamydiaTrachomatis-Vct-Deprecated.md) | Laboratory Report collection material in addition to the leading LOINC code and Patient with Patient VCT code, note VCT code is deprecated in name.extension, use identifier |
...
| [67Doc-Emerging-Pathogen](Bundle-67Doc-Emerging-Pathogen.md) | Example document for FOPH emerging pathogen reporting |
| [68Doc - CPE Genotyping Default](Bundle-68Doc-CPE-Genotyping-Default.md) | Example for a CH ELM Document: CPE Genotyping with leading code, no observation.value, 1 component code |
| [69Doc - CPE Genotyping with Observation Value](Bundle-69Doc-CPE-Genotyping-TwoComponents.md) | Example for a CH ELM Document: CPE Genotyping with leading code, 2 component codes |
| [6Doc - Influenza](Bundle-6Doc-Influenza.md) | Example for a CH ELM Document: Laboratory Report |
| [70Doc - CPE Genotyping Freetext](Bundle-70Doc-CPE-Genotyping-TwoComponentsFreetext.md) | Example for a CH ELM Document: CPE Genotyping with leading code, 1 coded component and 1 generic component code with freetext valueString |
| [71Doc-RSV](Bundle-71Doc-RSV.md) | Example Document for RSV |
| [72Doc-RSV](Bundle-72Doc-RSV.md) | Example Document for RSV with Specimen |
...
| [Chlamydia - Patient missing birthdate](Bundle-ChlamydiaPatientMissingBirthdate.md) | Example document for Chlamydiosis where patient birthdate is missing |
| [Chlamydia - Patient missing name.given](Bundle-ChlamydiaPatientMissingNameGiven.md) | Example document for Chlamydiosis where patient name.given is missing |
| [Chlamydia - Patient with partial birthdate](Bundle-ChlamydiaPatientPartialBirthdate.md) | Example document for Chlamydiosis where patient birthdate is partial (year-month only) |
| [Example Document with unknown patient name and birthdate](Bundle-UnknownPatientNameBirthDate.md) | Laboratory Report where patient name and birthdate are unknown |
...
| [Pat - Antoine Dupont (partial birthdate)](Patient-Pat-PartialBirthDate.md) | Example for a CH ELM Patient - partial birthdate |
| [Pat - Antoine Dupont (unknown birthdate)](Patient-Pat-UnknownBirthDate.md) | Example for a CH ELM Patient - unknown birthdate |
| [Pat - Antoine Dupont (unknown name)](Patient-Pat-UnknownName.md) | Example for a CH ELM Patient - unknown name |
...
| [Pat - HIV](Patient-Pat-004.md) | Example for a CH ELM Patient - special case HIV/AIDS |
| [Pat - Lilly Liechtenstein](Patient-Pat-007.md) | Example for a CH ELM Patient - IDN Liechtenstein |
| [Pat - VCT with extension (deprecated)](Patient-Pat-VCT-Deprecated.md) | Example for a CH ELM Patient with VCT Code (Deprecated) |
| [Pat - VCT with localpid](Patient-Pat-VCT.md) | Example for a CH ELM Patient with VCT Code |
...
| [Test100-Kosovo](TestScript-Test100-Kosovo.md) | Test100: Verify that XK iso country code is allowed for Kosovo |
| [Test101-InvalidCountryCode](TestScript-Test101-InvalidCountryCode.md) | Test101: Verify that XX raises an error for invalid country code |
| [Test102-BirthDateFuture](TestScript-Test102-BirthDateFuture.md) | Test102: Verify that Birthdate in the future raises an error |
...
| [Test95-Ignore-Observation-Interpretation-Codes-Warning](TestScript-Test95-Ignore-Observation-Interpretation-Codes-Warning.md) | Test script to verify that warning None of the codings provided are in the value set 'Observation Interpretation Codes' is ignored |
| [Test96-Ignore-Slice-Patient-Eu-Lab-Information](TestScript-Test96-Ignore-Slice-Patient-Eu-Lab-Information.md) | Test script to verify that Information This element does not match any known slice defined in the profile http://hl7.eu/fhir/laboratory/StructureDefinition/Patient-eu-lab is ignored |
...
| [Test97-CoaxiellaNoRatio](TestScript-Test97-CoaxiellaNoRatio.md) | Test97: Verify that error for missing ratio is raised |
...
| [Test99-CoaxiellaZeroDenominator](TestScript-Test99-CoaxiellaZeroDenominator.md) | Test99: Verify that error for denominator not positive is raised |
...
| [Test102-Bundle-BirthDateFuture](Binary-Test102-Bundle-BirthDateFuture.md) |
