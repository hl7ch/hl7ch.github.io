...
* **Source Code**: 100965-3 (Dengue virus IgG Ab [Interpretation] in Serum, Plasma or Blood)
  * **Relationship**: [is related to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#relatedto)
  * **Target Code**: http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-interpretation-codes-sero
...
* **Source Code**: 52986-7 (Rubella virus IgG Ab avidity [Ratio] in Serum by Immunoassay)
  * **Relationship**: [is related to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#relatedto)
  * **Target Code**: http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-interpretation-codes-avidity
...
**Group 2**Mapping from [SNOMED CT (all versions)](http://hl7.org/fhir/R4/codesystem-snomedct.html) to [CH ELM Interpretation Codes Vs](CodeSystem-ch-elm-interpretation-codes-vs.md)
