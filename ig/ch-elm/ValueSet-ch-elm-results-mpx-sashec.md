# CH ELM Results Mpx Sashec - CH ELM (R4) v1.12.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-mpx-sashec | *Version*:1.12.0 |
| Active as of 2025-10-21 | *Computable Name*:ChElmResultsMpxSashec |
...
```json
{
  ...
  "id" : "ch-elm-results-mpx-sashec",
  "url" : "http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-mpx-sashec",
  "version" : "1.12.0",
  "name" : "ChElmResultsMpxSashec",
  "title" : "CH ELM Results Mpx Sashec",
  "status" : "active",
  "experimental" : false,
