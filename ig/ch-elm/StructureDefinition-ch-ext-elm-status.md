# Status of the processing of the document - CH ELM (R4) v1.14.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/StructureDefinition/ch-ext-elm-status | *Version*:1.14.0 |
| Active as of 2026-05-26 | *Computable Name*:ChExtElmStatus |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ch.fhir.ig.ch-elm|current/StructureDefinition/StructureDefinition-ch-ext-elm-status.json)
