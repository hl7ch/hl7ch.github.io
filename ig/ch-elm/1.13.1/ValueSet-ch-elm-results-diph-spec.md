# CH ELM Results Diph Spec - CH ELM (R4) v1.13.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-diph-spec | *Version*:1.13.1 |
| Active as of 2026-01-21 | *Computable Name*:ChElmResultsDiphSpec |
...
```json
{
  ...
  "id" : "ch-elm-results-diph-spec",
  "url" : "http://fhir.ch/ig/ch-elm/ValueSet/ch-elm-results-diph-spec",
  "version" : "1.13.1",
  "name" : "ChElmResultsDiphSpec",
  "title" : "CH ELM Results Diph Spec",
  "status" : "active",
  "experimental" : false,
