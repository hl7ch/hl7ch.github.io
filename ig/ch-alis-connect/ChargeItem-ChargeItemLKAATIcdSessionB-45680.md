# ALIS 5.1 FHIR ChargeItemLKAATIcdSessionB-45680 - CH ALIS Connect (R4) v1.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ALIS 5.1 FHIR ChargeItemLKAATIcdSessionB-45680**

## Example ChargeItem: ALIS 5.1 FHIR ChargeItemLKAATIcdSessionB-45680
...
```json
{
  ...
  "id" : "ChargeItemLKAATIcdSessionB-45680",
  "contained" : [{
