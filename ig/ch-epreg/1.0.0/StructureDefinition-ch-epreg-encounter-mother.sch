...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter">
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-epreg/StructureDefinition/ch-epreg-ext-examination-sequence']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/ch-epreg/StructureDefinition/ch-epreg-ext-examination-sequence': maximum cardinality of 'extension' is 1</sch:assert>
