# UC 1: 12.5 kg (05.02.2025) - CH EPREG (R4) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **UC 1: 12.5 kg (05.02.2025)**

## Example Observation: UC 1: 12.5 kg (05.02.2025)
...
**value**: 12.5 kilogram(Details: UCUM codekg = 'kg')

**derivedFrom**: [Observation Body weight](Observation-UC1-BodyWeight-20250205.md)
