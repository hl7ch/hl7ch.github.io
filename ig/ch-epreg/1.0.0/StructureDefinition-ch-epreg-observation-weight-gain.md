# CH EPREG Observation (Mother): Weight Gain - CH EPREG (R4) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH EPREG Observation (Mother): Weight Gain**

## Resource Profile: CH EPREG Observation (Mother): Weight Gain 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epreg/StructureDefinition/ch-epreg-observation-weight-gain | *Version*:1.0.0 |
| Active as of 2025-12-16 | *Computable Name*:ChEpregObservationWeightGain |
| **Copyright/Legal**: CC0-1.0 | |

 
This profile constrains the Observation resource to represent the gestational weight gain. 

**Usages:**

* Refer to this Profile: [CH EPREG Composition](StructureDefinition-ch-epreg-composition.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epreg|current/StructureDefinition/ch-epreg-observation-weight-gain)
...
Other representations of profile: [CSV](StructureDefinition-ch-epreg-observation-weight-gain.csv), [Excel](StructureDefinition-ch-epreg-observation-weight-gain.xlsx), [Schematron](StructureDefinition-ch-epreg-observation-weight-gain.sch) 
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-epreg/StructureDefinition/ch-epreg-observation-weight-gain",
  "version" : "1.0.0",
  "name" : "ChEpregObservationWeightGain",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "short" : "Body weight measurement (e.g., at the beginning of pregnancy, current measurement) from which this gestational weight gain is derived",
        "type" : [
          {
            "code" : "Reference",
            "targetProfile" : [
