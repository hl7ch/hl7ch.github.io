# CH EPREG Observation (Child): Fetal Heart Feature - CH EPREG (R4) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH EPREG Observation (Child): Fetal Heart Feature**

## Resource Profile: CH EPREG Observation (Child): Fetal Heart Feature 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epreg/StructureDefinition/ch-epreg-observation-fetal-heart-feature | *Version*:1.0.0 |
| Active as of 2025-12-16 | *Computable Name*:ChEpregObservationFetalHeartFeature |
| **Copyright/Legal**: CC0-1.0 | |

 
This profile constrains the Observation resource to represent the fetal heart feature (e.g. rate, sounds, rhythm). 

**Usages:**

* Refer to this Profile: [CH EPREG Composition](StructureDefinition-ch-epreg-composition.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epreg|current/StructureDefinition/ch-epreg-observation-fetal-heart-feature)
...
Other representations of profile: [CSV](StructureDefinition-ch-epreg-observation-fetal-heart-feature.csv), [Excel](StructureDefinition-ch-epreg-observation-fetal-heart-feature.xlsx), [Schematron](StructureDefinition-ch-epreg-observation-fetal-heart-feature.sch) 
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-epreg/StructureDefinition/ch-epreg-observation-fetal-heart-feature",
  "version" : "1.0.0",
  "name" : "ChEpregObservationFetalHeartFeature",
