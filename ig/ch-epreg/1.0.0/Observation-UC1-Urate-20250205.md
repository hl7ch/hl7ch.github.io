# UC 1: Urate 6.3 mg/dL (05.02.2025) - CH EPREG (R4) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **UC 1: Urate 6.3 mg/dL (05.02.2025)**

## Example Observation: UC 1: Urate 6.3 mg/dL (05.02.2025)
...
**code**: Urate [Mass/volume] in Serum or Plasma
...
**value**: 6.3 milligram per deciliter(Details: UCUM codemg/dL = 'mg/dL')
