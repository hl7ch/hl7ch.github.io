# CH EPREG Observation (Lab): Fetal RhD - CH EPREG (R4) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH EPREG Observation (Lab): Fetal RhD**

## Resource Profile: CH EPREG Observation (Lab): Fetal RhD 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epreg/StructureDefinition/ch-epreg-observation-fetal-rhd | *Version*:1.0.0 |
| Active as of 2025-12-16 | *Computable Name*:ChEpregObservationFetalRhD |
| **Copyright/Legal**: CC0-1.0 | |

 
This profile constrains the Observation resource to represent the fetal Rhesus D determination from the maternal blood. 

**Usages:**

* Refer to this Profile: [CH EPREG Composition](StructureDefinition-ch-epreg-composition.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epreg|current/StructureDefinition/ch-epreg-observation-fetal-rhd)
...
Other representations of profile: [CSV](StructureDefinition-ch-epreg-observation-fetal-rhd.csv), [Excel](StructureDefinition-ch-epreg-observation-fetal-rhd.xlsx), [Schematron](StructureDefinition-ch-epreg-observation-fetal-rhd.sch) 
    ...
    "element" : [
      ...
      },
      {
        ...
        "mapping" : [
          {
            "identity" : "concept-pregnancy-passport",
            "map" : "Bestimmung des fetalen RHD-Status | Détermination du RhD fœtal"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "extensible",
          "description" : "See also [Mapping Fetal RhD](mapping-concept-valuesets.html#fetal-rhd).",
          "valueSet" : "http://fhir.ch/ig/ch-epreg/ValueSet/fetal-rhd-antigen"
        },
        "mapping" : [
          {
            "identity" : "concept-pregnancy-passport",
