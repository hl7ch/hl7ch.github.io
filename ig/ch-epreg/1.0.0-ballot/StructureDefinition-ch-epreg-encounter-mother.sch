...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter">
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-epreg/StructureDefinition/ch-epreg-ext-planned-next-preg-visit']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/ch-epreg/StructureDefinition/ch-epreg-ext-planned-next-preg-visit': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-epreg/StructureDefinition/ch-epreg-ext-number']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/ch-epreg/StructureDefinition/ch-epreg-ext-number': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-epreg/StructureDefinition/ch-epreg-ext-note']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/ch-epreg/StructureDefinition/ch-epreg-ext-note': maximum cardinality of 'extension' is 1</sch:assert>
