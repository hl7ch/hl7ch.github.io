# CH EPREG Observation (Mother): Gestational Age in Days - CH EPREG (R4) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH EPREG Observation (Mother): Gestational Age in Days**

## Resource Profile: CH EPREG Observation (Mother): Gestational Age in Days 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epreg/StructureDefinition/ch-epreg-observation-gestational-age-in-days | *Version*:1.0.0 |
| Active as of 2025-12-16 | *Computable Name*:ChEpregObservationGestationalAgeInDays |
| **Copyright/Legal**: CC0-1.0 | |

 
This profile constrains the Observation resource to represent the gestational age in days. 

**Usages:**

* Refer to this Profile: [CH EPREG Composition](StructureDefinition-ch-epreg-composition.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-epreg|current/StructureDefinition/ch-epreg-observation-gestational-age-in-days)
...
Other representations of profile: [CSV](StructureDefinition-ch-epreg-observation-gestational-age-in-days.csv), [Excel](StructureDefinition-ch-epreg-observation-gestational-age-in-days.xlsx), [Schematron](StructureDefinition-ch-epreg-observation-gestational-age-in-days.sch) 
    ...
    "element" : [
      ...
      },
      {
        ...
        "mapping" : [
          {
            "identity" : "concept-pregnancy-passport",
            "map" : "Schwangerschaftswoche+Tage | Semaine de grossesse + jours"
          }
        ]
      },
      {
