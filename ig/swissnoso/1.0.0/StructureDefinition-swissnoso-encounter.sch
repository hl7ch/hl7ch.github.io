...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter">
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/swissnoso/StructureDefinition/swissnoso-organizational-unit']) &gt;= 1">extension with URL = 'http://fhir.ch/ig/swissnoso/StructureDefinition/swissnoso-organizational-unit': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/swissnoso/StructureDefinition/swissnoso-organizational-unit']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/swissnoso/StructureDefinition/swissnoso-organizational-unit': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/swissnoso/StructureDefinition/swissnoso-admission-date-monitored-unit']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/swissnoso/StructureDefinition/swissnoso-admission-date-monitored-unit': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/swissnoso/StructureDefinition/swissnoso-discharge-date-monitored-unit']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/swissnoso/StructureDefinition/swissnoso-discharge-date-monitored-unit': maximum cardinality of 'extension' is 1</sch:assert>
