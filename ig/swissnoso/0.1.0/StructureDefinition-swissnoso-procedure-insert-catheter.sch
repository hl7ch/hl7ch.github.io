...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile SwissnosoProcedure
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Procedure">
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/swissnoso/StructureDefinition/swissnoso-transurethral-procedure']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/swissnoso/StructureDefinition/swissnoso-transurethral-procedure': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/swissnoso/StructureDefinition/swissnoso-sequence-number']) &gt;= 1">extension with URL = 'http://fhir.ch/ig/swissnoso/StructureDefinition/swissnoso-sequence-number': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/swissnoso/StructureDefinition/swissnoso-sequence-number']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/swissnoso/StructureDefinition/swissnoso-sequence-number': maximum cardinality of 'extension' is 1</sch:assert>
