...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Location">
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-ems/StructureDefinition/ch-ems-ext-disinfection']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/ch-ems/StructureDefinition/ch-ems-ext-disinfection': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
