...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Procedure">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-crl/StructureDefinition/ch-crl-procedure-treatment-goal']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/ch-crl/StructureDefinition/ch-crl-procedure-treatment-goal': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>Procedure.performed[x].start 1</sch:title>
    <sch:rule context="f:Procedure/f:performed[x]/f:start">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Procedure.performed[x].end 1</sch:title>
    <sch:rule context="f:Procedure/f:performed[x]/f:end">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
