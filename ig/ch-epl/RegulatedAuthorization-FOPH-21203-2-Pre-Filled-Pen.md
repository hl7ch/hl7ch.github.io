# Reimbursement SL 21203 2 Pre-Filled Pen - CH EPL (R5) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Reimbursement SL 21203 2 Pre-Filled Pen**

## Example RegulatedAuthorization: Reimbursement SL 21203 2 Pre-Filled Pen
...
```json
{
  ...
  "id" : "FOPH-21203-2-Pre-Filled-Pen",
  "contained" : [
    {
