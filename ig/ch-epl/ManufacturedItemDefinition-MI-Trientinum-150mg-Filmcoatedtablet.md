# MI Trientinum-150mg-Tablet - CH EPL (R5) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MI Trientinum-150mg-Tablet**

## Example ManufacturedItemDefinition: MI Trientinum-150mg-Tablet
...
```json
{
  ...
  "id" : "MI-Trientinum-150mg-Filmcoatedtablet",
  "meta" : {
    "profile" : [
