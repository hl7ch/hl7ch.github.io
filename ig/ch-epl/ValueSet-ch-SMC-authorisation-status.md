# CH SMC - Authorisation Status - CH EPL (R5) v1.0.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epl/ValueSet/ch-SMC-authorisation-status | *Version*:1.0.1 |
| Active as of 2026-04-07 | *Computable Name*:ChSMCAuthorisationStatusVS |
...
```json
{
  ...
  "url" : "http://fhir.ch/ig/ch-epl/ValueSet/ch-SMC-authorisation-status",
  "version" : "1.0.1",
