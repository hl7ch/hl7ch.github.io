# IDMP Standard ISO 11615 - CH EPL (R5) v1.0.0
...
1. **Data Classes:**The IDMP standard groups the data element into approx. 50 classes. Each class cnsists of one to many attributes. The classes are grouped and marked with colors:
...
* Light Purple: Limitation For details see chapter: Spezialitätenliste.

1. **Identifier:**The IDMP standard consists of different identifier. The following list indicates the 5 main identifier.
...
The following datamodel illustrates the full IDMP datamodel according to ISO 11615:2017 ![](ISO_11615_2017-Datamodel-Medicinal_Product_en.png)
...
The following datamodel illustrates the full IDMP datamodel according to ISO 11615:2017 translated into German representing the official Swiss locale terminology. ![](ISO_11615_2017-Datamodel-Medicinal_Product_de-CH.png)
