# Dataexport FOPH Spezialitätenliste - CH EPL (R5) v1.0.0

* [**Table of Contents**](toc.md)
* **Dataexport FOPH Spezialitätenliste**
...
![](Bundle-Externe-Spezialitaetenliste.png)

*Fig. 3: Bundle - Spezialitätenliste*
