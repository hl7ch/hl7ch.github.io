...
![](https://documedis.hcisolutions.ch/2020-01/api/products/image/PICFRONT3D/productnumber/1346803/350)

*Abb. 4: KEYTRUDA Inf Konz 100 mg/4ml Durchstf, Quelle: compendium.ch*

#### FHIR Example

Representation of IDMP data attributes as FHIR XML and JSON: [FHIR Beispiel](Bundle-b2eb19be-cca4-4fd8-a2a3-84d05631e6c0.md)

#### IDMP Data Example

Overview of IDMP data elements in the FHIR structure: ![](keytruda-structure.png)

*Fig. 1: IDMP Datamodel - Keytruda*
