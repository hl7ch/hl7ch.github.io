# ISO IDMP Standard (ISO 11615) - CH EPL (R5) v1.0.1

* [**Table of Contents**](toc.md)
* **ISO IDMP Standard (ISO 11615)**
...
![](idmp-wedding-cake.png)

*Fig. 1: IDMP Overview of Standards*
...
The base data model for this ePL FHIR IG is based on ISO 11615. The standard can be purchased here: [ISO 11615:2017](https://www.iso.org/standard/70150.html)
...
![](ISO_11615_2017-Datamodel-Medicinal_Product_en.png)

*Fig. 2: IDMP Datamodel - Authorised Medicinal Products (English)*

#### IDMP Datamodel for Authorised Medicinal Products (German – Switzerland)

![](ISO_11615_2017-Datamodel-Medicinal_Product_de-CH.png)

*Fig. 3: IDMP Datamodel - Authorised Medicinal Products (German – Switzerland)*

### Usefull Links

#### ISO

* [ISO 11615:2017](https://www.iso.org/standard/70150.html)
* [ISO 11616:2017](https://www.iso.org/standard/70044.html)
* [ISO 11238:2018](https://www.iso.org/standard/69697.html)
* [ISO 11239:2023](https://www.iso.org/standard/81133.html)
* [ISO 11240:2012](https://www.iso.org/standard/55033.html)

#### HL7

* FHIR specifications by HL7: [https://hl7.org/fhir](https://hl7.org/fhir)
* FHIR implementations in Switzerland: [https://fhir.ch/](https://fhir.ch/)
* Published FHIR IG of FOPH/ePL: [https://fhir.ch/ig/ch-epl/index.html](https://fhir.ch/ig/ch-epl/index.html)
...
* Swissmedic IDMP: [https://www.swissmedic.ch/swissmedic/en/home/services/submissions/idmp.html](https://www.swissmedic.ch/swissmedic/en/home/services/submissions/idmp.html)
* Swissmedic Handbook PDF (IDMP Implementation Guide) V2.0, 30.9.2025: [https://www.swissmedic.ch/dam/swissmedic/en/dokumente/e-gov/handbook-smc-idmp-implementation-guide.pdf.download.pdf/SMC-IDMP-IG-V2.0.pdf](https://www.swissmedic.ch/dam/swissmedic/en/dokumente/e-gov/handbook-smc-idmp-implementation-guide.pdf.download.pdf/SMC-IDMP-IG-V2.0.pdf)

#### EMA

* [EMA SPOR Portal](https://spor.ema.europa.eu/sporwi/#/)
* [EMA PMS FHIR IG](https://pms.ema.europa.eu/fhir/ig/)
