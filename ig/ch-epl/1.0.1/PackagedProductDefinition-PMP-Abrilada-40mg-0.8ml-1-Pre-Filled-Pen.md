# ABRILADA solution for injection 40 mg/0.8 mL pre-filled pen, 1 × 0.8 ml - CH EPL (R5) v1.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ABRILADA solution for injection 40 mg/0.8 mL pre-filled pen, 1 × 0.8 ml**

## Example PackagedProductDefinition: ABRILADA solution for injection 40 mg/0.8 mL pre-filled pen, 1 × 0.8 ml

Profile: [PackagedProductDefinition](StructureDefinition-ch-idmp-packagedproductdefinition.md)

**identifier**: [Clinical Product Identifier](NamingSystem-PCID.md)/CH-01001107-0678310010000-0001
...
**containedItemQuantity**: 1 Pre-filled pen (Details: EDQM - Standard Terms code30050000 = 'Pre-filled pen')

**description**: 

ABRILADA Inj Lös 40 mg/0.8ml Fertpen 1 x 0.8 ml
...
> **packaging****identifier**: [Global Trade Item Number](NamingSystem-GTIN.md)/7680678310019**type**: Box**quantity**: 1
...
| * | Shelf life from manufacturing time |  | in the refrigerator (2°C - 8°C) |
| * |  |  | protect from light |
| * |  |  | Do not freeze |
...
```json
{
  ...
  "id" : "PMP-Abrilada-40mg-0.8ml-1-Pre-Filled-Pen",
  "meta" : {
  ...
  "identifier" : [{
    ...
    "value" : "CH-01001107-0678310010000-0001"
  }],
  "packageFor" : [{
  ...
  "description" : "ABRILADA Inj Lös 40 mg/0.8ml Fertpen 1 x 0.8 ml",
  "legalStatusOfSupply" : [{
    "code" : {
      "coding" : [{
