...
Hidradenitis suppurativa (Acne inversa) Abrilada ist indiziert zur Behandlung von erwachsenen Patienten mit aktiver mittelschwerer bis schwerer Hidradenitis suppurativa (Acne inversa), die unzureichend auf eine systemische Antibiotikatherapie angesprochen haben.
...
**classification**: adalimumab, Extension for biosimilar, Biologics, Originator product, 07. STOFFWECHSEL, 07.15. Immunosuppressive Stoffe

**attachedDocument**: 

* [DocumentReference: identifier = http://fhir.ch/ig/ch-epl/sid/attno#Application / Assessment Tracking Number#123456789-initial submission-Example-klm-123; status = current; type = Fachinformation; date = 2025-05-01 00:00:00+0000](DocumentReference-DocRef-FI-Abrilada.md)
* [DocumentReference: identifier = http://fhir.ch/ig/ch-epl/sid/attno#Application / Assessment Tracking Number#123456789-initial submission-Example-hij-321; status = current; type = Patienteninformation; date = 2025-05-01 00:00:00+0000](DocumentReference-DocRef-PI-Abrilada.md)

> **name****productName**: ABRILADA Inj Lös 40 mg/0.8ml Fertpen 0.8 ml**type**: FOPH Medicinal Product Name
...
```json
{
  ...
  "id" : "Abrilada-40mg-Pre-Filled-Pen",
  "meta" : {
  ...
  "identifier" : [{
    ...
    "value" : "CH-01001107-0678310010000"
  }],
  ...
  "name" : [{
    "productName" : "ABRILADA Inj Lös 40 mg/0.8ml Fertpen 0.8 ml",
    "type" : {
      "coding" : [{
