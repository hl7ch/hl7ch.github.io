# Artifacts Summary - CH EPL (R5) v1.0.1
...
| [Organization](StructureDefinition-ch-idmp-organization.md) | Defines basic constraints and extensions on the Organization resource for use with other CH EPL resources |
...
| [Swissmedic Location Identifier](NamingSystem-SwissmedicLocationsIdentifier.md) | Temporary Namingsystem in this implementation guide until officially released by Swissmedic |
...
| [ABRILADA solution for injection 40 mg/0.8 mL pre-filled pen, 1 × 0.8 ml](PackagedProductDefinition-PMP-Abrilada-40mg-0.8ml-1-Pre-Filled-Pen.md) | ABRILADA Inj Lös 40 mg/0.8ml Fertpen 1 x 0.8 ml: Example of a PackagedProductDefinition (Packaged Medicinal Product) |
| [ABRILADA solution for injection 40 mg/0.8 mL pre-filled pen, 2 × 0.8 ml](PackagedProductDefinition-PMP-Abrilada-40mg-0.8ml-2-Pre-Filled-Pen.md) | ABRILADA Inj Lös 40 mg/0.8ml Fertpen 2 x 0.8 ml: Example of a PackagedProductDefinition (Packaged Medicinal Product) |
| [AXLOVID film-coated tablets 4 × 150 mg / 2 × 100 mg](PackagedProductDefinition-PMP-Paxlovid-Filmcoatedtablet.md) | PAXLOVID Filmtabl 4x150mg/2x100mg: Example of a PackagedProductDefinition (Packaged Medicinal Product) |
...
| [CUPRIOR film-coated tablets 150 mg, 72 tablets](PackagedProductDefinition-PMP-Cuprior-150mg-Filmcoatedtablet.md) | CUPRIOR Filmtabl 150 mg 72 Stk: Example of a PackagedProductDefinition (Packaged Medicinal Product) |
...
| [ENTOCORT enema, rectal solution + tablets, 7 units](PackagedProductDefinition-PMP-Entocort-Solvent-and-Tablet.md) | ENTOCORT Enema Klistier Lösung + Tabletten 7 Stk: Example of a PackagedProductDefinition (Packaged Medicinal Product) |
...
| [ESTALIS matrix patch 50/250, 24 units](PackagedProductDefinition-PMP-Estalis-Transdermalpatch.md) | ESTALIS Matrixpfl 50/250 24 Stk: Example of a PackagedProductDefinition (Packaged Medicinal Product) |
...
| [KEYTRUDA infusion concentrate 100 mg / 4 ml](PackagedProductDefinition-PMP-Keytruda-100mg-4ml-Solution-for-Infusion.md) | KEYTRUDA Inf Konz 100 mg / 4 ml: Example of a PackagedProductDefinition (Packaged Medicinal Product) |
...
| [Limitation 20416.XX](ClinicalUseDefinition-LIM-20416.XX.md) | KEYTRUDA Inf Konz 100 mg / 4 ml: Example of an ClinicalUseDefinition-Limitation (Indication) |
...
| [Limitation 64766004](ClinicalUseDefinition-LIM-64766004-ABRILADA.md) | ABRILADA Inj Lös 40 mg/0.8ml: Example of an ClinicalUseDefinition-Limitation (Indication) |
...
| [Limitation 79886009](ClinicalUseDefinition-LIM-79886009-CUPRIOR.md) | CUPRIOR Filmtabl 150 mg 72 Stk: Example of an ClinicalUseDefinition-Limitation (Indication) |
| [Limitation 79886009](ClinicalUseDefinition-LIM-79886009-TRIOGEN.md) | CUPRIOR Filmtabl 150 mg 72 Stk: Example of an ClinicalUseDefinition-Limitation (Indication) |
...
| [Limitation 90560007](ClinicalUseDefinition-LIM-64766004-ENTOCORT.md) | ENTOCORT Enema Klistier Lösung + Tabletten 7 Stk: Example of an ClinicalUseDefinition-Limitation (Indication) |
...
| [TRIOGEN capsules 250 mg, pack of 100](PackagedProductDefinition-PMP-Triogen-250mg-Capsule.md) | TRIOGEN Kaps 250 mg Ds 100 Stk: Example of a PackagedProductDefinition (Packaged Medicinal Product) |
