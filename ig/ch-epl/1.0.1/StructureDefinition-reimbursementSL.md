# CH EPL - Reimbursement SL - CH EPL (R5) v1.0.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epl/StructureDefinition/reimbursementSL | *Version*:1.0.1 |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Identifier",
        "profile" : ["http://fhir.ch/ig/ch-epl/StructureDefinition/ch-foph-dossier-number"]
      }]
    },
    {
