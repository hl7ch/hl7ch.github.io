# PAXLOVID Filmtabl 4x150mg/2x100mg - CH EPL (R5) v1.0.1
...
**identifier**: [Medical Product Identifier](NamingSystem-MPID.md)/CH-01001107-0687930010000
...
> **name****productName**: PAXLOVID Filmtabl 4x150mg/2x100mg**type**: FOPH Medicinal Product Name
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "CH-01001107-0687930010000"
  }],
