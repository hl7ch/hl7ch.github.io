# CH EPL - Regulated Authorization Limitation - CH EPL (R5) v1.0.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-epl/StructureDefinition/regulatedAuthorization-limitation | *Version*:1.0.1 |
| Draft as of 2026-02-25 | *Computable Name*:RegulatedAuthorizationLimitation |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "Extension.extension:priceModelSpecification",
      "path" : "Extension.extension",
      "sliceName" : "priceModelSpecification",
      "definition" : "Specification of the Price Model",
      "min" : 0,
      "max" : "1"
    },
    {
      "id" : "Extension.extension:priceModelSpecification.extension",
      "path" : "Extension.extension.extension",
      "max" : "0"
    },
    {
      "id" : "Extension.extension:priceModelSpecification.url",
      "path" : "Extension.extension.url",
      "fixedUri" : "priceModelSpecification"
    },
    {
      "id" : "Extension.extension:priceModelSpecification.value[x]",
      "path" : "Extension.extension.value[x]",
      "type" : [{
        "code" : "CodeableConcept"
      }]
    ...
    {
      "id" : "Extension.extension:priceModel",
      "path" : "Extension.extension",
      "sliceName" : "priceModel",
      "definition" : "Indicator for a Price Model",
      "min" : 0,
      "max" : "1"
    },
    {
      "id" : "Extension.extension:priceModel.extension",
      "path" : "Extension.extension.extension",
      "max" : "0"
    },
    {
      "id" : "Extension.extension:priceModel.url",
      "path" : "Extension.extension.url",
      "fixedUri" : "priceModel"
    },
    {
      "id" : "Extension.extension:priceModel.value[x]",
      "path" : "Extension.extension.value[x]",
      "type" : [{
        "code" : "boolean"
      }]
    ...
    {
      "id" : "Extension.extension:relatedIndication",
      "path" : "Extension.extension",
      "sliceName" : "relatedIndication",
      "definition" : "Reference to the indication related to this limitation",
      "min" : 0,
      "max" : "1"
    },
    {
      "id" : "Extension.extension:relatedIndication.extension",
      "path" : "Extension.extension.extension",
      "max" : "0"
    },
    {
      "id" : "Extension.extension:relatedIndication.url",
      "path" : "Extension.extension.url",
      "fixedUri" : "relatedIndication"
    },
    {
      "id" : "Extension.extension:relatedIndication.value[x]",
      "path" : "Extension.extension.value[x]",
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://hl7.org/fhir/StructureDefinition/ClinicalUseDefinition"]
