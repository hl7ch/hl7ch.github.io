# UC5-MedicationStatement-Bilol - CH EMR (R4) v1.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **UC5-MedicationStatement-Bilol**

## Example MedicationStatement: UC5-MedicationStatement-Bilol

Profile: [CH Emergency Record Medication Statement](StructureDefinition-ch-emr-medicationstatement.md)

**status**: Active

**medication**: [Medication BILOL Filmtabl 5 mg 30 Stk](Medication-UC5-Medication-Bilol.md)
