# UC5-MedicationStatement-Atorvastatin - CH EMR (R4) v1.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **UC5-MedicationStatement-Atorvastatin**

## Example MedicationStatement: UC5-MedicationStatement-Atorvastatin

Profile: [CH Emergency Record Medication Statement](StructureDefinition-ch-emr-medicationstatement.md)

**status**: Active

**medication**: [Medication SORTIS Filmtabl 40 mg 30 Stk](Medication-UC5-Medication-Atorvastatin.md)
