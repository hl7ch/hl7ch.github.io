# UC5-MedicationStatement-Pemzek - CH EMR (R4) v1.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **UC5-MedicationStatement-Pemzek**

## Example MedicationStatement: UC5-MedicationStatement-Pemzek

Profile: [CH Emergency Record Medication Statement](StructureDefinition-ch-emr-medicationstatement.md)

**status**: Active

**medication**: [Medication PEMZEK Tabl 16 mg 28 Stk](Medication-UC5-Medication-Pemzek.md)
