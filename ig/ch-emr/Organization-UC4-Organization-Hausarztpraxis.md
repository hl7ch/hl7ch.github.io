# UC4-Organization-Hausarztpraxis - CH EMR (R4) v1.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **UC4-Organization-Hausarztpraxis**

## Example Organization: UC4-Organization-Hausarztpraxis

Profile: [CH IPS Organization](http://fhir.ch/ig/ch-ips/2.0.0/StructureDefinition-ch-ips-organization.html)

**identifier**: [GLN](http://fhir.ch/ig/ch-term/3.4.0/NamingSystem-gln.html)/7601000000088
