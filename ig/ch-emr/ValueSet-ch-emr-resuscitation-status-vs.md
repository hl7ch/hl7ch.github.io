# Resuscitation status - CH EMR (R4) v1.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Resuscitation status**

## ValueSet: Resuscitation status 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-emr/ValueSet/ch-emr-resuscitation-status-vs | *Version*:1.0.0-ballot |
| Active as of 2026-04-18 | *Computable Name*:ChEmrResuscitationStatusVS |
| **Copyright/Legal**: CC0-1.0 | |

 
Coded resuscitation status values based on SNOMED CT, including all descendants of 304251008 (Resuscitation status). 
