# CH EMED Pharmaceutical Advice Composition - CH EMED (R4) v6.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CH EMED Pharmaceutical Advice Composition**

## Resource Profile: CH EMED Pharmaceutical Advice Composition 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-composition-pharmaceuticaladvice | *Version*:6.0.0 |
| Active as of 2025-12-16 | *Computable Name*:CHEMEDCompositionPharmaceuticalAdvice |
...
* Examples for this Profile: [Composition/2-2-Composition](Composition-2-2-Composition.md) and [Composition/Comp-ChangeDosage](Composition-Comp-ChangeDosage.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ch.fhir.ig.ch-emed|current/StructureDefinition/ch-emed-composition-pharmaceuticaladvice)
...
Other representations of profile: [CSV](StructureDefinition-ch-emed-composition-pharmaceuticaladvice.csv), [Excel](StructureDefinition-ch-emed-composition-pharmaceuticaladvice.xlsx), [Schematron](StructureDefinition-ch-emed-composition-pharmaceuticaladvice.sch) 
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "constraint" : [
          {
            "key" : "ch-emed-comp-padv",
            "severity" : "error",
            "human" : "If a LOINC code is additionally provided, '61356-2' SHALL be used for this document type.",
            "expression" : "coding.exists(system = 'http://loinc.org') and (coding.exists(system = 'http://loinc.org' and code = '61356-2'))",
            "source" : "http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-composition-pharmaceuticaladvice"
          }
        ]
      },
      {
      ...
      {
        "id" : "Composition.section:pharmaceuticalAdvice",
        "path" : "Composition.section",
      ...
      {
        "id" : "Composition.section:pharmaceuticalAdvice.title",
      ...
      {
        "id" : "Composition.section:pharmaceuticalAdvice.code",
      ...
      {
        "id" : "Composition.section:pharmaceuticalAdvice.text",
        "path" : "Composition.section.text",
        "short" : "Human readable text of this section",
        "min" : 1
      },
      {
        "id" : "Composition.section:pharmaceuticalAdvice.entry",
      ...
      {
        "id" : "Composition.section:pharmaceuticalAdvice.entry.reference",
        "path" : "Composition.section.entry.reference",
        "min" : 1
      },
      {
        "id" : "Composition.section:pharmaceuticalAdvice.section",
