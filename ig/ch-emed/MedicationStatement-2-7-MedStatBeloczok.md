# 2-7 Medication Statement with Medication Beloc Zok - CH EMED (R4) v6.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **2-7 Medication Statement with Medication Beloc Zok**

## Example MedicationStatement: 2-7 Medication Statement with Medication Beloc Zok
...
```json
{
  ...
  "identifier" : [
    {
      "system" : "urn:ietf:rfc:3986",
      "value" : "urn:uuid:af9e960d-99bf-46d5-8a72-8f863512246b"
    }
  ],
  "status" : "active",
  "medicationReference" : {
