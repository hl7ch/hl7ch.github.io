# 2-4 Medication Dispense document - CH EMED (R4) v6.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **2-4 Medication Dispense document**

## Example Bundle: 2-4 Medication Dispense document
...
```json
{
  ...
  "entry" : [
    {
      "fullUrl" : "http://test.fhir.ch/r4/Composition/2-4-Composition",
      "resource" : {
    ...
    {
      "fullUrl" : "http://test.fhir.ch/r4/MedicationDispense/2-4-MedDispBeloczok",
      "resource" : {
