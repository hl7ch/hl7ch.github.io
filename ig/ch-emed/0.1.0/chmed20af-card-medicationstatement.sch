...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile CHEMEDMedicationStatementCard
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationStatement">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-ext-documentauthor']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-ext-documentauthor': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationStatement/f:informationSource">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-ext-representedorganization']) &lt;= 1">extension with URL = 'http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-ext-representedorganization': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>MedicationStatement.informationSource.type</sch:title>
    <sch:rule context="f:MedicationStatement/f:informationSource/f:type">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
