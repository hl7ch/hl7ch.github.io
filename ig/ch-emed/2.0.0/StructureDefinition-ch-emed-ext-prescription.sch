...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'externalDocumentId']) &gt;= 1">extension with URL = 'externalDocumentId': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'externalDocumentId']) &lt;= 1">extension with URL = 'externalDocumentId': maximum cardinality of 'extension' is 1</sch:assert>
