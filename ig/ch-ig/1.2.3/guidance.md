...
* `stu-note` (see the [Home](index.md) page)
* `dragon` (see below)
* etc
...
CH IG example using a backport extension: [Cross-Version Encounter R4](Encounter-xver-encounter-r4.md):

CH IG profile using a backport extension: [CH IG Encounter](StructureDefinition-ch-ig-encounter.md)
