...
```json
{
  ...
  "id" : "ch.fhir.ig.ch-ig",
  "url" : "http://fhir.ch/ig/ch-ig/ImplementationGuide/ch.fhir.ig.ch-ig",
  "version" : "1.2.3",
  "name" : "CH_IG",
  "title" : "CH IG (R4)",
  "status" : "draft",
  ...
  "description" : "Template for HL7.ch FHIR Implementation Guides",
  "jurisdiction" : [
    {
      "coding" : [
        {
    ...
    "extension" : [
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "http://fhir.ch/ig/ch-ig/history.html"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
    ...
    "resource" : [
      {
        ...
        "reference" : {
          "reference" : "ValueSet/example"
        },
        "name" : "CH IG Designations",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/ch-ig-encounter"
        },
        "name" : "CH IG Encounter",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/ch-ig-practitioner"
        },
        "name" : "CH IG Practitioner",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/sct"
        },
        "name" : "CH IG SNOMED CT",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "Encounter/xver-encounter-r4"
        },
        "name" : "Cross-Version Encounter R4",
        "description" : "Example for CH IG Encounter using a backport extension for a new introduced resource element in R5 (Encounter.subjectStatus).",
        "exampleCanonical" : "http://fhir.ch/ig/ch-ig/StructureDefinition/ch-ig-encounter"
      },
      {
        "extension" : [
          {
        ...
        "exampleCanonical" : "http://fhir.ch/ig/ch-ig/StructureDefinition/ch-ig-practitioner"
      },
      {
        "extension" : [
          {
